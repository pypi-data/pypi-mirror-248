from src.admin.live_channel.get_live_channel_inputs_ids import _get_live_channel_inputs_ids
from src.admin.live_input.delete_live_input import _delete_live_input
...
def _delete_live_channel(AUTH_TOKEN, URL, CHANNEL_ID, DELETE_INPUTS, DEBUG):
    API_URL = f"{URL}/liveChannel/{CHANNEL_ID}"
