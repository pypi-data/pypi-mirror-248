...
from src.helpers.slugify import _slugify
from src.admin.live_channel.live_channel_statuses import _LIVE_CHANNEL_STATUSES
from src.admin.live_channel.get_security_groups import _get_security_groups
from src.admin.live_channel.wait_for_live_channel_status import _wait_for_live_channel_status
from src.admin.live_channel.live_channel_types import _LIVE_CHANNEL_TYPES
from src.admin.live_channel.get_live_channel import _get_live_channel

import json, requests

def _update_live_channel(AUTH_TOKEN, URL, ID, NAME, THUMBNAIL_IMAGE_ID, ARCHIVE_FOLDER_ASSET_ID, 
                        ENABLE_HIGH_AVAILABILITY, ENABLE_LIVE_CLIPPING, IS_SECURE_OUTPUT, 
                        OUTPUT_SCREENSHOTS, TYPE, EXTERNAL_URL, SECURITY_GROUPS, DEBUG):
    
    LIVE_CHANNEL_INFO = _get_live_channel(AUTH_TOKEN, URL, ID, DEBUG)

    API_URL = f"{URL}/liveChannel"
