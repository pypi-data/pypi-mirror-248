from src.admin.live_channel.get_live_channel_status import _get_live_channel_status
from src.admin.live_channel.get_live_channel_status_message import _get_live_channel_status_message

import time

def _wait_for_live_channel_status(AUTH_TOKEN, URL, CHANNEL_ID, STATUS_TO_WAIT_FOR, TIMEOUT = 30, POLL_INTERVAL = 2, DEBUG = False):
    ...
    while (ELAPSED_TIME < TIMEOUT):
        ...
        CHANNEL_STATUS = _get_live_channel_status(AUTH_TOKEN, URL, CHANNEL_ID, DEBUG)
        ...
        if (CHANNEL_STATUS == "Error"):
            ...
            CHANNEL_STATUS_MESSAGE = _get_live_channel_status_message(AUTH_TOKEN, URL, CHANNEL_ID, DEBUG)
