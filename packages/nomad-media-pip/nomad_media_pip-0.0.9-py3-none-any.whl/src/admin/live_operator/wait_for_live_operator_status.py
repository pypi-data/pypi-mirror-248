from src.admin.live_operator.get_live_operator import _get_live_operator
from src.exceptions.api_exception_handler import _api_exception_handler

import time

def _wait_for_live_operator_status(AUTH_TOKEN, URL, OPERATOR_ID, STATUS_TO_WAIT_FOR, 
    ...
    while (ELAPSED_TIME < TIMEOUT):
        ...
        OPERATOR_STATUS = _get_live_operator(AUTH_TOKEN, URL, OPERATOR_ID)["status"]
