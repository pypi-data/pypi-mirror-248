...
class Nomad_SDK:
	...
	PREVIOUS_ID (str, None): The ID of the previous schedule event. Set to null if the schedule event is the first schedule event.
	Returns:
	...
	def update_asset_schedule_event(self, ID: str, CHANNEL_ID: str, ASSET: dict, IS_LOOP: bool, 
		...
		try:
			...
			ASSET_INFO = _update_asset_schedule_event(self.token, self.config["serviceApiUrl"], 
				ID, CHANNEL_ID, ASSET, IS_LOOP, DURATION_TIME_CODE, PREVIOUS_ID, self.debug_mode)
