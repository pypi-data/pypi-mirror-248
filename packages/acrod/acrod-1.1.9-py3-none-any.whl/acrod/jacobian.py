...
class Jacobian(object):
    ...
    :param str type: robot_type (either 'planar' or 'spatial').
    :param str P: list of all paths.
    :param str P_tilde: list of independent paths for linear velocities.
    :param str P_tilde_omega: list of independent paths for angular velocitites.
    :param str is_serial: boolean, mentioning whether the manipulator is a serial manipulator or not a serial manipulator. it is initialised with None before determining whether the manipulator is serial or not.
    :param str Ja: J_a in symbolic form.
    :param str Jp: J_p in symbolic form.
    :param str Aa: A_a in symbolic form.
    :param str Ap: A_p in symbolic form.
    :param str Ja_func: J_a in Python function form.
    :param str Jp_func: J_p in Python function form.
    :param str Aa_func: A_a in Python function form.
    :param str Ap_func: A_p in Python function form.
    :param str active_joint_velocities: list of active joint velocities, each in string format.
    :param str passive_joint_velocities: list of passive joint velocities, each in string format.
    :param str parameters: list of parameters (other than end-effector parameters), each in string format.
    :param str active_joint_velocities_symbolic: active joint velocities in symbolic form.
    :param str passive_joint_velocities_symbolic: passive joint velocities in symbolic form.
    :param str parameters_symbolic: list of parameters (other than end-effector parameters) in string format.
    :param str endeffector_variables_symbolic: end-effector parameters in symbolic form.
    :param str superfluous_dof_information: list containing information of superfluous DOF existing in the robot.
    """
