...
if __name__ == '__main__':
    ...
    with IBClient(TWS=True, Live=False) as ibClient:
        ...
        #legs = []
        #legs.append(optionLeg('NVDA', '20231229', 495, 'P', 1, 'BUY',  ibClient=ibClient))
        #legs.append(optionLeg('NVDA', '20231229', 500, 'P', 1, 'SELL', ibClient=ibClient))  
        #legs.append(optionLeg('NVDA', '20231229', 500, 'C', 1, 'SELL', ibClient=ibClient))
        #legs.append(optionLeg('NVDA', '20231229', 505, 'C', 1, 'BUY',  ibClient=ibClient))               
