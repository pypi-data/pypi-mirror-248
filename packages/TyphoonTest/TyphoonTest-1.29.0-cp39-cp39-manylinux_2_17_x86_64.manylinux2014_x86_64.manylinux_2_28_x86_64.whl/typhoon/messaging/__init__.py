...
class MinimalMsgSubscriber(IMsgSubscriber, Task):
    ...
    def subscribe(self, msg_pattern: str) -> None:
        ...
        try:
            ...
            err_msg = "Subscriber '{}' can't subscribe to '{}' due to '{}'".format(
                self.name, str(msg_pattern), str(ex)
            )
            print(err_msg)
            raise
    ...
    def unsubscribe(self, msg_pattern: object) -> None:
        ...
        try:
            ...
            err_msg = "Subscriber '{}' can't unsubscribe '{}' due to '{}'".format(
                self.name, str(msg_pattern), str(ex)
            )
            print(err_msg)
            raise
    ...
    def execute(self) -> None:
        ...
        """
        print(f"Starting subscriber '{self.name}' <{self.get_id()}>")
