...
class JSONInclude(object):
    ...
    def _parse_json_include(self, dirpath, filename):
        ...
        # When there are multiple includes in the same file, the logic requires multiple _walk_through_to_include
        # It is assumed that no more than 5 levels of nested includes are required
        # TODO: figure out how to avoid repeated calls and update the nested includes below instead
