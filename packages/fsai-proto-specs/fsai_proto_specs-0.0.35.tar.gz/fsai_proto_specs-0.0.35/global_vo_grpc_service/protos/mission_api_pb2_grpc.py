...
class MissionApiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FindMissionsByIds = channel.unary_unary(
                '/MissionApi/FindMissionsByIds',
                request_serializer=global__vo__grpc__service_dot_protos_dot_mission__api__pb2.FindMissionsByIdsRequest.SerializeToString,
                response_deserializer=global__vo__grpc__service_dot_protos_dot_mission__api__pb2.FindMissionsByIdsResponse.FromString,
                )
...
class MissionApiServicer(object):
    ...
    def FindMissionsByIds(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_MissionApiServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'FindMissionsByIds': grpc.unary_unary_rpc_method_handler(
                    servicer.FindMissionsByIds,
                    request_deserializer=global__vo__grpc__service_dot_protos_dot_mission__api__pb2.FindMissionsByIdsRequest.FromString,
                    response_serializer=global__vo__grpc__service_dot_protos_dot_mission__api__pb2.FindMissionsByIdsResponse.SerializeToString,
            ),
...
class MissionApi(object):
    ...
    def FindMissionsByIds(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/MissionApi/FindMissionsByIds',
            global__vo__grpc__service_dot_protos_dot_mission__api__pb2.FindMissionsByIdsRequest.SerializeToString,
            global__vo__grpc__service_dot_protos_dot_mission__api__pb2.FindMissionsByIdsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
