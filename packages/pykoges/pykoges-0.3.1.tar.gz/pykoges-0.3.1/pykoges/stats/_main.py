...
from ..koges import KogesData, split_data
from ..utils import isdiscrete, isbinary, iscontinuous, arr_to_df_split
...
def split(
    ...
    # 2. 데이터 분리
    _kg = split_data(_kg, n_class=n_class, isdisplay=isdisplay)
    # 3. 등분산성 검정
    if with_homogenity:
