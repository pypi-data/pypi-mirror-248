...
from pykoges.datatype import Patients, Patient, Question
from pykoges.utils import isbinary, isfloat, iscontinuous, isdiscrete
from pykoges.utils import mul, div, arr_to_df
from pykoges.utils.map import name_map, ekg_map
...
def drop(
    ...
    df_sdfilter = __drop_norm(df_drop, _kg.q, alpha=filter_alpha)
