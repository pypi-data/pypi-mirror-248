...
class ViewportOverlayInterface(traits.api.HasTraits):
    ...
    class Canvas(PythonViewportOverlay.ViewportOverlayCanvas):
        ...
        if os.environ.get('OVITO_SPHINX_BUILD', False):
            ...
            @property
            def preferred_qimage_format(self):
                """
                Optimal `QImage.Format <https://doc.qt.io/qtforpython-6/PySide6/QtGui/QImage.html#PySide6.QtGui.PySide6.QtGui.QImage.Format>`__ to be used with
            ...
            def project_location(self, world_xyz: Sequence[float]) -> tuple[float,float] | None:
                """
            ...
            def project_length(self, world_xyz: Sequence[float], length: float) -> float:
                """
