...
@LastEditTime: 2023-11-27 11:57:32
...
class StatConsoleModel():
    ...
    def __init__(self):
        ...
        if connect_key_config:
            self.db_connect_key = connect_key_config.get("db_stat") if connect_key_config.get("db_stat") else self.db_connect_key
            self.redis_config_dict = config.get_value(connect_key_config.get("redis_stat")) if connect_key_config.get("redis_stat") else self.redis_config_dict
