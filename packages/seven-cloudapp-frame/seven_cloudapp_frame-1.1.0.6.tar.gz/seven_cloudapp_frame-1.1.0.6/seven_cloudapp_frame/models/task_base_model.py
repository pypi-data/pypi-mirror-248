...
@LastEditTime: 2023-11-21 11:24:54
...
class TaskBaseModel(FrameBaseModel):
    ...
    def __init__(self, context=None,logging_error=None, logging_info=None):
        ...
        if connect_key_config:
            self.db_connect_key = connect_key_config.get("db_task") if connect_key_config.get("db_task") else self.db_connect_key
            self.redis_config_dict = config.get_value(connect_key_config.get("redis_task")) if connect_key_config.get("redis_task") else self.redis_config_dict
