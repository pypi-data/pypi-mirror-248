...
@LastEditTime: 2023-12-29 10:36:01
...
class AssetBaseModel():
    ...
    def __init__(self,context=None,logging_error=None,logging_info=None):
        ...
        if connect_key_config:
            self.db_connect_key = connect_key_config.get("db_asset") if connect_key_config.get("db_asset") else self.db_connect_key
            self.redis_config_dict = config.get_value(connect_key_config.get("redis_asset")) if connect_key_config.get("redis_asset") else self.redis_config_dict
