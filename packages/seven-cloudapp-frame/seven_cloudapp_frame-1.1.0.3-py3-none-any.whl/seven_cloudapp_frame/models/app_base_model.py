...
@LastEditTime: 2023-12-25 16:39:31
...
class AppBaseModel():
    ...
    def get_left_navigation(self, user_nick, access_token, app_key, app_secret, app_id="", is_instantiate_other_app=False):
        """
        :description: 获取左侧导航
        ...
        :param app_id: 应用标识
        :param is_instantiate_other_app: 是否同时实例化多个模板
        :return
        :last_editors: HuangJianYi
        """
        invoke_result_data = InvokeResultData()
        ...
        if is_instantiate_other_app == True:
            other_app_ver_list = []
            ...
            if len(app_template_dict_list) > 0:
                ...
                for app_template_dict in app_template_dict_list:
                    ...
                    other_app_ver_list.append(other_app_ver)
                
            data["other_app_ver_list"] = other_app_ver_list
