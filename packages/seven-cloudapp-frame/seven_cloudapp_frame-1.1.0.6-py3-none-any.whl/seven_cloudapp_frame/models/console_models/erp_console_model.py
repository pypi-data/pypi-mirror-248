...
@LastEditTime: 2023-12-29 13:47:05
...
class ErpConsoleModel():
    ...
    def __init__(self):
        ...
        if connect_key_config:
            self.db_connect_key = connect_key_config.get("db_order") if connect_key_config.get("db_order") else self.db_connect_key
            self.redis_config_dict = config.get_value(connect_key_config.get("redis_order")) if connect_key_config.get("redis_order") else self.redis_config_dict
