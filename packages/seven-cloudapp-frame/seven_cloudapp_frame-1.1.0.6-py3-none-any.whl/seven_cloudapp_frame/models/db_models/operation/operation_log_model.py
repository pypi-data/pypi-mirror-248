...
@LastEditTime: 2023-12-29 13:41:15
...
class OperationLogModel(CacheModel):
    def __init__(self, db_connect_key='db_cloudapp', sub_table=None, db_transaction=None, context=None):
        ...
        if connect_key_config:
            db_connect_key = connect_key_config.get("db_cms") if connect_key_config.get("db_cms") else db_connect_key
            self.redis_config_dict = share_config.get_value(connect_key_config.get("redis_cms")) if connect_key_config.get("redis_cms") else self.redis_config_dict
