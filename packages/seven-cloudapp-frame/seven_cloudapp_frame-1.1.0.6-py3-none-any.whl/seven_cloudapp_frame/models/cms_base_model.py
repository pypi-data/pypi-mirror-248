...
class CmsBaseModel():
    ...
    def __init__(self, context=None, logging_error=None, logging_info=None):
        ...
        self.db_connect_key = "db_cms" if config.get_value("db_cms") else "db_cloudapp"
        self.redis_config_dict = config.get_value("redis_cms") if config.get_value("redis_cms") else None
        connect_key_config = share_config.get_value("connect_key_config")
        if connect_key_config:
            self.db_connect_key = connect_key_config.get("db_cms") if connect_key_config.get("db_cms") else self.db_connect_key
            self.redis_config_dict = config.get_value(connect_key_config.get("redis_cms")) if connect_key_config.get("redis_cms") else self.redis_config_dict
