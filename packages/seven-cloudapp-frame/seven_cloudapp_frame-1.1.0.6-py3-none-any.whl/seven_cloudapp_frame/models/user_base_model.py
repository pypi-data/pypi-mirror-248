...
@LastEditTime: 2023-12-29 11:15:53
...
class UserBaseModel(FrameBaseModel):
    ...
    def __init__(self, context=None, logging_error=None, logging_info=None):
        ...
        if connect_key_config:
            self.db_connect_key = connect_key_config.get("db_user") if connect_key_config.get("db_user") else self.db_connect_key
            self.redis_config_dict = config.get_value(connect_key_config.get("redis_user")) if connect_key_config.get("redis_user") else self.redis_config_dict
