...
@LastEditTime: 2023-12-26 18:40:21
        ...
        if plat_type == PlatType.tb.value:
            if self._request_source_type() == 2:
                ...
                if app_id == share_config.get_value("client_template_id") or app_id == "":
                    ...
                    app_relation_dict = app_relation_model.get_cache_dict(where="app_id=%s", limit="1", field="parent_app_id", params=[app_id])
                    if app_relation_dict:
                        app_id = app_relation_dict["parent_app_id"]
