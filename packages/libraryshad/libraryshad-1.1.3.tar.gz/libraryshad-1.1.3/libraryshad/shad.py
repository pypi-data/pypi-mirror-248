...
class Bot:
	...
	async def send_file(self,file,chat_id, message_id=None, caption=None):
	...
	async def send_music(self,file,chat_id, message_id=None, caption=None):
		uresponse = await self.upload(file)
		file_id = str(uresponse[0]["id"])
		mime = file.split(".")[-1]
		dc_id = uresponse[0]["dc_id"]
		...
		file_name = file.split("/")[-1]
		size = str(len(open(file,"rb").read()))
		inData = {"method":"sendMessage","input":{"object_guid":chat_id,"reply_to_message_id":message_id,"rnd":f"{randint(100000,999999999)}","file_inline":{"dc_id":str(dc_id),"file_id":str(file_id),"type":"Music","file_name":file_name,"size":size,"mime":mime,"access_hash_rec":access_hash_rec}},"client": {"app_name":"Main","app_version":"3.5.5","lang_code":"fa","package":"ir.medu.shad","temp_code":"31","platform":"Android"}}
		if caption != None: inData["input"]["text"] = caption
		data = await self.post_data(inData)
		return data
	
	async def send_voice(self,file,chat_id, message_id=None, caption=None):
		uresponse = await self.upload(file)
		file_id = str(uresponse[0]["id"])
		mime = file.split(".")[-1]
		dc_id = uresponse[0]["dc_id"]
		...
		file_name = file.split("/")[-1]
		size = str(len(open(file,"rb").read()))
		inData = {"method":"sendMessage","input":{"object_guid":chat_id,"reply_to_message_id":message_id,"rnd":f"{randint(100000,999999999)}","file_inline":{"dc_id":str(dc_id),"file_id":str(file_id),"type":"Voice","file_name":file_name,"size":size,"mime":mime,"access_hash_rec":access_hash_rec}},"client": {"app_name":"Main","app_version":"3.5.5","lang_code":"fa","package":"ir.medu.shad","temp_code":"31","platform":"Android"}}
		if caption != None: inData["input"]["text"] = caption
		data = await self.post_data(inData)
		return data
	
	async def send_video(self,file,chat_id, message_id=None, caption=None):
		uresponse = await self.upload(file)
		file_id = str(uresponse[0]["id"])
		mime = file.split(".")[-1]
		dc_id = uresponse[0]["dc_id"]
		...
		file_name = file.split("/")[-1]
		size = str(len(open(file,"rb").read()))
		inData = {"method":"sendMessage","input":{"object_guid":chat_id,"reply_to_message_id":message_id,"rnd":f"{randint(100000,999999999)}","file_inline":{"dc_id":str(dc_id),"file_id":str(file_id),"type":"Video","file_name":file_name,"size":size,"mime":mime,"access_hash_rec":access_hash_rec}},"client": {"app_name":"Main","app_version":"3.5.5","lang_code":"fa","package":"ir.medu.shad","temp_code":"31","platform":"Android"}}
		if caption != None: inData["input"]["text"] = caption
		data = await self.post_data(inData)
		return data
	
	async def send_image(self,file,chat_id, message_id=None, caption=None):
		uresponse = await self.upload(file)
		file_id = str(uresponse[0]["id"])
		mime = file.split(".")[-1]
		dc_id = uresponse[0]["dc_id"]
		...
		file_name = file.split("/")[-1]
		size = str(len(open(file,"rb").read()))
		inData = {"method":"sendMessage","input":{"object_guid":chat_id,"reply_to_message_id":message_id,"rnd":f"{randint(100000,999999999)}","file_inline":{"dc_id":str(dc_id),"file_id":str(file_id),"type":"Image","file_name":file_name,"size":size,"mime":mime,"access_hash_rec":access_hash_rec}},"client": {"app_name":"Main","app_version":"3.5.5","lang_code":"fa","package":"ir.medu.shad","temp_code":"31","platform":"Android"}}
		if caption != None: inData["input"]["text"] = caption
		data = await self.post_data(inData)
		return data
