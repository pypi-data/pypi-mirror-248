...
class Forum:
    ...
    async def GetTopicsPaged(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Forum/GetTopicsPaged/{page}/{pageSize}/{group}/{sort}/{quickDate}/{categoryFilter}/"
            )
    ...
    async def GetCoreTopicsPaged(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Forum/GetCoreTopicsPaged/{page}/{sort}/{quickDate}/{categoryFilter}/"
            )
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetPostsThreadedPaged(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Forum/GetPostsThreadedPaged/{parentPostId}/{page}/{pageSize}/{replySize}/{getParentPost}/{rootThreadMode}/{sortMode}/"
            )
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetPostsThreadedPagedFromChild(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Forum/GetPostsThreadedPagedFromChild/{childPostId}/{page}/{pageSize}/{replySize}/{rootThreadMode}/{sortMode}/"
            )
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetPostAndParent(self, childPostId: int, showbanned: str) -> dict:
        ...
        try:
            ...
            url = self.base_url + f"/Forum/GetPostAndParent/{childPostId}/"
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetPostAndParentAwaitingApproval(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Forum/GetPostAndParentAwaitingApproval/{childPostId}/"
            )
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetTopicForContent(self, contentId: int) -> dict:
        ...
        try:
            ...
            url = self.base_url + f"/Forum/GetTopicForContent/{contentId}/"
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetForumTagSuggestions(self, partialtag: str) -> dict:
        ...
        try:
            ...
            url = self.base_url + "/Forum/GetForumTagSuggestions/"
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetPoll(self, topicId: int) -> dict:
        ...
        try:
            ...
            url = self.base_url + f"/Forum/Poll/{topicId}/"
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetRecruitmentThreadSummaries(self) -> dict:
        ...
        try:
            ...
            url = self.base_url + "/Forum/Recruit/Summaries/"
