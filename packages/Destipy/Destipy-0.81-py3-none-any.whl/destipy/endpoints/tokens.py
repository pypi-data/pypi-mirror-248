...
class Tokens:
    ...
    async def ForceDropsRepair(self, access_token: str) -> dict:
        ...
        try:
            ...
            url = self.base_url + "/Tokens/Partner/ForceDropsRepair/"
    ...
    async def ClaimPartnerOffer(
        ...
        try:
            ...
            url = self.base_url + "/Tokens/Partner/ClaimOffer/"
            return await self.requester.request(
    ...
    async def ApplyMissingPartnerOffersWithoutClaim(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Tokens/Partner/ApplyMissingOffers/{partnerApplicationId}/{targetBnetMembershipId}/"
            )
            return await self.requester.request(
                method=HTTPMethod.POST, url=url, access_token=access_token
            )
    ...
    async def GetPartnerOfferSkuHistory(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Tokens/Partner/History/{partnerApplicationId}/{targetBnetMembershipId}/"
            )
            return await self.requester.request(
    ...
    async def GetPartnerRewardHistory(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Tokens/Partner/History/{targetBnetMembershipId}/Application/{partnerApplicationId}/"
            )
            return await self.requester.request(
                method=HTTPMethod.GET, url=url, access_token=access_token
            )
    ...
    async def GetBungieRewardsForUser(
        ...
        try:
            ...
            url = self.base_url + f"/Tokens/Rewards/GetRewardsForUser/{membershipId}/"
            return await self.requester.request(
                method=HTTPMethod.GET, url=url, access_token=access_token
            )
        except Exception as ex:
    ...
    async def GetBungieRewardsForPlatformUser(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Tokens/Rewards/GetRewardsForPlatformUser/{membershipId}/{membershipType}/"
            )
            return await self.requester.request(
                method=HTTPMethod.GET, url=url, access_token=access_token
            )
    ...
    async def GetBungieRewardsList(self) -> dict:
        ...
        try:
            ...
            url = self.base_url + "/Tokens/Rewards/BungieRewards/"
