...
class Fireteam:
    ...
    async def GetActivePrivateClanFireteamCount(
        ...
        try:
            ...
            url = self.base_url + f"/Fireteam/Clan/{groupId}/ActiveCount/"
    ...
    async def GetAvailableClanFireteams(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Fireteam/Clan/{groupId}/Available/{platform}/{activityType}/{dateRange}/{slotFilter}/{publicOnly}/{page}/"
            )
            return await self.requester.request(
                method=HTTPMethod.GET, url=url, access_token=access_token
            )
    ...
    async def SearchPublicAvailableClanFireteams(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Fireteam/Search/Available/{platform}/{activityType}/{dateRange}/{slotFilter}/{page}/"
            )
            return await self.requester.request(
                method=HTTPMethod.GET, url=url, access_token=access_token
            )
    ...
    async def GetMyClanFireteams(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Fireteam/Clan/{groupId}/My/{platform}/{includeClosed}/{page}/"
            )
            return await self.requester.request(
                method=HTTPMethod.GET, url=url, access_token=access_token
            )
    ...
    async def GetClanFireteam(
        ...
        try:
            ...
            url = self.base_url + f"/Fireteam/Clan/{groupId}/Summary/{fireteamId}/"
            return await self.requester.request(
                method=HTTPMethod.GET, url=url, access_token=access_token
            )
        except Exception as ex:
