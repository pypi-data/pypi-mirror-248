...
class Destiny2:
    ...
    async def GetDestinyManifest(self) -> dict:
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Manifest/"
    ...
    async def GetDestinyEntityDefinition(
        ...
        try:
            ...
            url = self.base_url + f"/Destiny2/Manifest/{entityType}/{hashIdentifier}/"
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def SearchDestinyPlayerByBungieName(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Destiny2/SearchDestinyPlayerByBungieName/{membershipType}/"
            )
    ...
    async def GetProfile(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Destiny2/{membershipType}/Profile/{destinyMembershipId}/"
            )
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetCharacter(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Destiny2/{membershipType}/Profile/{destinyMembershipId}/Character/{characterId}/"
            )
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetClanWeeklyRewardState(self, groupId: int) -> dict:
        ...
        try:
            ...
            url = self.base_url + f"/Destiny2/Clan/{groupId}/WeeklyRewardState/"
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetClanBannerSource(self) -> dict:
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Clan/ClanBannerDictionary/"
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetItem(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Destiny2/{membershipType}/Profile/{destinyMembershipId}/Item/{itemInstanceId}/"
            )
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetVendors(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Destiny2/{membershipType}/Profile/{destinyMembershipId}/Character/{characterId}/Vendors/"
            )
            return await self.requester.request(
    ...
    async def GetVendor(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Destiny2/{membershipType}/Profile/{destinyMembershipId}/Character/{characterId}/Vendors/{vendorHash}/"
            )
            return await self.requester.request(
                method=HTTPMethod.GET, url=url, access_token=access_token
            )
    ...
    async def GetPublicVendors(self, components: list) -> dict:
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Vendors/"
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetCollectibleNodeDetails(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Destiny2/{membershipType}/Profile/{destinyMembershipId}/Character/{characterId}/Collectibles/{collectiblePresentationNodeHash}/"
            )
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def TransferItem(
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Actions/Items/TransferItem/"
            return await self.requester.request(
    ...
    async def PullFromPostmaster(
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Actions/Items/PullFromPostmaster/"
            return await self.requester.request(
                method=HTTPMethod.POST,
                url=url,
                data=request_body,
    ...
    async def EquipItem(
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Actions/Items/EquipItem/"
            return await self.requester.request(
                method=HTTPMethod.POST,
                url=url,
                data=request_body,
    ...
    async def EquipItems(
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Actions/Items/EquipItems/"
            return await self.requester.request(
                method=HTTPMethod.POST,
                url=url,
                data=request_body,
    ...
    async def EquipLoadout(
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Actions/Loadouts/EquipLoadout/"
            return await self.requester.request(
                method=HTTPMethod.POST,
                url=url,
                data=request_body,
    ...
    async def SnapshotLoadout(
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Actions/Loadouts/SnapshotLoadout/"
            return await self.requester.request(
                method=HTTPMethod.POST,
                url=url,
                data=request_body,
    ...
    async def UpdateLoadoutIdentifiers(
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Actions/Loadouts/UpdateLoadoutIdentifiers/"
            return await self.requester.request(
                method=HTTPMethod.POST,
                url=url,
                data=request_body,
    ...
    async def ClearLoadout(
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Actions/Loadouts/ClearLoadout/"
            return await self.requester.request(
                method=HTTPMethod.POST,
                url=url,
                data=request_body,
    ...
    async def SetItemLockState(
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Actions/Items/SetLockState/"
            return await self.requester.request(
                method=HTTPMethod.POST,
                url=url,
                data=request_body,
    ...
    async def SetQuestTrackedState(
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Actions/Items/SetTrackedState/"
            return await self.requester.request(
                method=HTTPMethod.POST,
                url=url,
                data=request_body,
    ...
    async def InsertSocketPlug(
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Actions/Items/InsertSocketPlug/"
            return await self.requester.request(
                method=HTTPMethod.POST,
                url=url,
                data=request_body,
    ...
    async def InsertSocketPlugFree(
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Actions/Items/InsertSocketPlugFree/"
            return await self.requester.request(
                method=HTTPMethod.POST,
                url=url,
                data=request_body,
    ...
    async def GetPostGameCarnageReport(self, activityId: int) -> dict:
        ...
        try:
            ...
            url = self.base_url + f"/Destiny2/Stats/PostGameCarnageReport/{activityId}/"
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def ReportOffensivePostGameCarnageReportPlayer(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Destiny2/Stats/PostGameCarnageReport/{activityId}/Report/"
            )
            return await self.requester.request(
                method=HTTPMethod.POST,
                url=url,
    ...
    async def GetHistoricalStatsDefinition(self) -> dict:
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Stats/Definition/"
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetClanLeaderboards(
        ...
        try:
            ...
            url = self.base_url + f"/Destiny2/Stats/Leaderboards/Clans/{groupId}/"
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetClanAggregateStats(self, groupId: int, modes: str) -> dict:
        ...
        try:
            ...
            url = self.base_url + f"/Destiny2/Stats/AggregateClanStats/{groupId}/"
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetLeaderboards(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Destiny2/{membershipType}/Account/{destinyMembershipId}/Stats/Leaderboards/"
            )
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetLeaderboardsForCharacter(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Destiny2/Stats/Leaderboards/{membershipType}/{destinyMembershipId}/{characterId}/"
            )
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def SearchDestinyEntities(
        ...
        try:
            ...
            url = self.base_url + f"/Destiny2/Armory/Search/{type}/{searchTerm}/"
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetHistoricalStats(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Destiny2/{membershipType}/Account/{destinyMembershipId}/Character/{characterId}/Stats/"
            )
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetHistoricalStatsForAccount(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Destiny2/{membershipType}/Account/{destinyMembershipId}/Stats/"
            )
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetActivityHistory(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Destiny2/{membershipType}/Account/{destinyMembershipId}/Character/{characterId}/Stats/Activities/"
            )
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetUniqueWeaponHistory(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Destiny2/{membershipType}/Account/{destinyMembershipId}/Character/{characterId}/Stats/UniqueWeapons/"
            )
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetDestinyAggregateActivityStats(
        ...
        try:
            ...
            url = (
                self.base_url
                + f"/Destiny2/{membershipType}/Account/{destinyMembershipId}/Character/{characterId}/Stats/AggregateActivityStats/"
            )
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetPublicMilestoneContent(self, milestoneHash: int) -> dict:
        ...
        try:
            ...
            url = self.base_url + f"/Destiny2/Milestones/{milestoneHash}/Content/"
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def GetPublicMilestones(self) -> dict:
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Milestones/"
            return await self.requester.request(method=HTTPMethod.GET, url=url)
        except Exception as ex:
            self.logger.exception(ex)
    ...
    async def AwaInitializeRequest(
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Awa/Initialize/"
            return await self.requester.request(
                method=HTTPMethod.POST,
                url=url,
                data=request_body,
    ...
    async def AwaProvideAuthorizationResult(
        ...
        try:
            ...
            url = self.base_url + "/Destiny2/Awa/AwaProvideAuthorizationResult/"
            return await self.requester.request(
                method=HTTPMethod.POST, url=url, data=request_body
            )
        except Exception as ex:
    ...
    async def AwaGetActionToken(self, correlationId: str, access_token: str) -> dict:
        ...
        try:
            ...
            url = self.base_url + f"/Destiny2/Awa/GetActionToken/{correlationId}/"
            return await self.requester.request(
                method=HTTPMethod.GET, url=url, access_token=access_token
            )
        except Exception as ex:
