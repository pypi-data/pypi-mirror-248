  ...
  'syms': { 'bellek.kuzu': {},
            ...
            'bellek.ml.llm.dataset': { 'bellek.ml.llm.dataset.alpaca2openai': ( 'ml.llm.dataset.html#alpaca2openai',
                                       ...
                                       'bellek.ml.llm.dataset.sharegpt_from2openai_role': ( 'ml.llm.dataset.html#sharegpt_from2openai_role',
                                                                                            'bellek/ml/llm/dataset.py')},
            'bellek.ml.llm.obs': { 'bellek.ml.llm.obs.TraceRecorder': ('ml.llm.obs.html#tracerecorder', 'bellek/ml/llm/obs.py'),
                                   'bellek.ml.llm.obs.TraceRecorder.__call__': ( 'ml.llm.obs.html#tracerecorder.__call__',
                                                                                 'bellek/ml/llm/obs.py'),
                                   'bellek.ml.llm.obs.TraceRecorder.__init__': ( 'ml.llm.obs.html#tracerecorder.__init__',
                                                                                 'bellek/ml/llm/obs.py'),
