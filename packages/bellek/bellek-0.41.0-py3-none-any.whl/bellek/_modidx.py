  ...
  'syms': { 'bellek.kuzu': {},
            ...
            'bellek.ml.llm.dataset': { 'bellek.ml.llm.dataset.alpaca2openai': ( 'ml.llm.dataset.html#alpaca2openai',
                                       ...
                                       'bellek.ml.llm.dataset.sharegpt_from2openai_role': ( 'ml.llm.dataset.html#sharegpt_from2openai_role',
                                                                                            'bellek/ml/llm/dataset.py')},
            'bellek.ml.llm.obs': { 'bellek.ml.llm.obs.TracePersister': ('ml.llm.obs.html#tracepersister', 'bellek/ml/llm/obs.py'),
                                   'bellek.ml.llm.obs.TracePersister.__call__': ( 'ml.llm.obs.html#tracepersister.__call__',
                                                                                  'bellek/ml/llm/obs.py'),
                                   'bellek.ml.llm.obs.TracePersister.__init__': ( 'ml.llm.obs.html#tracepersister.__init__',
                                                                                  'bellek/ml/llm/obs.py'),
                                   'bellek.ml.llm.obs.make_phoenix_trace_callback_handler': ( 'ml.llm.obs.html#make_phoenix_trace_callback_handler',
                                                                                              'bellek/ml/llm/obs.py')},
            'bellek.ml.llm.qdecomp': { 'bellek.ml.llm.qdecomp.make_question_decomposer': ( 'ml.llm.qdecomp.html#make_question_decomposer',
                                                                                           'bellek/ml/llm/qdecomp.py'),
                                       'bellek.ml.llm.qdecomp.parse_sub_questions': ( 'ml.llm.qdecomp.html#parse_sub_questions',
                                                                                      'bellek/ml/llm/qdecomp.py')},
