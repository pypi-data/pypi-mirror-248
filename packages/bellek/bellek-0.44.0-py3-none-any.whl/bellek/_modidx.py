...
d = { 'settings': { 'branch': 'master',
                ...
                'lib_path': 'bellek'},
  'syms': { 'bellek.jerx.dataset': { 'bellek.jerx.dataset._batch_transform_webnlg': ( 'jerx.dataset.html#_batch_transform_webnlg',
                                     ...
                                     'bellek.jerx.dataset.batch_transform_webnlg': ( 'jerx.dataset.html#batch_transform_webnlg',
                                                                                     'bellek/jerx/dataset.py')},
            'bellek.jerx.eval': { 'bellek.jerx.eval.evaluate_joint_er_extraction': ( 'jerx.eval.html#evaluate_joint_er_extraction',
                                                                                     'bellek/jerx/eval.py'),
                                  'bellek.jerx.eval.evaluate_joint_er_extractions': ( 'jerx.eval.html#evaluate_joint_er_extractions',
                                                                                      'bellek/jerx/eval.py'),
                                  'bellek.jerx.eval.evaluate_model_jer': ('jerx.eval.html#evaluate_model_jer', 'bellek/jerx/eval.py'),
                                  'bellek.jerx.eval.evaluate_pipe_jer': ('jerx.eval.html#evaluate_pipe_jer', 'bellek/jerx/eval.py')},
