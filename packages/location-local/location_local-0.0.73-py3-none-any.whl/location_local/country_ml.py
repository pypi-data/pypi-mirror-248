...
class CountryMl(GenericCRUDML):
    ...
    def __init__(self):
        ...
        super().__init__(default_schema_name=LocationLocalConstants.LOCATION_SCHEMA_NAME,  # noqa501
                         default_table_name=LocationLocalConstants.COUNTRY_ML_TABLE_NAME,  # noqa501
                         default_view_table_name=LocationLocalConstants.COUNTRY_ML_VIEW_NAME,  # noqa501
    ...
    def insert(self, country_id: int, country: str, lang_code: LangCode,
        ...
        country_ml_id = super().insert(data_json=country_ml_json)
