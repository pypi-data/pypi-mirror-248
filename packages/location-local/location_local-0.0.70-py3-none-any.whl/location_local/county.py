...
class County(GenericCRUD):
    ...
    def get_county_id_by_county_name_state_id(county_name: str, state_id: int = None) -> int:  # noqa501
        ...
        county_id = County.county_ml.select_one_by_value_with_none_option(condition_column_name='title',  # noqa501
                                                              condition_column_value=f"{county_name}",  # noqa501
                                                              select_column_name=LocationLocalConstants.COUNTY_ID_COLUMN_NAME)  # noqa501
