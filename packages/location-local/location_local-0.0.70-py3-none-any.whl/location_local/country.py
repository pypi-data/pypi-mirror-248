...
class Country(GenericCRUD):
    ...
    def get_country_id_by_country_name(country_name: str) -> int:
        ...
        country_id = Country.country_ml.select_one_by_value_with_none_option(select_column_name=LocationLocalConstants.COUNTRY_ID_COLUMN_NAME,  # noqa501
                                                                condition_column_name= 'name',  # noqa501
                                                                condition_column_value= f"{country_name}")  # noqa501
