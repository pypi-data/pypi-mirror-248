...
class Neighborhood(GenericCRUD):
    ...
    def get_neighborhood_id_by_neighborhood_name(neighborhood_name: str,
        ...
        neighborhood_id = Neighborhood.neighborhood_ml.select_one_by_value_with_none_option(condition_column_name='title',  # noqa501
                                                                          condition_column_value=f"{neighborhood_name}",  # noqa501
                                                                          select_column_name=LocationLocalConstants.NEIGHBORHOOD_ID_COLUMN_NAME)  # noqa501
