...
class City(GenericCRUD):
    ...
    def get_city_id_by_city_name_state_id(city_name: str, state_id: int = None) -> int:  # noqa501
        ...
        city_id = City.city_ml.select_one_by_value_with_none_option(condition_column_name='title',  # noqa501
                                                              condition_column_value=f"{city_name}",  # noqa501
                                                              select_column_name=LocationLocalConstants.CITY_ID_COLUMN_NAME)  # noqa501
