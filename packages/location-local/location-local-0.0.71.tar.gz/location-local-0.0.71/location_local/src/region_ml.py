...
class RegionMl(GenericCRUDML):
    ...
    def __init__(self):
        ...
        super().__init__(default_schema_name=LocationLocalConstants.LOCATION_SCHEMA_NAME,  # noqa501
                         default_table_name=LocationLocalConstants.REGION_ML_TABLE_NAME,  # noqa501
                         default_view_table_name=LocationLocalConstants.REGION_ML_VIEW_NAME,  # noqa501
    ...
    def insert(self, region_id: int, region: str,
        ...
        region_ml_id = super().insert(data_json=region_ml_json)
