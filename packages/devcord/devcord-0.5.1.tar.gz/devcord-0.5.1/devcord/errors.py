...
class devcordException(Exception):
    """Base exception class for all devcord exceptions."""


class ConvertTimeError(devcordException):
    """Raised when a time conversion fails."""


class Blacklisted(devcordException):
