...
class Bot(_main_bot):  # type: ignore
    """The devcord bot class. This is a subclass of :class:`discord.Bot` if you use Pycord.
    ...
    **kwargs:
    ...
    def add_help_command(
        ...
        *,
        ...
        if not DPY:
            self.load_extension("devcord.cogs.pyc.help_setup", package="devcord")
    ...
    def add_status_changer(
        ...
        **kwargs:
        ...
        if not DPY:
            self.load_extension("devcord.cogs.pyc.status_changer_setup", package="devcord")
    ...
    def add_blacklist(
        ...
        *,
        ...
        if not DPY:
            self.load_extension("devcord.cogs.pyc.blacklist_setup", package="devcord")
    ...
    async def setup_hook(self):
        ...
        for ext in self.enabled_extensions:
            await self.load_extension(f".cogs.dpy.{ext}_setup", package="devcord")
...
class PrefixBot(Bot, commands.Bot):
    ...
    This class can be used if you want to use devcord with prefix commands.
...
class BridgeBot(Bot, bridge.Bot):
    ...
    This class can be used if you want to use devcord with bridge commands.
    This is only needed for Pycord.
    """
