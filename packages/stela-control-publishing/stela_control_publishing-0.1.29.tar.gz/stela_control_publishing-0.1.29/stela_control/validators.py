...
def coreHandlers(request):
    if request.method == 'POST':        
        ...
        if action == "loadPagesBlog":
            ...
            new_pages = render_to_string('stela_control/load-data/handlers/blog-pages.html', {
        ...
        if form_id == "blog-search":
            ...
            if blog_posts:
                ...
                new_pages = render_to_string('stela_control/load-data/handlers/blog/blog-empty.html')
            return JsonResponse({'response': new_pages})