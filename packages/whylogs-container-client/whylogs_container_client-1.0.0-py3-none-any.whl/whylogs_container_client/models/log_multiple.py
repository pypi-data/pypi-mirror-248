...
class LogMultiple:
    ...
    Attributes:
        columns (List[str]):
        data (List[List[Union[List[float], List[int], List[str], bool, float, int, str]]]):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        for data_item_data in self.data:
            ...
            for data_item_item_data in data_item_data:
                data_item_item: Union[List[float], List[int], List[str], bool, float, int, str]
        ...
        for data_item_data in _data:
            ...
            for data_item_item_data in _data_item:
                ...
                def _parse_data_item_item(
                    data: object,
                ) -> Union[List[float], List[int], List[str], bool, float, int, str]:
                    try:
                    ...
                    try:
                        ...
                        pass
                    return cast(Union[List[float], List[int], List[str], bool, float, int, str], data)
