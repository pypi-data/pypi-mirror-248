...
@plugin_function(categories=['label', 'bia-bob-suggestion'], output_creator=create_labels_like)
def masked_voronoi_labeling(binary_source : Image, mask_image : Image, labeling_destination : Image = None) -> Image:
