...
def validate_inputs(*, input_data: pd.DataFrame) -> Tuple[pd.DataFrame, Optional[dict]]:
    ...
    input_data["job"] = input_data["job"].astype("float")
    input_data["marital"] = input_data["marital"].astype("float")
    input_data["education"] = input_data["education"].astype("float")
    input_data["default"] = input_data["default"].astype("float")
    input_data["balance"] = input_data["balance"].astype("float")
    input_data["housing"] = input_data["housing"].astype("float")
    input_data["loan"] = input_data["loan"].astype("float")
    input_data["contact"] = input_data["contact"].astype("float")
    input_data["day"] = input_data["day"].astype("float")
    input_data["month"] = input_data["month"].astype("float")
    input_data["duration"] = input_data["duration"].astype("float")
    input_data["campaign"] = input_data["campaign"].astype("float")
    input_data["pdays"] = input_data["pdays"].astype("float")
    input_data["previous"] = input_data["previous"].astype("float")
    input_data["poutcome"] = input_data["poutcome"].astype("float")
