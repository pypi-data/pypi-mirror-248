...
from llm_agent.prompts.chameleon_prompt import chameleon_global_prompt_pgm
from llm_agent.prompts.undercover_prompt import undercover_clue_demo, undercover_view_demo, global_prompt_undercover_pgm
        ...
        for player_config in config.players:
            ...
            if config.environment.env_type.startswith("chameleon"): 
                ...
                if fix_player:
                    ...
                    player_config["clue_demo"] = undercover_clue_demo # now demo is empty
                    player_config["view_demo"] = undercover_view_demo # now demo is empty
