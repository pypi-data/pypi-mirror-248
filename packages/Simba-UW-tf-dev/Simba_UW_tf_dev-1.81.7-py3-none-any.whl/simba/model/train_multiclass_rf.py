...
class TrainMultiClassRandomForestClassifier(ConfigReader, TrainModelMixin):
    def __init__(self,
        ...
        self.data_df, self.frm_idx = self.read_all_files_in_folder_mp_futures(file_paths=self.target_file_paths, file_type=self.file_type, classifier_names=self.clf_names, raise_bool_clf_error=False)
