...
class MessageLocal(Item, GenericCRUD):
    ...
    def __can_send_direct(self, api_data: dict = None) -> bool:
    ...
    def __can_send_indirect(self, outgoing_body: dict = None) -> bool:
        # TODO: implement sender_profile_id logic
    ...
    def after_send_attempt(self, outgoing_body: dict = None,
