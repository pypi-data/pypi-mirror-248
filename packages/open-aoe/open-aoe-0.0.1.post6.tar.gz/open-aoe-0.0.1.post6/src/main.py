...
from src.backend.api.route_minimax import router as minimax_router
from src.backend.api.route_openai import router as openai_router
from src.backend.api.route_baidu import router as baidu_router
from src.backend.api.route_google import router as google_router
from src.backend.api.route_claude import router as claude_router
from src.backend.api.route_xunfei import router as xunfei_router
from src.backend.util.log import log
from src.backend.job.jobs import start_jobs

from src.backend.util.exception import OpenAIException, is_openai_key_limited
from src.backend.util.request_info import set_request_keys_need_rotate
from src.backend.model.dto.ReturnBase import ReturnBase

from fastapi.responses import FileResponse
from starlette.responses import HTMLResponse
from fastapi.staticfiles import StaticFiles
from src.backend.config.biz_config import app_abs_path, img_out_path
from src.backend.util.str_util import safe_join
import os
