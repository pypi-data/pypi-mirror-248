...
class SwingExecutorService(java.util.concurrent.AbstractExecutorService):
    LATER: ghidra.async.SwingExecutorService = ghidra.async.SwingExecutorService$1@b2dcda
    MAYBE_NOW: ghidra.async.SwingExecutorService = ghidra.async.SwingExecutorService$2@53d74d6f
