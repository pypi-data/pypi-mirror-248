...
def main():
    ...
    dc_client.annotate(user_inter_id, AnnotationType.GOOD)
    ...
    if OPENAI_API_KEY:
        ...
        for interaction in dc_client.golden_set_iterator(version_name="0.0.1"):
            print(f"processing golden set interaction with unique_interaction_id: {interaction.user_interaction_id}  "
