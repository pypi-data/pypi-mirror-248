...
/* harmony import */ var _is__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(18);
/* harmony import */ var _htmldomapi__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(17);
...
/* harmony export */ });
/* harmony import */ var _vnode__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(16);
/* harmony import */ var _is__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(18);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ('0.4.11');
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_0_use_1_node_modules_sass_loader_dist_cjs_js_ruleSet_1_rules_0_use_2_main_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(42);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(43);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `html, body, button, input, select {
...
body > .main > .panel-resizer {
  cursor: ew-resize;
  width: 0.4rem;
  flex-shrink: 0;
}
body > .main > .left-panel {
...
body > .main > .left-panel .invalid {
  background-color: rgba(255, 0, 0, 0.3);
}
body > .main > .left-panel > .header {
  flex-shrink: 0;
  margin: 1rem;
  display: flex;
  align-items: stretch;
...
body > .main > .left-panel > .header > .title {
  flex-grow: 1;
  font-size: 1.4rem;
  font-weight: 500;
  color: #616161;
}
body > .main > .left-panel > .header > .title > .version {
  font-size: 0.8rem;
  padding-left: 0.5rem;
}
body > .main > .left-panel > .form {
  display: grid;
...
body > .main > .left-panel > .form > .label {
  font-weight: 600;
  color: #424242;
}
body > .main > .left-panel > .content {
  flex-grow: 1;
  display: flex;
  flex-direction: column;
  margin: 1rem;
...
body > .main > .left-panel > .content > div {
  margin-bottom: 1rem;
}
body > .main > .left-panel > .content > div > table {
  width: 100%;
}
body > .main > .left-panel > .content > div > table .col-quantity, body > .main > .left-panel > .content > div > table .col-height, body > .main > .left-panel > .content > div > table .col-width {
  width: 5rem;
}
body > .main > .left-panel > .content > div > table .col-quantity input, body > .main > .left-panel > .content > div > table .col-height input, body > .main > .left-panel > .content > div > table .col-width input {
  text-align: right;
}
body > .main > .left-panel > .content > div > table .col-rotate {
  width: 4rem;
}
body > .main > .left-panel > .content > div > table .col-delete {
  width: 2rem;
}
body > .main > .left-panel > .content > div > table > thead th {
  font-weight: 600;
  color: #424242;
  text-align: left;
}
body > .main > .left-panel > .content > div > table > thead th.col-rotate {
  text-align: center;
}
body > .main > .left-panel > .content > div > table > tbody td div {
  display: flex;
...
body > .main > .left-panel > .content > div > table > tfoot td > div {
  display: flex;
}
body > .main > .left-panel > .content > div > table > tfoot td > div > .spacer {
  flex-grow: 1;
}
body > .main > .left-panel > .calculate {
  flex-shrink: 0;
  margin: 1rem;
  padding: 1rem;
}
...
body > .main > .right-panel .form > .label {
  font-weight: 600;
  color: #424242;
}
body > .main > .right-panel .panel {
  margin: 1.5rem 0;
}
body > .main > .right-panel .panel > *:hover {
  background-color: #E0E0E0;
  cursor: pointer;
}
body > .main > .right-panel .panel-name {
  padding: 0.4rem 1rem;
  overflow: hidden;
...
body > .main > .right-panel .item {
  padding: 0.4rem 1rem 0.4rem 2rem;
  display: flex;
}
body > .main > .right-panel .item .item-name {
  flex-grow: 1;
}
body > .main > .right-panel .item .item-rotate, body > .main > .right-panel .item .item-x, body > .main > .right-panel .item .item-y {
  margin-left: 0.4rem;
  font-weight: 600;
  color: #424242;
}
body > .main > .right-panel .selected {
  background-color: #E0E0E0;
}
body > .main > .overlay {
  position: absolute;
...
body > .main > .overlay > .settings {
  background-color: #F5F5F5;
  border-radius: 0.2rem;
}
body > .main > .overlay > .settings > .header {
  display: flex;
  padding: 0.2rem;
...
body > .main > .overlay > .settings > .header > .title {
  flex-grow: 1;
  text-align: center;
  font-weight: 600;
  color: #EEEEEE;
}
body > .main > .overlay > .settings > .header > button {
  font-size: 0.6rem;
  padding: 0.2rem;
}
body > .main > .overlay > .settings > .form {
  display: grid;
  grid-template-columns: auto 1fr;
  grid-column-gap: 0.5rem;
  grid-row-gap: 0.3rem;
...
body > .main > .overlay > .settings > .form > .label {
  font-weight: 600;
  color: #424242;
}
body > .main > .overlay > .settings > .form > .title {
  margin-top: 1rem;
...
/* harmony import */ var _src_scss_main_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(35);
