...
def hero_selection_slider(heroData=None, styles=None, key=None):
  
    component_value = _hero_selection_component(heroData=heroData, styles=styles, key=key, default=0)
