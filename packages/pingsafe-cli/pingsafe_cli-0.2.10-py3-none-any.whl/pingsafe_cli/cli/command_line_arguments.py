...
def add_iac_flags(iac_parser):
    ...
    iac_parser.add_argument("-q", "--quiet", dest="quiet", action="store_true", default=False,
    ...
    iac_parser.add_argument("--verbose", dest="verbose", action="store_true", default=False,
...
def add_secret_flags(secret_parser):
    ...
    secret_parser.add_argument("-q", "--quiet", dest="quiet", action="store_true", default=False,
                               help="show limited information")
    ...
    secret_parser.add_argument("--verbose", dest="verbose", action="store_true", default=False,
                               help="show more information")
...
def add_vulnerability_flags(vulnerability_parser):
    ...
    vulnerability_parser.add_argument("-q", "--quiet", dest="quiet", action="store_true", default=False,
                                      help="show limited information")
    ...
    vulnerability_parser.add_argument("--verbose", dest="verbose", action="store_true", default=False,
                                      help="show more information")
...
def add_config_global_flags(config_sub_parser):
    ...
    config_sub_parser.add_argument("--debug", dest="debug", action="store_true", default=False, help="debug config command")
