...
# Content types corresponding to XML
xmlContentTypes = ('text/xml', 'application/xml', 'application/soap+xml')
...
class Request(Object):
    ...
    def create(class_, handler):
        ...
        if contentType:
            ...
            elif contentType in xmlContentTypes:
                req.parseXml(content)
        # Get Cookies
