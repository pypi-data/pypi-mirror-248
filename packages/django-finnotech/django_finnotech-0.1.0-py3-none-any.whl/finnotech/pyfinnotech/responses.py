...
class ClientIdentificationInquiry(BaseFinnotechResponse):
    @property
    def first_name(self):
        return self.payload.get("firstName")
    
    @property
    def last_name(self):
        return self.payload.get("lastName")
    
    @property
    def father_name(self):
        return self.payload.get("fatherName")
    
    @property
    def gender(self):
        return self.payload.get("gender")
    
    @property
    def identity_seri(self):
        return self.payload.get("identitySeri")
    
    @property
    def identity_serial(self):
        return self.payload.get("identitySerial")
