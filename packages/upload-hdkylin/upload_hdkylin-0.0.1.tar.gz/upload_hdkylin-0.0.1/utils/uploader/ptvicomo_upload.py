...
def ptvicomo_upload(siteinfo,file1,record_path,qbinfo,basic,hashlist):
    post_url = "https://www.ptvicomo.net/takeupload.php"
    tags=[]
    time_out=40
    ...
    #选择制作组
    if 'Eleph' in file1.sub.lower():
        team_sel='3'
    elif 'Eleph Remux' in file1.sub.lower():
        team_sel='1'
    elif 'ptvicomoGame' in file1.sub.lower():
        team_sel='8'
    elif 'Eleph Rip' in file1.sub.lower():
        team_sel='4'
    elif 'Eleph Web' in file1.sub.lower():
        team_sel='2'
    elif 'Eleph Rec' in file1.sub.lower():
        team_sel='6'
    else:
        team_sel='5'
    ...
    if 'Eleph' in file1.sub.lower():
        tags.append(3)
        logger.info('已选择官方')
    if 'Eleph' in file1.pathinfo.exclusive :
        tags.append(1)
        logger.info('已选择禁转')
