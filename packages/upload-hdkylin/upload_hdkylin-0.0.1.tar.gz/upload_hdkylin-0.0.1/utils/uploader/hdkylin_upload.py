...
def hdkylin_upload(siteinfo,file1,record_path,qbinfo,basic,hashlist):
    post_url = "https://www.hdkyl.in/takeupload.php"
    tags=[]
    time_out=40
    ...
    if not file1.country=='':
        if '大陆' in file1.country:
            ...
            processing_sel='14'
            logger.info('未找到资源国家信息，已默认other')
    else:
        processing_sel='6'
        logger.info('未找到资源国家信息，已默认日本')

    #选择制作组
    if 'HDKylin' in file1.sub.lower():
        team_sel='6'
    elif 'HDKylinWeb' in file1.sub.lower():
        team_sel='7'
    elif 'HDKylinGame' in file1.sub.lower():
        team_sel='8'
    elif 'HDKylinMV' in file1.sub.lower():
        team_sel='1'
    elif 'HDKylinTV' in file1.sub.lower():
        team_sel='2'
    elif 'HDKylinDIY' in file1.sub.lower():
        team_sel='3'
    else:
        team_sel='5'
    ...
    if 'HDKylin' in file1.sub.lower():
        tags.append(3)
        logger.info('已选择官方')
    if 'HDKylin' in file1.pathinfo.exclusive :
        tags.append(1)
        logger.info('已选择禁转')
