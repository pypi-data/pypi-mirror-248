...
set_target_properties(dragonbox::dragonbox_to_chars PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/dragonbox_to_chars.lib"
  )

list(APPEND _cmake_import_check_targets dragonbox::dragonbox_to_chars )
list(APPEND _cmake_import_check_files_for_dragonbox::dragonbox_to_chars "${_IMPORT_PREFIX}/lib/dragonbox_to_chars.lib" )
