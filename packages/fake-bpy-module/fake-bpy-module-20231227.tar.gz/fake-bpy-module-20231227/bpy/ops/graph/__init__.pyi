...
def scale_from_neighbor(
        ...
        *,
        factor=0.0,
        anchor='LEFT'):
    ''' Increase or decrease the value of selected keys in relationship to the neighboring one :arg factor: Factor, The factor to scale keys with :type factor: float in [-inf, inf], (optional) :arg anchor: Reference Key, Which end of the segment to use as a reference to scale from * ``LEFT`` From Left -- foo. * ``RIGHT`` From Right -- foo. :type anchor: enum in ['LEFT', 'RIGHT'], (optional)
