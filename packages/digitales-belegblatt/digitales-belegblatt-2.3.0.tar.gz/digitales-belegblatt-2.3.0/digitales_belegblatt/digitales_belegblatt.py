...
class DigitalesBelegblatt:
    ...
    def set_nothalt(self, nothalt):
        self.nothalt = nothalt
    ...
    def generate_image(self, minutes=15, offset=None):
        ...
        # Nothalt
        if self.nothalt:
            svg_document.add(svg_document.rect(insert=(650, 10), size=(120, 30), fill=svgwrite.rgb(100, 0, 0, '%')))
            svg_document.add(svg_document.text("NOTHALT", insert=(755, 25), style="font-size:20px; font-family:Arial; text-anchor: end;dominant-baseline: middle;"))
