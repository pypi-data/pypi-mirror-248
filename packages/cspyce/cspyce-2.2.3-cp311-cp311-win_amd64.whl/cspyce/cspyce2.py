...
def ckcov(ck, idcode, needav, level, tol, timsys):
    ...
    Returns:
      SpiceCell cover  = Array giving start/stop time pairs for the
                         intervals covered.
    """
    return cs1.ckcov(ck, idcode, needav, level, tol, timsys)
...
def ckcov_error(ck, idcode, needav, level, tol, timsys):
    ...
    the C kernel.
    """
    return cs1.ckcov_error(ck, idcode, needav, level, tol, timsys)
...
def gfdist(target, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine):
    ...
    """
    return cs1.gfdist(target, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine)
...
def gfevnt(step, gquant, qpnams, qcpars, qdpars, qipars, qlpars, op, refval, tol, adjust, rpt, nintvls, cnfine):
    """
    ...
    Returns:
      SpiceCell    result  = SPICE window containing results.
    """
    return cs1.gfevnt(step, gquant, qpnams, qcpars, qdpars, qipars, qlpars, op, refval, tol, adjust, rpt, nintvls, cnfine)
...
def gffove(inst, tshape, raydir, target, tframe, abcorr, obsrvr, tol, step, rpt, cnfine):
    ...
    Returns:
      SpiceCell    result = SPICE window containing results.
    """
    return cs1.gffove(inst, tshape, raydir, target, tframe, abcorr, obsrvr, tol, step, rpt, cnfine)
...
def gfilum(method, angtyp, target, illmn, fixref, abcorr, obsrvr, spoint, relate, refval, adjust, step, nintvls, cnfine):
    ...
    Returns:
      SpiceCell    result  = SPICE window containing results.
    """
    return cs1.gfilum(method, angtyp, target, illmn, fixref, abcorr, obsrvr, spoint, relate, refval, adjust, step, nintvls, cnfine)
...
def gfocce(occtyp, front, fshape, fframe, back, bshape, bframe, abcorr, obsrvr, tol, step, rpt, cnfine):
    ...
    Returns:
      SpiceCell    result = SPICE window containing results.
    """
    return cs1.gfocce(occtyp, front, fshape, fframe, back, bshape, bframe, abcorr, obsrvr, tol, step, rpt, cnfine)
...
def gfoclt(occtyp, front, fshape, fframe, back, bshape, bframe, abcorr, obsrvr, step, cnfine):
    ...
    Returns:
      SpiceCell    result = SPICE window containing results.
    """
    return cs1.gfoclt(occtyp, front, fshape, fframe, back, bshape, bframe, abcorr, obsrvr, step, cnfine)
...
def gfpa(target, illmn, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine):
    ...
    Returns:
      SpiceCell    result  = SPICE window containing results.
    """
    return cs1.gfpa(target, illmn, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine)
...
def gfposc(target, frame, abcorr, obsrvr, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine):
    ...
    Returns:
      SpiceCell    result  = SPICE window containing results.
    """
    return cs1.gfposc(target, frame, abcorr, obsrvr, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine)
...
def gfrfov(inst, raydir, rframe, abcorr, obsrvr, step, cnfine):
    ...
    Returns:
      SpiceCell    result = SPICE window containing results.
    """
    return cs1.gfrfov(inst, raydir, rframe, abcorr, obsrvr, step, cnfine)
...
def gfrr(target, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine):
    ...
    Returns:
      SpiceCell    result  = SPICE window containing results.
    """
    return cs1.gfrr(target, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine)
...
def gfsep(targ1, shape1, frame1, targ2, shape2, frame2, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine):
    ...
    Returns:
      SpiceCell    result  = SPICE window containing results.
    """
    return cs1.gfsep(targ1, shape1, frame1, targ2, shape2, frame2, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine)
...
def gfsntc(target, fixref, method, abcorr, obsrvr, dref, dvec, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine):
    ...
    Returns:
      SpiceCell    result  = SPICE window containing results.
    """
    return cs1.gfsntc(target, fixref, method, abcorr, obsrvr, dref, dvec, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine)
...
def gfsubc(target, fixref, method, abcorr, obsrvr, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine):
    ...
    Returns:
      SpiceCell    result  = SPICE window containing results.
    """
    return cs1.gfsubc(target, fixref, method, abcorr, obsrvr, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine)
...
def gftfov(inst, target, tshape, tframe, abcorr, obsrvr, step, cnfine):
    ...
    Returns:
      SpiceCell    result = SPICE window containing results.
    """
    return cs1.gftfov(inst, target, tshape, tframe, abcorr, obsrvr, step, cnfine)
...
def pckcov_error(pck, idcode):
    ...
    """
    return cs1.pckcov_error(pck, idcode)
...
def spkcov_error(spk, idcode):
    ...
    """
    return cs1.spkcov_error(spk, idcode)
...
def wncomd(left, right, window):
    ...
    Returns:
      SpiceCell    result = Complement of window with respect to
                            [left,right].
    """
    return cs1.wncomd(left, right, window)
