...
def gfdist(target, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine):
    r"""gfdist(ConstSpiceChar * target, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, ConstSpiceChar * relate, SpiceDouble refval, SpiceDouble adjust, SpiceDouble step, SpiceInt nintvls, SpiceCell * cnfine)"""
    return _cspyce0.gfdist(target, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine)

def gfevnt(step, gquant, qpnams_ct, qcpars_ct, qdpars, qipars, qlpars, op, refval, tol, adjust, rpt, nintvls, cnfine):
    r"""gfevnt(SpiceDouble step, ConstSpiceChar * gquant, SpiceInt qpnams_ct, SpiceInt qcpars_ct, ConstSpiceDouble * qdpars, ConstSpiceInt * qipars, ConstSpiceBoolean * qlpars, ConstSpiceChar * op, SpiceDouble refval, SpiceDouble tol, SpiceDouble adjust, SpiceBoolean rpt, SpiceInt nintvls, SpiceCell * cnfine)"""
    return _cspyce0.gfevnt(step, gquant, qpnams_ct, qcpars_ct, qdpars, qipars, qlpars, op, refval, tol, adjust, rpt, nintvls, cnfine)

def gffove(inst, tshape, raydir, target, tframe, abcorr, obsrvr, tol, step, rpt, cnfine):
    r"""gffove(ConstSpiceChar * inst, ConstSpiceChar * tshape, ConstSpiceDouble [3] raydir, ConstSpiceChar * target, ConstSpiceChar * tframe, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, SpiceDouble tol, SpiceDouble step, SpiceBoolean rpt, SpiceCell * cnfine)"""
    return _cspyce0.gffove(inst, tshape, raydir, target, tframe, abcorr, obsrvr, tol, step, rpt, cnfine)

def gfilum(method, angtyp, target, illmn, fixref, abcorr, obsrvr, spoint, relate, refval, adjust, step, nintvls, cnfine):
    r"""gfilum(ConstSpiceChar * method, ConstSpiceChar * angtyp, ConstSpiceChar * target, ConstSpiceChar * illmn, ConstSpiceChar * fixref, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, ConstSpiceDouble [3] spoint, ConstSpiceChar * relate, SpiceDouble refval, SpiceDouble adjust, SpiceDouble step, SpiceInt nintvls, SpiceCell * cnfine)"""
    return _cspyce0.gfilum(method, angtyp, target, illmn, fixref, abcorr, obsrvr, spoint, relate, refval, adjust, step, nintvls, cnfine)

def gfocce(occtyp, front, fshape, fframe, back, bshape, bframe, abcorr, obsrvr, tol, step, rpt, cnfine):
    r"""gfocce(ConstSpiceChar * occtyp, ConstSpiceChar * front, ConstSpiceChar * fshape, ConstSpiceChar * fframe, ConstSpiceChar * back, ConstSpiceChar * bshape, ConstSpiceChar * bframe, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, SpiceDouble tol, SpiceDouble step, SpiceBoolean rpt, SpiceCell * cnfine)"""
    return _cspyce0.gfocce(occtyp, front, fshape, fframe, back, bshape, bframe, abcorr, obsrvr, tol, step, rpt, cnfine)

def gfoclt(occtyp, front, fshape, fframe, back, bshape, bframe, abcorr, obsrvr, step, cnfine):
    r"""gfoclt(ConstSpiceChar * occtyp, ConstSpiceChar * front, ConstSpiceChar * fshape, ConstSpiceChar * fframe, ConstSpiceChar * back, ConstSpiceChar * bshape, ConstSpiceChar * bframe, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, SpiceDouble step, SpiceCell * cnfine)"""
    return _cspyce0.gfoclt(occtyp, front, fshape, fframe, back, bshape, bframe, abcorr, obsrvr, step, cnfine)

def gfpa(target, illmn, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine):
    r"""gfpa(ConstSpiceChar * target, ConstSpiceChar * illmn, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, ConstSpiceChar * relate, SpiceDouble refval, SpiceDouble adjust, SpiceDouble step, SpiceInt nintvls, SpiceCell * cnfine)"""
    return _cspyce0.gfpa(target, illmn, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine)

def gfposc(target, frame, abcorr, obsrvr, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine):
    r"""gfposc(ConstSpiceChar * target, ConstSpiceChar * frame, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, ConstSpiceChar * crdsys, ConstSpiceChar * coord, ConstSpiceChar * relate, SpiceDouble refval, SpiceDouble adjust, SpiceDouble step, SpiceInt nintvls, SpiceCell * cnfine)"""
    return _cspyce0.gfposc(target, frame, abcorr, obsrvr, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine)

def gfrfov(inst, raydir, rframe, abcorr, obsrvr, step, cnfine):
    r"""gfrfov(ConstSpiceChar * inst, ConstSpiceDouble [3] raydir, ConstSpiceChar * rframe, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, SpiceDouble step, SpiceCell * cnfine)"""
    return _cspyce0.gfrfov(inst, raydir, rframe, abcorr, obsrvr, step, cnfine)

def gfrr(target, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine):
    r"""gfrr(ConstSpiceChar * target, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, ConstSpiceChar * relate, SpiceDouble refval, SpiceDouble adjust, SpiceDouble step, SpiceInt nintvls, SpiceCell * cnfine)"""
    return _cspyce0.gfrr(target, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine)

def gfsep(targ1, shape1, frame1, targ2, shape2, frame2, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine):
    r"""gfsep(ConstSpiceChar * targ1, ConstSpiceChar * shape1, ConstSpiceChar * frame1, ConstSpiceChar * targ2, ConstSpiceChar * shape2, ConstSpiceChar * frame2, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, ConstSpiceChar * relate, SpiceDouble refval, SpiceDouble adjust, SpiceDouble step, SpiceInt nintvls, SpiceCell * cnfine)"""
    return _cspyce0.gfsep(targ1, shape1, frame1, targ2, shape2, frame2, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine)

def gfsntc(target, fixref, method, abcorr, obsrvr, dref, dvec, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine):
    ...
    return _cspyce0.gfsntc(target, fixref, method, abcorr, obsrvr, dref, dvec, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine)

def gfstol(value):
    r"""gfstol(SpiceDouble value)"""
    return _cspyce0.gfstol(value)

def gfsubc(target, fixref, method, abcorr, obsrvr, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine):
    r"""gfsubc(ConstSpiceChar * target, ConstSpiceChar * fixref, ConstSpiceChar * method, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, ConstSpiceChar * crdsys, ConstSpiceChar * coord, ConstSpiceChar * relate, SpiceDouble refval, SpiceDouble adjust, SpiceDouble step, SpiceInt nintvls, SpiceCell * cnfine)"""
    return _cspyce0.gfsubc(target, fixref, method, abcorr, obsrvr, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine)

def gftfov(inst, target, tshape, tframe, abcorr, obsrvr, step, cnfine):
    r"""gftfov(ConstSpiceChar * inst, ConstSpiceChar * target, ConstSpiceChar * tshape, ConstSpiceChar * tframe, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, SpiceDouble step, SpiceCell * cnfine)"""
    return _cspyce0.gftfov(inst, target, tshape, tframe, abcorr, obsrvr, step, cnfine)
...
def wncomd(left, right, window):
    r"""wncomd(SpiceDouble left, SpiceDouble right, SpiceCell * window)"""
    return _cspyce0.wncomd(left, right, window)
...
def wndifd(a, b):
    r"""wndifd(SpiceCell * a, SpiceCell * b)"""
    return _cspyce0.wndifd(a, b)
...
def wnintd(a, b):
    r"""wnintd(SpiceCell * a, SpiceCell * b)"""
    return _cspyce0.wnintd(a, b)
...
def wnunid(a, b):
    r"""wnunid(SpiceCell * a, SpiceCell * b)"""
    return _cspyce0.wnunid(a, b)
