...
def to_pyarrow_table_bytes_b64(result):
	I='16777216';B=result;import pyarrow as C;J={'byteLength':I,'charLength':I,'logicalType':'VARIANT','precision':'38','scale':'0','finalType':'T'};D=[];E=[A['name'].replace('_col','$')for A in B.data.rowtype]
