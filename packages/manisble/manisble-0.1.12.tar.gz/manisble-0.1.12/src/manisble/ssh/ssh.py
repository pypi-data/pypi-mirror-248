...
def checkenv():
    myenv = {}
    myenv['VAULT_ADDR'] = os.environ.get('MANISBLE_VAULT_ADDR')   
    myenv['VAULT_TOKEN'] = os.environ.get('MANISBLE_VAULT_TOKEN')
    myenv['VAULT_NAMESPACE'] = os.environ.get('MANISBLE_VAULT_NAMESPACE')
    myenv['VAULT_FORMAT'] = os.environ.get('MANISBLE_VAULT_FORMAT')
