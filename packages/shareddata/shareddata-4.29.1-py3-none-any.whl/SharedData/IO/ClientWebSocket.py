...
class ClientWebSocket():
    ...
    @staticmethod
    async def table_subscribe_thread(table, host, port, lookbacklines=1000, lookbackdate=None):

        shnumpy = table.records
        buffsize = int(np.floor(ServerWebSocket.BUFF_SIZE/shnumpy.itemsize))*shnumpy.itemsize
...
if __name__ == '__main__':
    ...
    source = args[4]
    tablename = args[5]
    table = shdata.get_table(database,period,source,tablename)
