...
class probit (Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(probit, self).describe(), {
            ...
            'api': {
                'public': {
                    'get': ['v1/ticker/price', 'v1/market/tickers'],
                },
                'private': {
                    'post': ['spot/accountList', 'trade/order/place', 'trade/order/cancelAll'],
                    'get': ['v1/ticker/price', 'v1/market/tickers'],
                },
            },
            'fees': {
    ...
    def fetch_markets(self, params={}):
        response = self.publicGetV1TickerPrice()
    ...
    def fetch_balance(self, params={}):
        self.load_markets()
        response = self.privatePostSpotAccountList()
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        resp = self.privatePostTradeOrderPlace(self.extend(req, params))
