...
struct NEIGHBOR_LIST
{
    ...
    int exceed_max_neighbor_atoms = 0;
    int exceed_max_grid_atoms = 0;
    int* d_exceed_max_neighbor_atoms;
    int* d_exceed_max_grid_atoms;
    ...
    //检查内存溢出
    void Check_Overflow(CONTROLLER* controller);
