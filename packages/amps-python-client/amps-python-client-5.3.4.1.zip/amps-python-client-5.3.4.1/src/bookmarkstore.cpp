...
namespace ampspy
{
  namespace bookmarkstore
  {
    ...
    size_t wrapper::log(AMPS::Message& message_)
    {
      ...
      PyObject* pResult = PyObject_CallMethod(_pImpl, (char*)"log", (char*)"(O)", pPythonMessage);
    ...
    {
      LockGIL lockGil;
      PyObject* pResult = PyObject_CallMethod(_pImpl, (char*)"discard", (char*)"(s#K)",
    ...
    void wrapper::discard(const AMPS::Message& message_)
    {
      ...
      PyObject* pPythonMessage = ampspy::message::toPythonMessage(const_cast<AMPS::Message&>(message_));
      PyObject* pResult = PyObject_CallMethod(_pImpl, (char*)"discard_message", (char*)"(O)", pPythonMessage);
      Py_DECREF(pPythonMessage);
      if (pResult == NULL)
      {
        exc::throwError();
    ...
    {
      LockGIL lockGil;
      PyObject* pResult = PyObject_CallMethod(_pImpl, (char*)"get_most_recent", (char*)"(s#)",
                                              subId_.data(), subId_.len());
      if (pResult == NULL)
      {
        exc::throwError();
    ...
    bool wrapper::isDiscarded(AMPS::Message& message_)
    {
      LockGIL lockGil;
      PyObject* pPythonMessage = ampspy::message::toPythonMessage(message_);
      PyObject* pResult = PyObject_CallMethod(_pImpl, (char*)"is_discarded", (char*)"(O)", pPythonMessage);
      Py_DECREF(pPythonMessage);
      if (pResult == NULL)
      {
        exc::throwError();
    ...
    {
      LockGIL lockGil;
      PyObject* pResult = PyObject_CallMethod(_pImpl, (char*)"get_oldest_bookmark_seq",
    ...
    AMPS::Message::Field wrapper::persisted(const AMPS::Message::Field& subId_, size_t bookmark_)
    {
