...
namespace ampspy
{
  ...
  ampspy_type_object& ampspy_type_object::registerType(const char* name_, PyObject* module_)
  {
  ...
  ampspy_type_object& ampspy_type_object::addMethod(const char* name_, void* function_, const char* doc_)
  {
    _pImpl->addMethod(name_, function_, METH_VARARGS, doc_);
    return *this;
  }

  ampspy_type_object& ampspy_type_object::addStaticMethod(const char* name_, void* function_, const char* doc_)
  {
    _pImpl->addMethod(name_, function_, METH_VARARGS | METH_STATIC, doc_);
    return *this;
  }

  ampspy_type_object& ampspy_type_object::addKeywordMethod(const char* name_, void* function_, const char* doc_)
  {
    _pImpl->addMethod(name_, function_, METH_VARARGS | METH_KEYWORDS, doc_);
    return *this;
  }

  ampspy_type_object& ampspy_type_object::addGetter(const char* name_, void* function_, const char* doc_)
  {
  ...
  {
    _pImpl->addMethod("__copy__", (void*)not_copyable, METH_VARARGS, "__copy__ not supported.");
    _pImpl->addMethod("__deepcopy__", (void*)not_copyable, METH_VARARGS, "__deepcopy__ not supported.");
    return *this;
  }
}
