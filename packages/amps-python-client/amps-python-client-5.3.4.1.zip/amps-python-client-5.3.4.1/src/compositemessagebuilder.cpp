...
namespace ampspy
{
  namespace compositemessagebuilder
  {
    ...
    {
      CALL_RETURN_BYTES_AND_SIZE(self->pCompositeMessageBuilder->data(), self->pCompositeMessageBuilder->length());
    }
    ...
    {
      CALL_RETURN_STRING_AND_SIZE(self->pCompositeMessageBuilder->data(), self->pCompositeMessageBuilder->length());
    }
