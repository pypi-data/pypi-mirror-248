...
namespace ampspy
{
  namespace compositemessageparser
  {
    ...
    static PyObject* parse(obj* self, PyObject* args)
    {
      ...
      CALL_RETURN_SIZE_T(self->pCompositeMessageParser->parse(self->pLastParsed->c_str(), len));
    }
    //  def get_part(self)
