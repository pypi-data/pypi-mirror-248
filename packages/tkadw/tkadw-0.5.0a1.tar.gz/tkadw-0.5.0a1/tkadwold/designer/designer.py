from tkadwold.windows.theme import AdwTFrame
...
class AdwDesigner(AdwTFrame):
    ...
    def setup_project_panel(self):
        from tkadwold.windows.theme import AdwTListBox
    ...
    def setup_designer_panel(self):
        from tkadwold.windows.theme import AdwTMDI
    ...
    def add_widget(self):
        if self.widgets_panel.select() == "AdwTButton":
            from tkadwold.windows.theme import AdwTButton, AdwTDesignerFrame
            _ = AdwTDesignerFrame(self.designer_window[0], AdwTButton)
        elif self.widgets_panel.select() == "AdwTEntry":
            from tkadwold.windows.theme import AdwTEntry, AdwTDesignerFrame
            _ = AdwTDesignerFrame(self.designer_window[0], AdwTEntry)
        elif self.widgets_panel.select() == "AdwTText":
            from tkadwold.windows.theme import AdwTText, AdwTDesignerFrame
