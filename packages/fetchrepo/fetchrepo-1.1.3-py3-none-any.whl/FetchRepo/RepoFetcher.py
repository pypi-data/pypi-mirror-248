...
def harvest_github_repo(repo_link, branch=None, access_token=None):
    ...
    # ignore_file_path = os.path.join(os.getcwd(), 'FetchRepo', 'ignore_files.txt')
    ignore_files = [".gitignore","README.md",".DS_Store","package-lock.json","package.json",".github/","images/",".prettierrc","node_modules/","tsconfig.json","LICENSE"]
