...
def list_proxys():
    ...
    if input2 == "":
        lol = 1
    if input2 == "http":
        if os.path.exists("./alfred_osint/proxys/http.txt"):
            file1 = open("./alfred_osint/proxys/http.txt", "r")
        ...
        if os.path.exists("./alfred_osint/proxys/socks4.txt"):
            file1 = open("./alfred_osint/proxys/socks4.txt", "r")
            Lines = file1.readlines()
        ...
        if os.path.exists("./alfred_osint/proxys/socks5.txt"):
            file1 = open("./alfred_osint/proxys/socks5.txt", "r")
            Lines = file1.readlines()
