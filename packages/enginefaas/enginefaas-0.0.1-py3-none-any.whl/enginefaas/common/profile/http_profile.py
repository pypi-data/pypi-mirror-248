...
class HttpProfile(object):
    ...
    def __init__(self, protocol=None, endpoint=None, reqMethod="POST", reqTimeout=60,
        ...
        :type protocol: str
        :param endpoint: The domain to access, like: func1.enginefaas.com
        :type endpoint: str
        :param reqMethod: the http method, valid choice: GET, POST
        :type reqMethod: str
        :param reqTimeout: The http timeout in second.
        :type reqTimeout: int
        :param rootDomain: The root domain to access, like: enginefaas.com.
        :type rootDomain: str
        """
        ...
        self.proxy = proxy
        self.rootDomain = "gateway.openfaas.svc.cluster.local:8080" if rootDomain is None else rootDomain
