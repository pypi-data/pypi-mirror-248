...
class Completions(github_copilot.Completions):
    ...
    @staticmethod
    @retrying
    @ttl_cache(ttl=7 * 24 * 3600)  # 一周更新一次即可
    def get_access_token(state_file: Optional[str] = None):
        state_file = state_file or "/Users/betterme/PycharmProjects/AI/MeUtils/examples/爬虫/deepseek_cookie.json"
...
if __name__ == '__main__':
    ...
    data = {'model': 'deepseek', 'messages': [{'role': 'user', 'content': '你是谁'}], 'stream': True}
