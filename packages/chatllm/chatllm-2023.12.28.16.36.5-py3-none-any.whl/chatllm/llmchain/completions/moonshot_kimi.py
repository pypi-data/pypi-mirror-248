...
class Completions(github_copilot.Completions):
    ...
    def create(
        ...
        **kwargs,
        ...
        data = {
            "model": 'gpt-4',
            "messages": messages[-1:],  # 系统提示词怎么自定义
    ...
    @staticmethod
    @diskcache(ttl=24 * 3600, location=HOME_CACHE, ignore=['headers'])  # 会话session缓存一天, todo: redis cache
...
if __name__ == '__main__':
    ...
    data = {'model': 'kimi', 'messages': [{'role': 'user', 'content': '你是谁'}], 'stream': True,
            'use_search': False}
    # data = {
    #     "messages":
    #         [
