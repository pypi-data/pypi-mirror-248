...
class Linear(NetworkLayer):
    ...
    def import_from_dict(cls, layer_data : Dict[ str, Union[ str, int, bytes ] ]) -> "Linear":
        ...
        linear_layer = Linear(
            ...
            activation  = Activation.ACTIVATION_FUNCTIONS.get(layer_data["activation"]["A"], None)
        )
    ...
    def __init__(self, input_size  : int,
        ...
        if (self.DEBUG_MODE):
            ...
            assert ((activation is None) or (isinstance(activation, Activation)))
...
if (__name__ == "__main__"):
    ...
    layer_1 = Linear(input_size = 2, output_size = 32, activation = ReLU)

    layer_2 = Linear(input_size = 32, output_size = 2, activation = Sigmoid)
