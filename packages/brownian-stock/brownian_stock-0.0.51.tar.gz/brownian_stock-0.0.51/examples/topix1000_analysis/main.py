...
from brownian_stock import AbstractModel, Simulator, StockSet, const, universe, utils
...
class Topix1000Model(AbstractModel):
    ...
    def trade(self, trade_date, is_first_date, is_last_date):
        if trade_date.month == 1 and trade_date.day == 1:
            ...
            self.lgbm_scorer.train(start_date, end_date)
        ...
        utils.long_short_trading(self, trade_date, subset, return_map)
