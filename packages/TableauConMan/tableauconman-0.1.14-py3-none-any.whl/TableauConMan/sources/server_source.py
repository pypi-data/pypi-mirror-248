...
class ServerSource:
    ...
    def delete_item(self, asset_type: str, item_to_delete: TSC.Resource):
        server_item = getattr(self.server, asset_type)

        with self.connect():
            server_item.delete(item_to_delete.id)

    def add_item(self, asset_type: str, item_to_delete: TSC.Resource) -> TSC.Resource:
        server_item = getattr(self.server, asset_type)
    ...
    def update_item(
        self, asset_type: str, item_to_delete: TSC.Resource
    ) -> TSC.Resource:
        server_item = getattr(self.server, asset_type)
    ...
    def add_sub_item(
        self, asset_type: str, target_item: TSC.Resource, sub_item: TSC.Resource
    ) -> None:
