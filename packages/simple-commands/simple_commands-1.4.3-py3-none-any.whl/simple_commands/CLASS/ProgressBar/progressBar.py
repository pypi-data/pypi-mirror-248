...
class __ProgressBar:
    ...
    def __n(self):
        ...
        try:
            return str(str(self.__start[1][1]) + str(starts[self.__start[0]]) + str(self.__start[1][2]))
    ...
    def generate(self, iterable, description='', length=50, bar_character="#", empty_character="-"):
        ...
        for value in iterable:
            ...
            self.start = self.__n()
            print(f"\r {self.__description} {self.start} [{self.__bar}] {self.__progress_percentage:.2f}% description: {self.__description}", end='', flush=True)
            yield value
            
    def Progress_print(self, value):
        print(f"\r {self.start} [{self.__bar}] {self.__progress_percentage:.2f}%  description: {self.__description} value: {value}", end='',flush=True)
