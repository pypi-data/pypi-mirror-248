...
def save_images(imgs: Union[TensorArray, List[TensorArray], Tuple[TensorArray]],
...
def show_images(imgs: Union[TensorArray, List[TensorArray], Tuple[TensorArray]],
                format: Optional[str] = None,
                batched: bool = False,
                ncols: int = None):
    """
...
def channel_fist_to_channel_last(images: Union[List[TensorArray], Tuple[TensorArray]]):
    """
