...
class coinstore (Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(coinstore, self).describe(), {
            ...
            'urls': {
                'logo': 'https://www.coinstore.com/img/logo-blue.1fe14dd9.png',
                'api': {
                    'account': 'https://api.coinstore.com/api/spot/accountList',
                    'exchange': 'https://api.coinstore.com',
                },
                'www': 'www.coinstore.com',
                'doc': [
                    'https://coinstore-openapi.github.io',
                    'https://coinstore-openapi.github.io',
                ],
            ...
            'api': {
                'public': {
                    'get': [
                        ...
                        'v1/market/tickers',
                        'v1/market/depth/{symbol}',
                        'trade/order/orderInfo',
                        'v1/market/trade/{symbol}',
                ...
                'private': {
                    'get': [
                        'spot/accountList',
                        'spot/accountList/{currency}',
                        'v2/trade/order/active',
                        'Order/active',
                        'trade/order/active',
