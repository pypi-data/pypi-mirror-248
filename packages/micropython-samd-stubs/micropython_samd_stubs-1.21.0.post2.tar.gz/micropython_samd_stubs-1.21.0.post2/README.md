...
Included stubs:
* Merged stubs from `stubs/micropython-v1_21_0-samd-SEEED_WIO_TERMINAL-merged`
* Frozen stubs from `stubs/micropython-v1_21_0-frozen/samd/GENERIC`
