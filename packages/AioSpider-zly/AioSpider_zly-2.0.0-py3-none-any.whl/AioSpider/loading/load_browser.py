...
from AioSpider.browser import Browser, BrowserType
from AioSpider.tools.browser_tools import chromium_instance, firefox_instance


class LoadBrowser:

    def __new__(cls, *args, **kwargs) -> Browser:
