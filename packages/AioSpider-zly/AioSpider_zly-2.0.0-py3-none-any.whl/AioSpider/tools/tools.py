...
from .time_tools import (
    ...
    before_day, make_date_range, make_timestamp, get_quarter_end_dates
)
from .string_tools import re_text, join, re
from .encrypt_tools import aes_ecb_decrypt
...
def convert_bool(value: Union[str, int, float, bool], default: bool = False):
    ...
    if isinstance(value, str):
        if (not value) or '否' in value or '-' in value or 'false' in value or 'N' in value or '不' in value:
            return False
        else:
            return True
