...
```sh
cd C:\Users\<current_user>\Envs
.\DEV_WONDER_METADATA\Scripts\activate
```
...
```sh
deactivate
rmvirtualenv DEV_WONDER_METADATA
```
...
sudo docker build -t DEV_WONDER_METADATA .
sudo docker run -it --rm --name DEV_WONDER_METADATA DEV_WONDER_METADATA
```
...
3. Set Python environment to a virtual environment such DEV_WONDER_METADATA
...
Details: /home/jcbow/.virtualenvs/DEV_WONDER_METADATA/bin/python: No module named pip
