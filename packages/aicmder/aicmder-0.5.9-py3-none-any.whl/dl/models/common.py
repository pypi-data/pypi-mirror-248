...
from .general import (check_requirements, check_suffix, check_version, colorstr, increment_path,
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=None, dnn=False, fp16=False):
        # Usage:
        #   PyTorch:      weights = *.pt
