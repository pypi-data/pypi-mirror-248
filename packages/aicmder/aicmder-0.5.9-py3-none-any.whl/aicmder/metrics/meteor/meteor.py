...
if __name__ == "__main__":
    ...
    # gitee error: WARNING: Authentication error: Authentication required: LFS only supported repository in paid enterprise.
    # git config lfs.https://gitee.com/aifaith/aicmder.git/info/lfs.locksverify false

    # batch response: LFS only supported repository in paid enterprise.
    # rm .git/hooks/pre-push or mv .git/hooks/pre-push .git/hooks/pre-push_bak 
    ...
    score, scores = meteor_calculator.compute_score(references, hypotheses)
    print(score, scores)