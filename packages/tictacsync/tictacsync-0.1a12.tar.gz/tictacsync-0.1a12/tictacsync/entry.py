...
def main():
    ...
    parser.add_argument('--terse', action='store_true',
                    dest='terse',
                    help='terse output')
    parser.add_argument('-o', dest='output_structure', type=str, default='loose',
                    help='should be one of: loose [DEFAULT], strict')
    args = parser.parse_args()
    if not args.output_structure in 'loose strict reconf'.split():
        print('Unknown -o option value "%s", should be one of: loose [DEFAULT] or strict'%args.output_structure)
        quit()
    ...
    if not args.terse:
        print("\n")
    if args.output_structure == 'strict':
