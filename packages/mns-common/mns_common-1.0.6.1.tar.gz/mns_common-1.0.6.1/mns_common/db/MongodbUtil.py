...
class MongodbUtil:
    ...
    def get_db(self):
        port = self.port
        if port == "remote":
            client = pymongo.MongoClient("mongodb://100.77.155.135:" + '27017' + "/patience")
        elif port == "remote1":
            client = pymongo.MongoClient("mongodb://100.77.155.135:" + '27019' + "/patience")
        # 家里
        ...
        # 新都
            ...
            client = pymongo.MongoClient("mongodb://100.77.155.135:" + port + "/patience")
        else:
            client = pymongo.MongoClient("mongodb://100.77.155.135:" + port + "/patience")
