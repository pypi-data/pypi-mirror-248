...
class AdminApi:
    ...
    def reload_app(
        ...
        _param = self._reload_app_serialize(
    ...
    @validate_call
    def reload_app_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
