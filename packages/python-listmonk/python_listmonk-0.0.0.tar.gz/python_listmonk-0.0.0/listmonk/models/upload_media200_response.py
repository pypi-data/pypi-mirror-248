...
class UploadMedia200Response(BaseModel):
    """
    UploadMedia200Response
    """ # noqa: E501
    data: Optional[MediaFileObject] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": MediaFileObject.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
