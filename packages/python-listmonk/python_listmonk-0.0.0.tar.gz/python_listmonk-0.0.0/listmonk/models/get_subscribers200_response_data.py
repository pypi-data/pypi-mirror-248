...
class GetSubscribers200ResponseData(BaseModel):
    """
    GetSubscribers200ResponseData
    """ # noqa: E501
    results: Optional[List[Subscriber]] = None
    query: Optional[StrictStr] = None
    total: Optional[StrictInt] = None
    per_page: Optional[StrictInt] = None
    page: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["results", "query", "total", "per_page", "page"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "results": [Subscriber.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
            "query": obj.get("query"),
            "total": obj.get("total"),
