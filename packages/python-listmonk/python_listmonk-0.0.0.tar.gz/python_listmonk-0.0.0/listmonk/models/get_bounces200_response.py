...
class GetBounces200Response(BaseModel):
    """
    GetBounces200Response
    """ # noqa: E501
    data: Optional[GetBounces200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": GetBounces200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
