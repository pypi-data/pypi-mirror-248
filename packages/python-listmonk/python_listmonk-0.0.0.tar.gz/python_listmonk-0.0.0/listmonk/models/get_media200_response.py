...
class GetMedia200Response(BaseModel):
    """
    GetMedia200Response
    """ # noqa: E501
    data: Optional[List[MediaFileObject]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [MediaFileObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
