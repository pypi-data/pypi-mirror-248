...
class GetDashboardCharts200Response(BaseModel):
    """
    GetDashboardCharts200Response
    """ # noqa: E501
    data: Optional[DashboardChart] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": DashboardChart.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
