...
class HandlePublicSubscription200Response(BaseModel):
    """
    HandlePublicSubscription200Response
    """ # noqa: E501
    has_optin: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["has_optin"]
