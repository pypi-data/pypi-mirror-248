...
class Subscriber(BaseModel):
    ...
    attribs: Optional[SubscriberProfileAttribs] = None
    status: Optional[StrictStr] = None
    lists: Optional[List[SubscriberListsInner]] = None
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "uuid", "email", "name", "attribs", "status", "lists"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "name": obj.get("name"),
            "attribs": SubscriberProfileAttribs.from_dict(obj.get("attribs")) if obj.get("attribs") is not None else None,
            "status": obj.get("status"),
            "lists": [SubscriberListsInner.from_dict(_item) for _item in obj.get("lists")] if obj.get("lists") is not None else None
        })
        return _obj
