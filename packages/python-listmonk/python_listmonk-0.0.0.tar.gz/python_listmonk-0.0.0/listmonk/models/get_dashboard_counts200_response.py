...
class GetDashboardCounts200Response(BaseModel):
    """
    GetDashboardCounts200Response
    """ # noqa: E501
    data: Optional[DashboardCount] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": DashboardCount.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
