...
class Campaign(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "CampaignID", "views", "clicks", "lists", "started_at", "to_send", "sent", "uuid", "type", "name", "subject", "from_email", "body", "send_at", "status", "content_type", "tags", "template_id", "messenger"]
