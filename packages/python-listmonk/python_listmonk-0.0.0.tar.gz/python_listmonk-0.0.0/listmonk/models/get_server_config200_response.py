...
class GetServerConfig200Response(BaseModel):
    """
    GetServerConfig200Response
    """ # noqa: E501
    data: Optional[ServerConfig] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ServerConfig.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
