...
class GetCampaignAnalytics200Response(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[CampaignAnalyticsCount]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [CampaignAnalyticsCount.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
