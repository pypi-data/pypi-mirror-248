...
class GetRunningCampaignStats200Response(BaseModel):
    """
    GetRunningCampaignStats200Response
    """ # noqa: E501
    data: Optional[List[CampaignStats]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [CampaignStats.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
