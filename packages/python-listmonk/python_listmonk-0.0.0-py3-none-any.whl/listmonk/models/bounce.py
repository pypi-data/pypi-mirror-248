...
class Bounce(BaseModel):
    ...
    Bounce
    """ # noqa: E501
    results: Optional[List[BounceResultsInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "results": [BounceResultsInner.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
