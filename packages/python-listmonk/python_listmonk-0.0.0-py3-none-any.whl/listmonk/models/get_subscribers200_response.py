...
class GetSubscribers200Response(BaseModel):
    """
    GetSubscribers200Response
    """ # noqa: E501
    data: Optional[GetSubscribers200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": GetSubscribers200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
