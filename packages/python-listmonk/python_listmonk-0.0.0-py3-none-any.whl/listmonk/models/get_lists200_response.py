...
class GetLists200Response(BaseModel):
    """
    GetLists200Response
    """ # noqa: E501
    data: Optional[GetLists200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": GetLists200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
