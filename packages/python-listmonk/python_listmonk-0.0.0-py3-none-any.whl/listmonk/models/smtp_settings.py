...
class SMTPSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uuid", "enabled", "host", "hello_hostname", "port", "auth_protocol", "username", "email_headers", "max_conns", "max_msg_retries", "idle_timeout", "wait_timeout", "tls_type", "tls_skip_verify"]
