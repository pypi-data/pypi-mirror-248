...
class NewList(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "type", "optin", "tags"]
    ...
    @field_validator('optin')
    def optin_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in ('single', 'double'):
            raise ValueError("must be one of enum values ('single', 'double')")
        return value
