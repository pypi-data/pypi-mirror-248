...
class GetBounces200ResponseData(BaseModel):
    """
    GetBounces200ResponseData
    """ # noqa: E501
    results: Optional[List[Bounce]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "results": [Bounce.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
            "query": obj.get("query"),
            "total": obj.get("total"),
