...
class NewSubscriberAttribs(BaseModel):
    """
    NewSubscriberAttribs
    """ # noqa: E501
    city: Optional[StrictStr] = None
    projects: Optional[StrictInt] = None
    stack: Optional[NewSubscriberAttribsStack] = None
    __properties: ClassVar[List[str]] = ["city", "projects", "stack"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "stack": NewSubscriberAttribsStack.from_dict(obj.get("stack")) if obj.get("stack") is not None else None
        })
        return _obj
