...
class GetImportSubscribers200Response(BaseModel):
    """
    GetImportSubscribers200Response
    """ # noqa: E501
    data: Optional[ImportStatus] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ImportStatus.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
