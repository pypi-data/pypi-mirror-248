...
class DeleteGCSubscribers200Response(BaseModel):
    """
    DeleteGCSubscribers200Response
    """ # noqa: E501
    data: Optional[DeleteGCSubscribers200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": DeleteGCSubscribers200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
