...
class MediaApi:
    ...
    def delete_media_by_id(
        self,
        id: Annotated[StrictInt, Field(description="The id value of the list you want to delete.")],
        ...
        :param id: The id value of the list you want to delete. (required)
        :type id: int
        ...
        _param = self._delete_media_by_id_serialize(
            id=id,
    ...
    @validate_call
    def delete_media_by_id_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The id value of the list you want to delete.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_media_by_id_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The id value of the list you want to delete.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_media_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_media_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetMedia200Response]:
        """get_media
    ...
    def get_media_by_id(
        self,
        id: Annotated[StrictInt, Field(description="media file id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def get_media_by_id_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UploadMedia200Response]:
        """get_media_by_id
