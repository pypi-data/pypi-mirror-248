...
This version is a release candidate that is replacing the now inactive `rust-cpython <https://github.com/dgrunwald/rust-cpython>`_ crate with `PyO3 <https://github.com/pyO3/pyo3>`_.
