...
if __name__ == "__main__":
    input_json_file = '/Users/rajithprabhakaran/Library/Mobile Documents/com~apple~CloudDocs/Documents/Python/Python Package/src/DataQualityFrameworkGovernance/DataWorkflow/dq_pipeline_config.json'
