...
def adocs2notebooks(adoc_dir=None, dest_dir=None, glob='Chapter-*.adoc'):
    ...
    """
    adoc_dir = Path(adoc_dir or ADOC_DIR)
...
def convert(format='ipynb', **kwargs):
    """ Return dictionary of notebook json (text), notebook object (nb), and filepath """
