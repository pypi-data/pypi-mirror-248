...
class GotoLists:
	...
	def displayListItemMenu(self):
		...
		{row1}#zeroId $code, #zeroItemCode $code, #zeroBarcode $code -> set Quantity of result to zero(0)[r2u]{end}
		{row0}#clearId $code, #clearItemCode $code, #clearBarcode $code -> delete result forever[r2u]{end}
