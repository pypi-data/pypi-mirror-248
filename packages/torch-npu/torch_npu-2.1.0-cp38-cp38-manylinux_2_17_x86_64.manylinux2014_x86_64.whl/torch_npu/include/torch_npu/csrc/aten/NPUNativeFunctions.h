...
static at::Tensor npu_clear_float_status(const at::Tensor & self);
...
static at::Tensor npu_get_float_status(const at::Tensor & self);
...
static at::Tensor npu_incre_flash_attention(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const c10::optional<at::Tensor> & padding_mask={}, const c10::optional<at::Tensor> & atten_mask={}, at::OptionalIntArrayRef actual_seq_lengths=c10::nullopt, int64_t num_heads=1, double scale_value=1.0, c10::string_view input_layout="BSH", int64_t num_key_value_heads=0);
