...
class EditorNotebook(CustomNotebook):
    ...
    def _init_commands(self):
        ...
        #     "programming",
        #     tr("课后练习"),
        #     self._cmd_programming_exercises,
        #     caption=tr("Programming"),
        #     group=10,
        #     image="download1",
        #     include_in_toolbar=True,
        # )
    ...
    # def _cmd_programming_exercises(self):
    #     sys.excepthook = cef.ExceptHook  # To shutdown all CEF processes on error
    #     cef.Initialize()
    #     cef.CreateBrowserSync(url="http://system.turcar.net.cn",
    #                           window_title="Hello World!")
    #     cef.MessageLoop()
    #     cef.Shutdown()
        # from programming_exercises1 import MainFrame
        # MainFrame(self)
