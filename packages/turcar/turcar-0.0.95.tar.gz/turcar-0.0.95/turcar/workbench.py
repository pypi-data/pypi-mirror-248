...
class Workbench(tk.Tk):
    ...
    def add_view(
        ...
        def toggle_view_visibility():
            if visibility_flag.get():
                self.hide_view(view_id)
                if view_id == "InnerBrowser":
                    # self._view_records[view_id]["instance"].close_cef()
                    self._view_records[view_id]["instance"].close_cef()
            else:
                self.show_view(view_id, True)
                if view_id == "InnerBrowser":
                    self._view_records[view_id]["instance"].initialize_cef()
