...
class WebKeyWord(BaseKeyWord):
    ...
    driver: Incomplete
    wait: Incomplete
    def key_new_driver(self, browser: str = ..., hub: str = ..., capabilities: str = '', *args, **kwargs): ...
    ...
    def key_sleep(self, times: str, *args, **kwargs): ...
...
class AppKeyWord(BaseKeyWord):
    ...
    def key_swipe(self, start_x: int, start_y: int, end_x: int, end_y: int, times: int = 0.1, *args, **kwargs): ...
    ...
    def key_ac_new_swipe(self, start_x: int, start_y: int, end_x: int, end_y: int, times: int = 0.1, *args, **kwargs): ...
