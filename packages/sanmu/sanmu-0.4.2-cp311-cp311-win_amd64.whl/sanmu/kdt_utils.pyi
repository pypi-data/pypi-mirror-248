...
class MyActionChains(ActionChains):
    ...
    def touch_by_new_pointer(self, start_x: int, start_y: int, end_x: int, end_y: int, pause_time: int = 0.1): ...
...
class BaseKeyWord(metaclass=abc.ABCMeta):
    ...
    def set_driver(self, fixture_name) -> None: ...
    ...
    def key_assert(self, value: str, assert_name, actual_value: str = '', *args, **kwarg): ...
