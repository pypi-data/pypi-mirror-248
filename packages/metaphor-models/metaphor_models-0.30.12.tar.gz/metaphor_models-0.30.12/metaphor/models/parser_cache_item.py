...
class MapStringString:
    ...
    to_string_tag_4870: Optional[str] = None
    size: Optional[float] = None

    @staticmethod
    def from_dict(obj: Any) -> 'MapStringString':
        assert isinstance(obj, dict)
        to_string_tag_4870 = from_union([from_str, from_none], obj.get("__@toStringTag@4870"))
        size = from_union([from_float, from_none], obj.get("size"))
        return MapStringString(to_string_tag_4870, size)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.to_string_tag_4870 is not None:
            result["__@toStringTag@4870"] = from_union([from_str, from_none], self.to_string_tag_4870)
