...
from apixunit.dataextract import get_defined_data, get_entries, get_base_Url, getDataSql, saved_request_Data, \
    saved_response_Data, get_file_headers, get_test_data
...
class apicall(cdxg.TestCase):
    ...
    def apicall(self, testcase, apiendpoint, xmethod, payload, params, tdata, headers, exresults, schemavar, gtypes,
        ...
        global status_code, getalljson, gettet, sparams, callapis, getendpoint
        ...
        try:
            ...
            get_results(xlcreate, roles, testcase, getendpoint, payload, params, exresults, 'ScriptError:' + str(e),
                        ...
                        elapsed_secs=time_elapsed, comments=schemavar, sprints=sprints, incidentids=incidentids, alljson=traceback.print_exc())