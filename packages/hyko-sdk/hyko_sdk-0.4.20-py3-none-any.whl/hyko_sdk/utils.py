...
def to_container_name(
    function_name: str, hf_model_name: str | None, device_map: str | None
) -> str:
    container_name: str = "hyko_sdk_"
    container_name += function_name[len("sdk/") :].replace("/", "_").replace(":", "_")
    if hf_model_name:
        container_name += "_" + hf_model_name.replace("/", "_").replace(":", "_")
    if device_map:
        container_name += "_" + device_map.replace("/", "_").replace(":", "_")
