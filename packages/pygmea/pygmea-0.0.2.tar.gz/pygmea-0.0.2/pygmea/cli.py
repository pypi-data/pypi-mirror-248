...
class URLDownloaderApp:
    ...
    def createURLList(app):
        ...
        #print(" -> " + str(lowerRange) + " " + str(upperRange) + " " + str(useLeadingZeroes))
        listTxt = list()
    ...
    def loadURLFile(app):
        ...
        filename = fd.askopenfilename(
            title='Open a URL list text file',
            initialdir='/',
            filetypes=filetypes)
    ...
    def __init__(self, master=None):
        ...
        self.statusMessage.set("Replaces '<>' with numbers and '<txt>' with texts provided above")
