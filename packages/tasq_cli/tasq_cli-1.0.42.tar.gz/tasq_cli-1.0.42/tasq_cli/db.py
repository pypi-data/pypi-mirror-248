...
class UploadsDatabase:
    ...
    def _create_tables(self):
        ...
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_dataset_name ON uploads (dataset_name);")
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_file_name ON uploads (file_name);")
