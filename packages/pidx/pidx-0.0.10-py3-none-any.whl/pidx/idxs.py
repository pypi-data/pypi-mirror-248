...
from atyp import (    
    DataFrame, IndexLike, IndexQ, BoolIndex,
    NPArray, NumStr, BoolQ, IndexLikeQ, CatIndexQ, BoolIndexQ
)
...
# %% ../nbs/20_idxs.ipynb 20
from nlit import CATEGORY, CATEGORIES
from hasr import hascat
from getr import getindex, getcategories
from hasr import hasindex, hasastype, hascategories

# %% ../nbs/20_idxs.ipynb 22
from .mock import dummydf
from .util import getdfidx, wrapidx, idxisin, mergebools, safeloc, safeiloc
from .util import DataFrameLike, ascat, ascidx

# %% ../nbs/20_idxs.ipynb 28
...
# %% ../nbs/20_idxs.ipynb 30
def getaidx(dl: DataFrameLike = None, idx: IndexLikeQ = None, *args: DataFrameLike) -> IndexQ:
...
def getcats(dl: DataFrameLike = None, cidx: CatIndexQ = None, *args: DataFrameLike) -> IndexQ:
    '''
...
def cateqidx(
    dl: DataFrameLike, cat: NumStr, cidx: CatIndexQ = None, *args: DataFrameLike
    # df: DataFrame, cat: NumStr, cidx: IndexQ = None, ds: DatasetQ = None, logger: LoggerQ = None
) -> BoolIndex:
    '''
...
def wherecats(
    ...
    # df: DataFrame, cats: NumStr | IndexLike, cidx: CatIndexQ = None, ds: DatasetQ = None, logger: LoggerQ = None  
):
    '''
...
# %% ../nbs/20_idxs.ipynb 52
def catseqidx(
    dl: DataFrameLike, cats: NumStr | IndexLike, cidx: CatIndexQ = None, *args: DataFrameLike
    # df: DataFrame, cats: NumStr | IndexLike, cidx: IndexQ = None, ds: DatasetQ = None, logger: LoggerQ = None
) -> BoolIndex:
    '''
    Check where a categorical index has a specified category.
...
# %% ../nbs/20_idxs.ipynb 63
def geticat(
    dl: DataFrameLike, idx: IndexLikeQ = None, *args: DataFrameLike, unique: BoolQ = True, cats: CatIndexQ = None
