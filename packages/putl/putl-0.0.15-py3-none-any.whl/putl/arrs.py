...
# %% auto 0
__all__ = ['P', 'consec', 'non0row', 'runs', 'sameruns', 'mergeruns', 'islastval', 'islastidx', 'islast']
...
# %% ../nbs/40_arrs.ipynb 23
def islastval(v, a: list) -> bool: return v == a[-1]
def islastidx(i: int, a: list) -> bool: return i == (len(a) - 1)
def islast(e, a: list) -> bool: return islastval(e, a) or islastidx(e, a)
