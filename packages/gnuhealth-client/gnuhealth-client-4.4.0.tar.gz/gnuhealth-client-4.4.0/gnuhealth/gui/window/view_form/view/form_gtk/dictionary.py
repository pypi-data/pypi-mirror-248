...
from gnuhealth.common import Tooltips, timezoned_date, untimezoned_date, \
        IconFactory
...
from gnuhealth.common.datetime_ import Date, DateTime, add_operators
...
from gnuhealth.common.domain_inversion import eval_domain
...
class DictWidget(Widget):
    ...
    def __init__(self, view, attrs):
        ...
        self.but_add.add(
            IconFactory.get_image('gnuhealth-add', Gtk.IconSize.SMALL_TOOLBAR))
    ...
    def _new_remove_btn(self):
        ...
        but_remove.add(
            IconFactory.get_image('gnuhealth-remove', Gtk.IconSize.SMALL_TOOLBAR))
