...
from gnuhealth.common.datetime_ import popup_position, popup_show, popup_hide
...
class Toolbar(Gtk.Toolbar):
    ...
    def __init__(self, goocalendar):
        ...
        arrow_left = IconFactory.get_image('gnuhealth-arrow-left')
        ...
        arrow_right = IconFactory.get_image('gnuhealth-arrow-right')
