...
if __name__ == '__main__':
    ...
    mean_pixel1, std_pixel1, mean_level1, std_level1 = cal_mean_std_one_loop(s1, ss1, 3)
    mean_pixel2, std_pixel2, mean_level2, std_level2 = cal_mean_std_one_loop(s2, ss2, 2)
    print('*' * 40)
    ...
    mean_pixel, std_pixel = mean_std_part2all([3, 2], [mean_pixel1, mean_pixel2], [std_pixel1, std_pixel2])
    mean_level, std_level = mean_std_part2all([3, 2], [mean_level1, mean_level2], [std_level1, std_level2])
    print('*' * 40)
