...
class AppiumImage:
    ...
    def find_and_tap_in_drop_down_menu(self, item: str, items: List[str], drop_down_coordinates: tuple=None, timeout: int = 390):
        ...
        while True:
            try:
                ...
                if drop_down_coordinates is not None:
                    self.terminal.tap(drop_down_coordinates)
                continue
