...
@action_recipe(
    ...
    field_props={
        ...
        "model_registration": OptionalProps(title="Register Model", description="Register model with Prodigy Teams", optional_title="Enable model registration"),
...
def train(
    *,
    ...
    model_registration: Optional[ModelRegistrationSettings] = None,
    ...
    if not pipes:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            if model_registration is not None:
                ...
                _register_model(model_registration, tmp_dir)
