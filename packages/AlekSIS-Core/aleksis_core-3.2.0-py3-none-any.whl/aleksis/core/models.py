...
class Person(ExtensibleModel):
    ...
    def member_of_recursive(self) -> QuerySet:
        ...
        warnings.warn(
            "Person.member_of_recursive is deprecated and will be removed " "in AlekSIS-Core 4.0.",
            UserWarning,
        )
        q = self.member_of
        for group in q.all():
    ...
    def owner_of_recursive(self) -> QuerySet:
        """Get all groups this person is a member of, recursively."""
        warnings.warn(
            "Person.owner_of_recursive is deprecated and will be removed " "in AlekSIS-Core 4.0.",
            UserWarning,
        )
        q = self.owner_of
        for group in q.all():
...
class Group(SchoolTermRelatedExtensibleModel):
    ...
    def parent_groups_recursive(self) -> CTEQuerySet:
        ...
        warnings.warn(
            "Group.parent_groups_recursive is deprecated and will be removed "
            "in AlekSIS-Core 4.0.",
            UserWarning,
        )
    ...
    def child_groups_recursive(self) -> CTEQuerySet:
        ...
        warnings.warn(
            "Group.child_groups_recursive is deprecated and will be removed "
            "in AlekSIS-Core 4.0.",
            UserWarning,
        )
    ...
    def members_recursive(self) -> QuerySet:
        ...
        warnings.warn(
            "Group.members_recursive is deprecated and will be removed " "in AlekSIS-Core 4.0.",
            UserWarning,
        )
    ...
    def owners_recursive(self) -> QuerySet:
        ...
        warnings.warn(
            "Group.owners_recursive is deprecated and will be removed " "in AlekSIS-Core 4.0.",
            UserWarning,
        )
        return Person.objects.filter(
