...
@retrying
async def _refresh_cookies(url, headless=True, storage_state: Optional[Path] = '', timeout: int = 0, delay: int = 0):
...
def refresh_cookies(
    ...
    fn = partial(_refresh_cookies, url=url, headless=headless, timeout=timeout, delay=delay)
