...
def refresh(
    ...
    """
    mecli-browser refresh--storage-state "/Users/betterme/PycharmProjects/AI/MeUtils/meutils/playwright_utils/kimi*.json"
    """
    refresh_cookies(url, headless, storage_state, timeout, delay)
