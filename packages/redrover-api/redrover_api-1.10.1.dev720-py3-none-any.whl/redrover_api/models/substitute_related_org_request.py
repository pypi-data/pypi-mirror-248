...
class SubstituteRelatedOrgRequest(BaseModel):
    """
    ...
    attributes: Optional[List[SubstituteAttributeRequest]] = Field(default=None, description="The Substitute's attributes")
    __properties: ClassVar[List[str]] = ["orgId", "payCode", "attributes"]
