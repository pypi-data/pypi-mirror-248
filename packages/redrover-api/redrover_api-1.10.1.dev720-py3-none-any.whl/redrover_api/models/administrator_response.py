...
class AdministratorResponse(BaseModel):
    ...
    """ # noqa: E501
    is_super_user: Optional[StrictBool] = Field(default=None, description="If the User is a super user", alias="isSuperUser")
    access_control: Optional[AccessControlResponse] = Field(default=None, alias="accessControl")
    ...
    __properties: ClassVar[List[str]] = ["isSuperUser", "accessControl", "relatedOrgIds", "id", "orgId", "createdUtc", "changedUtc", "externalId", "firstName", "middleName", "lastName", "email", "notificationEmail", "loginEmail", "dateOfBirth", "address1", "address2", "city", "state", "postalCode", "country", "phoneNumber", "active", "permissionSetId", "isDeleted"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "accessControl": AccessControlResponse.from_dict(obj.get("accessControl")) if obj.get("accessControl") is not None else None,
