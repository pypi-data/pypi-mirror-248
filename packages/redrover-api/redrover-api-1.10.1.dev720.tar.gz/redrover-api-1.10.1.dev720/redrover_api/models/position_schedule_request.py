...
class PositionScheduleRequest(BaseModel):
    """
    PositionScheduleRequest
    """ # noqa: E501
    items: List[PositionScheduleItemRequest] = Field(description="Position Schedule Items")
    days_of_the_week: List[DayOfWeek] = Field(description="Days of the week", alias="daysOfTheWeek")
    __properties: ClassVar[List[str]] = ["items", "daysOfTheWeek"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "items": [PositionScheduleItemRequest.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
