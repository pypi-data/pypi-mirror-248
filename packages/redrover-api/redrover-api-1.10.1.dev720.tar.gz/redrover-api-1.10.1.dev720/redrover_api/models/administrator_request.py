...
class AdministratorRequest(BaseModel):
    ...
    replace_existing_related_orgs: Optional[StrictBool] = Field(default=None, description="If existing related Organizations will be replaced. (Default is true)", alias="replaceExistingRelatedOrgs")
    is_super_user: Optional[StrictBool] = Field(default=None, description="If the Administrator is a super user", alias="isSuperUser")
    related_org_ids: Optional[List[StrictInt]] = Field(default=None, description="Organization Ids that the Administrator is related it", alias="relatedOrgIds")
    ...
    __properties: ClassVar[List[str]] = ["accessControl", "replaceExistingRelatedOrgs", "isSuperUser", "relatedOrgIds", "id", "secondaryIdentifier", "externalId", "firstName", "middleName", "lastName", "email", "notificationEmail", "dateOfBirth", "address1", "address2", "city", "postalCode", "badgeNumber", "state", "country", "phoneNumber", "active", "permissionSet", "removeFutureAssignmentsOnInactivate", "inviteImmediately"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.is_super_user is None and "is_super_user" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "accessControl": AccessControlRequest.from_dict(obj.get("accessControl")) if obj.get("accessControl") is not None else None,
