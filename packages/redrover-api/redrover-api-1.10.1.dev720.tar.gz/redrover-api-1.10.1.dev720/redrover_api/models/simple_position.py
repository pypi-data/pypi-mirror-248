...
class SimplePosition(BaseModel):
    ...
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="The name of the Position")
    hours_per_full_work_day: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Hours per full work day", alias="hoursPerFullWorkDay")
    ...
    __properties: ClassVar[List[str]] = ["title", "hoursPerFullWorkDay", "positionType", "needsReplacement", "id", "externalId"]
