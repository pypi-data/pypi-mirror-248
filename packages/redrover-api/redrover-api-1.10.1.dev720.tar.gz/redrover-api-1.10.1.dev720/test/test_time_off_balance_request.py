...
class TestTimeOffBalanceRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TimeOffBalanceRequest:
        """Test TimeOffBalanceRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeOffBalanceRequest`
        """
        model = TimeOffBalanceRequest()
        if include_optional:
            return TimeOffBalanceRequest(
                ...
                absence_reason_tracking_type_id = ERROR_TO_EXAMPLE_VALUE,
                balance = 1.337
            )
        else:
            return TimeOffBalanceRequest(
