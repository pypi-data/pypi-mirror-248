...
class TestPositionScheduleRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PositionScheduleRequest:
        """Test PositionScheduleRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PositionScheduleRequest`
        """
        model = PositionScheduleRequest()
        if include_optional:
            return PositionScheduleRequest(
                ...
                days_of_the_week = ERROR_TO_EXAMPLE_VALUE
            )
        else:
            return PositionScheduleRequest(
                items = [
