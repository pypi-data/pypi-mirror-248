...
class TestPositionScheduleItemRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PositionScheduleItemRequest:
        """Test PositionScheduleItemRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PositionScheduleItemRequest`
        """
        model = PositionScheduleItemRequest()
        if include_optional:
