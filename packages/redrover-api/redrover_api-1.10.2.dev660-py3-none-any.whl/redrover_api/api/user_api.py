...
class UserApi:
    ...
    def get_substitutes(
        ...
        limit: Annotated[Optional[StrictInt], Field(description="Limit. For pagination purposes")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Offset. For pagination purposes")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def get_substitutes_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[SubstituteResponse]]:
        """Query for Substitutes
    ...
    def update_admin(
        self,
        org_id: Annotated[StrictInt, Field(description="The Red Rover Id of the Organization")],
        identifier: Annotated[StrictStr, Field(description="The identifier of the OrgUser. If this is an External Id, prepend the value with the pike character `|` (e.g. `|ABC123`)")],
        administrator_request: Optional[AdministratorRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
