...
class AbsenceReasonBalanceApi:
    ...
    def create_absence_reason_balance(
        ...
        employee_identifier: Annotated[StrictStr, Field(description="The identifier of the Employee. If this is an External Id, prepend the value with the pike character `|` (e.g. `|ABC123`)")],
