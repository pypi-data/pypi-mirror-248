...
class VacancyDetailResponse(BaseModel):
    ...
    approval_status_id: Optional[ApprovalStatusEnum] = Field(default=None, alias="approvalStatusId")
    __properties: ClassVar[List[str]] = ["id", "assignmentId", "substitute", "externalAssignmentNumber", "assignmentIsLongTerm", "assignmentNotes", "location", "start", "end", "actualDurationMinutes", "accountingCodes", "payDuration", "payUnit", "payCode", "vacancyReason", "verified", "verifiedAtUtc", "verifyComment", "verifiedBy", "approvalStatus", "approvalStatusId"]
