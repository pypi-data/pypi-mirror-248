...
class SubstituteAttributeResponse(BaseModel):
    """
    SubstituteAttributeResponse
    """ # noqa: E501
    attribute: Optional[Int32LocatorResponse] = None
    expires: Optional[datetime] = Field(default=None, description="When the attribute expire")
    __properties: ClassVar[List[str]] = ["attribute", "expires"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "attribute": Int32LocatorResponse.from_dict(obj.get("attribute")) if obj.get("attribute") is not None else None,
