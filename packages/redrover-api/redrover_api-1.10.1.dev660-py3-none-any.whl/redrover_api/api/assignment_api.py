...
class AssignmentApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_assignment_endpoint = _Endpoint(
            settings={
                'response_type': (AssignmentResponse,),
                'auth': [
                    'basic'
                ],
                'endpoint_path': '/api/v1/{orgId}/Assignment/{identifier}',
    ...
    def get_assignment(
        ...
        **kwargs
        ...
        kwargs['identifier'] = \
            identifier
        return self.get_assignment_endpoint.call_with_http_info(**kwargs)
