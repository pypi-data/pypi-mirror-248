...
from src.game_qu.base.utility_functions import button_is_clicked, mouse_is_clicked
...
from src.game_qu.base.utility_functions import game_button_is_clicked
