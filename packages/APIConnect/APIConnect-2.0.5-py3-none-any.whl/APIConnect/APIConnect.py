...
class APIConnect:
    ...
    def __init__(self, ApiKey, Password, reqID, downloadContract: bool, conf = None) -> None:
        ...
        AppIdKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcHAiOjAsImZmIjoiVyIsImJkIjoid2ViLXBjIiwibmJmIjoxNzAzODUyMTEzLCJzcmMiOiJlbXRtdyIsImF2IjoiMi4wLjUiLCJhcHBpZCI6IjM1M2FjZTM0NjI1MWUzMzQxNmQ5MWVjOGViMmEwOGE2IiwiaXNzIjoiZW10IiwiZXhwIjoxNzAzODc0NjAwLCJpYXQiOjE3MDM4NTI0MTN9.3yt5bQXw_a3PFo4Kb9KMcmzFUWSVT1kO0fwLQsHT488"
...
# Trade Methods
    ...
    def PlaceBracketTrade(self, Exchange : ExchangeEnum, Streaming_Symbol, Transaction_Type : ActionEnum, Quantity : int, Duration : DurationEnum, Disclosed_Quantity, Limit_Price, Target, StopLoss, Trailing_Stop_Loss='Y', Trailing_Stop_Loss_Value="1") -> str or None:
        ...
        Validator.validate_stopLoss(StopLoss)
    ...
    def getCustomPeriodChart(self, Exchange : ChartExchangeEnum, AssetType : AssetTypeEnum, Streaming_Symbol, 
        ...
        response = self.__getCustomPeriodChartDataOfScrip(Exchange.value, AssetType, Streaming_Symbol, Interval, FromDate, ToDate, IncludeContinuousFutures)
