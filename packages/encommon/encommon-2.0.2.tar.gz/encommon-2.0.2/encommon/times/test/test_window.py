...
def test_Window() -> None:
    ...
    assert len(window.__dict__) == 8

    assert hasattr(window, '_Window__schedule')
    assert hasattr(window, '_Window__start')
    assert hasattr(window, '_Window__stop')
    assert hasattr(window, '_Window__anchor')
    assert hasattr(window, '_Window__delay')
    assert hasattr(window, '_Window__wilast')
    assert hasattr(window, '_Window__winext')
    assert hasattr(window, '_Window__walked')
