...
class TcConnection:
    def __init__(self, url: str, username: str, password: str, locale: str, descrimator: str = None, insecure: bool = False, backend: str = 'tcsoa.backend.RestBackend'):
        """
...
class TcSoaBasics:
    ...
    @classmethod
    def download_file(cls, ticket: str, path: str):
        TcSoaConfig.backend.fms_download(ticket, path)
