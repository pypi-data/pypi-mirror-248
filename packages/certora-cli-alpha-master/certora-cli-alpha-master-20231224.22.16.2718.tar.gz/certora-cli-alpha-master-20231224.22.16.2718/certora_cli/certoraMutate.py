...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--mutation_conf", type=Path, help="The mutation .conf file to use for Gambit runs.", required=True)
    ...
    parser.add_argument("--gambit_only", action="store_true", help="Stop proccessing after generating mutations.")
