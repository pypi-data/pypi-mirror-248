...
class QlikSense:
    ...
    def get_apps_by_name(self, app_name):
        apps = self.__qs_repository.get_app_list(filter=f"name eq '{app_name}'")
    ...
    def get_hypercube_data(self, app_id, cube, x: int, y: int):
        result = self.__qs_engine.get_hypercube_data(app_id, cube, x, y)
        return result
