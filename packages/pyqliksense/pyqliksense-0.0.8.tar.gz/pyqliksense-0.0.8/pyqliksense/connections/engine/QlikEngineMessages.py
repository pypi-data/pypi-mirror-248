class QlikSenseEngineMessages:
    ...
    @classmethod
    def get_tree(cls, handle):
        return cls.build_engine_message(handle=handle, method="GetFullPropertyTree", params={})

    @classmethod
    def set_tree(cls, handle, tree):
        return cls.build_engine_message(handle=handle, method="SetFullPropertyTree", params=tree)
