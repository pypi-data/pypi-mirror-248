...
class ApiClient(base_api_client.ApiClient):
    ...
    async def add_event(self, account_id: str, championship_id: str, create_model: CreateModel) -> ApiGetResult[Mapping | None]:
        response = await self.post_request(account_id, f"{self.api_endpoint}Events?championshipId={championship_id}", create_model)
    ...
    async def add_tyre_set_pressure_adjustment(self, account_id: str, tyre_set_id: str, create_model: CreateModel) -> ApiGetResult[Mapping | None]:
        response = await self.post_request(account_id, f"{self.api_endpoint}TyreSetPressureAdjustments?tyreSetId={tyre_set_id}", create_model)
    ...
    async def add_account_options(self, account_id: str, create_model: CreateModel) -> ApiGetResult[Mapping | None]:
        response = await self.post_request(account_id, f"{self.api_endpoint}AccountOptions?accountId={account_id}", create_model)
    ...
    async def add_session(self, account_id: str, event_id: str, create_model: CreateModel) -> ApiGetResult[Mapping | None]:
        response = await self.post_request(account_id, f"{self.api_endpoint}Sessions?eventId={event_id}", create_model)
