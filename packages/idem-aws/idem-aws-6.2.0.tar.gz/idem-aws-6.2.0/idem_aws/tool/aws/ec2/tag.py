...
async def get_tags_for_resource(hub, ctx, resource_id: str) -> Dict[str, Any]:
    r"""
    Get tags for a given resource in EC2.
    """
    ...
    tags_ret = await hub.exec.boto3.client.ec2.describe_tags(
        ctx,
        Filters=[
            {
                "Name": "resource-id",
