...
python3 support/update_version.py examples website_build/examples/example.html website_build/examples/example.html
...
pdoc --docformat google ./sketching -o website_build/devdocs/
