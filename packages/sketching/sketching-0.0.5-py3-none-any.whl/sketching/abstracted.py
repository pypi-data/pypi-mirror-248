...
class Sketch:
    ...
    def set_arc_mode(self, mode: str):
        """Specify how Sketching should interpret the position and size arguments for arcs.
    ...
    def set_ellipse_mode(self, mode: str):
        """Specify how Sketching should interpret the position and size arguments.
    ...
    def set_map_pan(self, longitude: float, latitude: float):
        ...
        """
        self._map_current_view = sketching.geo.GeoTransformation(
            sketching.geo.GeoPoint(longitude, latitude),
    ...
    def convert_geo_to_pixel(self, longitude: float,
        ...
        """
        point = sketching.geo.GeoPoint(longitude, latitude, )
    ...
    def start_geo_polygon(self, longitude: float,
        latitude: float) -> sketching.geo.GeoPolygonBuilder:
        ...
        return sketching.geo.GeoPolygonBuilder(longitude, latitude, get_current_view)
    ...
    def parse_geojson(self, source: typing.Dict) -> typing.List[sketching.geo.GeoPolygonBuilder]:
        ...
        """
        raw_polygons = sketching.geo.parse_geojson(source)
    ...
    def set_image_mode(self, mode: str):
        """Specify how Sketching should place images.
    ...
    def set_angle_mode(self, mode: str):
        """Indicate how angles should be provided to sketching.

        Change the units with which angles are expressed to Sketching in transforms and shapes.
    ...
    def _build_geo_polygon_builder(self,
        polygon: typing.List[typing.Tuple[float, float]]) -> sketching.geo.GeoPolygonBuilder:
        get_current_view = lambda: self._map_current_view
        builder = sketching.geo.GeoPolygonBuilder(polygon[0][0], polygon[0][1], get_current_view)
    ...
    def _create_map_view(self) -> sketching.geo.GeoTransformation:
        return sketching.geo.GeoTransformation(
            sketching.geo.GeoPoint(sketching.geo.BASE_LONGITUDE, sketching.geo.BASE_LATITUDE),
            sketching.geo.PixelOffset(sketching.geo.BASE_X, sketching.geo.BASE_Y),
            sketching.geo.BASE_SCALE
        )
