...
def test_kind():
    ...
    mod         = rk_model(preffix='kind_alt_1', d_eff=d_eff, d_nent=d_nent, l_dset=['2018_TOS'])
    mod.kind    = 'signal_ee:alt_1'
...
def test_all_years():
    ...
    mod         = rk_model(preffix='allyears', d_eff=d_eff, d_nent=d_nent, l_dset=['all_TOS', 'all_TIS'])
