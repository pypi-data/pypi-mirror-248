...
#cgo CFLAGS: -I/usr/local/opt/python@3.8/Frameworks/Python.framework/Versions/3.8/include/python3.8 -Wno-error -Wno-implicit-function-declaration -Wno-int-conversion
