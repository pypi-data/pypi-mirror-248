...
def create_network(netiface, links_info, connector_info, other_info):
    ...
    # 创建连接段
    for connector_road_tuple, connector_info in pgd.progress(connector_info.items(), "创建连接段中（8/8）"):
