...
import traceback
from .config import p, default_lane_width, min_width, join_point_distance
...
def get_data(folder_path, is_use_lon_and_lat, is_use_center_line, laneFileName, laneConnectorFileName):
    # 读取路段数据
