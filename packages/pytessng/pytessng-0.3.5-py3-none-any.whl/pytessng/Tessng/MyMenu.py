...
class NetworkImportOpenstreetmap(QWidget):
    ...
    def create_network(self):
        ...
        # bounding_box = {
        #     "lon_min": 121.11877441406250,
        #     "lon_max": 121.40441894531250,
        #     "lat_min": 31.114091594898689,
        #     "lat_max": 31.311408386201627,
        # }
...
class TrajectoryExport(QWidget):
    ...
    def check_kafka(self):
        ...
        kafka_pull_is_ok, message = self.check_kafka_pull(ip, port, topic)
    ...
    def check_kafka_pull(self, ip, port, topic):
        ...
        try:
            ...
            if messages:
                ...
                message = "Kafka消息拉取测试成功！"
            else:
                message = "Kafka消息拉取测试失败：未接收到消息"
        except Exception as e:
            message = f"Kafka消息拉取测试失败：{e}"
        try:
            consumer.close()
        except:
            pass
