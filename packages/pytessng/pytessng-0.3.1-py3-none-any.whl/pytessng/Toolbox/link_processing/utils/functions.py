...
def get_split_info(line, given_distance):
    ...
    for i in range(1, len(line)):
        ...
        if all_length < given_distance:
            ...
            split_info = (i-1, ratio)
            break

    return split_info

def split_line_by_split_info(line, split_info):
    index, ratio = split_info
...
# 简化路网文件
def simplify_tessng_file(file_path):
    """
