...
def furx(sv: np.ndarray, theta: float, q: int) -> np.ndarray:
    ...
    The operation will be in-place if the input is a CUDA device array or numpy.ndarray of
    complex data type. Otherwise the input will be copied to a new numpy.ndarray.
    @param sv statevector on which the rotation is applied (CUDA device array or numpy.ndarray)
    @param theta rotation angle
    @param q index of qubit on which the rotation is applied
    @return statevector after the operation
    """
