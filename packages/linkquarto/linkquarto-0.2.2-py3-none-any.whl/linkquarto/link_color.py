...
def affiche_freq2(x,xlab,ylab,titre, pal):
    """
    Cette fonction affiche un value_counts
    params:
        x : la colonne à afficher
        xlab : label abscice
        ylab : label ordonnée
        titre : le title
    """

    graf = sns.countplot(x=x,palette=pal)
    plt.xlabel(xlab,fontdict={"fontsize":"x-large",
                              "fontfamily":"Calibri",
                              "color":"#060341"});
    plt.ylabel(ylab,fontdict={"fontsize":"x-large", 
...
|_________________________________________________________________|
                 ...
                 `==========='    `===========' 
    """.format(message)
    print(ascii_art_rappel)
    
    
    
    
def bar_bivariee(x, y, xlab, ylab, titre, couleurs):
    """
    ...
    sns.countplot(x = x, hue= y,  palette=couleurs)
    plt.xlabel(xlab,fontdict={"fontsize":"x-large",
                              "fontfamily":"Calibri",
                              "color":"#060341"})
    plt.ylabel(ylab,fontdict={"fontsize":"x-large", 
