...
class H2OXGBoostParams(HasMonotoneConstraints, HasCalibrationDataFrame, HasIgnoredCols, Params):
    ...
    def getScoreEvalMetricOnly(self):
        return self.getOrDefault(self.scoreEvalMetricOnly)
    ...
    def setScoreEvalMetricOnly(self, value):
        return self._set(scoreEvalMetricOnly=value)
