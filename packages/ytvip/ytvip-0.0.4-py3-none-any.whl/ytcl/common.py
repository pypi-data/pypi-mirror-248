...
_INITIAL_PREFS_CONTENT = {
    ...
    _PREFKEYS.VIDEO_PLAYER_COMMAND: 'mpv',
}
...
VIDEO_PLAYER_CMD = _prefs.get(_PREFKEYS.VIDEO_PLAYER_COMMAND, 'mpv')
VIDEO_PLAYER_FLAGS = _prefs.get(
    _PREFKEYS.VIDEO_PLAYER_FLAGS,
    "--fullscreen --ontop" if 'mpv' in VIDEO_PLAYER_CMD else ''
)
...
In order to use this app, you need to sign up for a YouTube
API key and store it in the file "{_PREFS_FILE}" in this folder.
"""
