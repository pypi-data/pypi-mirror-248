...
from typing import Any, get_args, Union, get_origin, List
...
class KeycloakRoleInfoModel(BaseModel):
    """Keycloak representation of a role

    Attributes:
        roles (List[KeycloakRoleModel]):
        max_role (str): is computed field, which requires context on the API client
    """

    roles: List[KeycloakRoleModel] = None
    max_role: str = None
