...
from _qwak_proto.qwak.vectors.v1.vector_pb2 import DoubleVector, Property, StoredVector
...
def _upsert_vector_block(
    vector_tuples: List[Tuple[str, _Vector, _Properties]],
    chunk_size: int,
    collection_name: str,
...
def _upsert_natural_input_block(
    vector_tuples: List[Tuple[str, _NaturalInput, _Properties]],
    chunk_size: int,
    vectorizer_name: str,
    collection_name: str,
    edge_services_url: str,
