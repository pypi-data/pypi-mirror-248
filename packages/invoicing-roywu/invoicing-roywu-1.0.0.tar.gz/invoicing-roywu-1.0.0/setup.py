...
setup(
    name='invoicing-roywu',  # * Your package will have this name
    ...
    description='This package can be used to convert Excel invoices to PDF invoices. '
                'Example package from Ardit Sulce\'s course',
    # Short description of your library
    author='Roy Wu',  # Your name
    author_email='your.email@example.com',  # Your email
    url='https://github.com/Roy0528/App5-PDF-Invoices',  # Homepage of your library (e.g. github or your website)
