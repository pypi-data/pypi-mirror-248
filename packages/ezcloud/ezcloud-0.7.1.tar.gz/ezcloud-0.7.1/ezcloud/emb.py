...
Example
-------
Here is an example for sending a success message within a ezcloud application command.
...
from .internal.dc import ezcloud, discord
...
async def _send_embed(
    ...
    **kwargs,
    ...
    if ezcloud and isinstance(target, discord.ApplicationContext):
...
class EzContext(_ctx_type):  # type: ignore
    """A custom context to access embed templates. Only works within ezcloud application commands."""
