...
class PropertyValuePb final :
 ...
 public:
  ...
  inline PropertyValuePb(const PropertyValuePb& from)
      : PropertyValuePb(nullptr, from) {}
...
class LabelIdPb final :
 ...
 public:
  ...
  inline LabelIdPb(const LabelIdPb& from)
      : LabelIdPb(nullptr, from) {}
...
class PropertyDefPb final :
 ...
 public:
  ...
  inline PropertyDefPb(const PropertyDefPb& from)
      : PropertyDefPb(nullptr, from) {}
...
class EdgeKindPb final :
 ...
 public:
  ...
  inline EdgeKindPb(const EdgeKindPb& from)
      : EdgeKindPb(nullptr, from) {}
...
class TypeDefPb final :
 ...
 public:
  ...
  inline TypeDefPb(const TypeDefPb& from)
      : TypeDefPb(nullptr, from) {}
...
inline void EdgeKindPb::set_allocated_edge_label_id(::gs::rpc::graph::LabelIdPb* value) {
  ...
  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::gs::rpc::graph::LabelIdPb*>(value)->GetArena();
...
inline void PropertyDefPb::set_allocated_default_value(::gs::rpc::graph::PropertyValuePb* value) {
  ...
  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::gs::rpc::graph::PropertyValuePb*>(value)->GetArena();
    if (message_arena != submessage_arena) {
      value = ::google::protobuf::internal::GetOwnedMessage(message_arena, value, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000001u;
