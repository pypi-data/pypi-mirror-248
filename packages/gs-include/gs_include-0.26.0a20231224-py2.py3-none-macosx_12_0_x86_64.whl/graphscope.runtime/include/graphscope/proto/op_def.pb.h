...
class OpResult_Meta final :
 ...
 public:
  ...
  inline OpResult_Meta(const OpResult_Meta& from)
      : OpResult_Meta(nullptr, from) {}
...
class OpResult final :
 ...
 public:
  ...
  inline OpResult(const OpResult& from)
      : OpResult(nullptr, from) {}
...
class DagDef final :
 ...
 public:
  ...
  inline DagDef(const DagDef& from)
      : DagDef(nullptr, from) {}
...
inline ::gs::rpc::LargeAttrValue* OpDef::_internal_mutable_large_attr() {
  ...
  if (_impl_.large_attr_ == nullptr) {
    auto* p = CreateMaybeMessage<::gs::rpc::LargeAttrValue>(GetArena());
...
inline ::gs::rpc::OpResult_Meta* OpResult::_internal_mutable_meta() {
  ...
  if (_impl_.meta_ == nullptr) {
    auto* p = CreateMaybeMessage<::gs::rpc::OpResult_Meta>(GetArena());
...
inline void OpResult::set_allocated_meta(::gs::rpc::OpResult_Meta* value) {
  ...
  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::gs::rpc::OpResult_Meta*>(value)->GetArena();
    if (message_arena != submessage_arena) {
      value = ::google::protobuf::internal::GetOwnedMessage(message_arena, value, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000001u;
