...
class ChunkMeta final :
 ...
 public:
  ...
  inline ChunkMeta(const ChunkMeta& from)
      : ChunkMeta(nullptr, from) {}
...
class LargeAttrValue_ChunkMetaList final :
 ...
 public:
  ...
  inline LargeAttrValue_ChunkMetaList(const LargeAttrValue_ChunkMetaList& from)
      : LargeAttrValue_ChunkMetaList(nullptr, from) {}
...
class LargeAttrValue_ChunkList final :
 ...
 public:
  ...
  inline LargeAttrValue_ChunkList(const LargeAttrValue_ChunkList& from)
      : LargeAttrValue_ChunkList(nullptr, from) {}
...
class LargeAttrValue final :
 ...
 public:
  ...
  inline LargeAttrValue(const LargeAttrValue& from)
      : LargeAttrValue(nullptr, from) {}
...
inline ::gs::rpc::AttrValue_ListValue* AttrValue::_internal_mutable_list() {
  if (value_case() != kList) {
    clear_value();
    set_has_list();
    _impl_.value_.list_ = CreateMaybeMessage<::gs::rpc::AttrValue_ListValue>(GetArena());
  }
...
inline ::gs::rpc::NameAttrList* AttrValue::_internal_mutable_func() {
  if (value_case() != kFunc) {
    clear_value();
    set_has_func();
    _impl_.value_.func_ = CreateMaybeMessage<::gs::rpc::NameAttrList>(GetArena());
  }
...
inline ::gs::rpc::LargeAttrValue_ChunkList* LargeAttrValue::_internal_mutable_chunk_list() {
  if (large_value_case() != kChunkList) {
    clear_large_value();
    set_has_chunk_list();
    _impl_.large_value_.chunk_list_ = CreateMaybeMessage<::gs::rpc::LargeAttrValue_ChunkList>(GetArena());
  }
...
inline ::gs::rpc::LargeAttrValue_ChunkMetaList* LargeAttrValue::_internal_mutable_chunk_meta_list() {
  if (large_value_case() != kChunkMetaList) {
    clear_large_value();
    set_has_chunk_meta_list();
    _impl_.large_value_.chunk_meta_list_ = CreateMaybeMessage<::gs::rpc::LargeAttrValue_ChunkMetaList>(GetArena());
  }
