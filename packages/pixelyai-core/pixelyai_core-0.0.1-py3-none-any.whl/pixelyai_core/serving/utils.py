...
class BaseClassAgent:
    ...
    def gradio_app_custom(self) -> gr.Blocks:
    ...
    if contexts is not None:
        for context in contexts:
            ...
            if is_found:
                ...
                break
        if not is_found:
            partial_generator_function = functools.partial(
                client.predict,
                prompt,  # str in "Message Box" Textbox component
                "",  # str in "UserId" Textbox component
                history,  # str in "Data" Textbox component
            ...
            generated_response = partial_generator_function(fn_index=0)[-1]
            # generated_response_tokens = partial_generator_function(fn_index=4)
    ...
    if contexts is not None:
        for context in contexts:
            ...
            grf_func = functools.partial(
                ...
                prompt,  # str in "Message Box" Textbox component
                "",  # str in "UserId" Textbox component
                f"Here's Extra information:\n{context}{END_OF_MESSAGE_TURN_HUMAN}Great, thank you for "
                f"providing me with this  additional information.",  # str in "Data" Textbox component
                FOUND_SYSTEM_MESSAGE,  # str in "System" Textbox component
                max_new_tokens,
                # int | float (numeric value between 64 and 10000) in "Max New Tokens" Slider component
                False,
            )
        ...
        possibilities.append(partial_generator_function(fn_index=4))
