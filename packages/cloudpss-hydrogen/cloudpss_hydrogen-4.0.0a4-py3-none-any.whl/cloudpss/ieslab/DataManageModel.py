...
class IESPlanDataManageModel(DataManageModel):
    ...
    _kindNameMap = {
        ...
        "氢负荷": "HydrogenLoad",
        "化石燃料制氢": "HydrogenProductionFuels",
        "运氢槽车": "HydrogenTanker"
    }
    _kindUrlMap = {
        ...
        "HydrogenTank": "api/ieslab-plan/rest/escs/",
        "HeatStoTank": "api/ieslab-plan/rest/escs/",
        "HeatExchanger": "api/ieslab-plan/rest/hstcs/",
        "HydrogenCompression": "api/ieslab-plan/rest/hsec/",
        "HydrogenLoad": "api/ieslab-plan/rest/hydrogenLoad/",
        "HydrogenProductionFuels": "api/ieslab-plan/rest/hydrogen/",
        "HydrogenTanker": "api/ieslab-plan/rest/hydrogen/",
        "PEMF": "api/ieslab-plan/rest/dhscs/",
        "SOFC": "api/ieslab-plan/rest/dhscs/",
        "ALK": "api/ieslab-plan/rest/hpc/",
        "PEME": "api/ieslab-plan/rest/hpc/",
        "SOEC": "api/ieslab-plan/rest/hpc/",
    }
    pass