        ...
        try:
            ...
            if self.choice['AnomalyDetection']==1:
                ...
                result=AnomalyDetection(df_new,self.anomalytype, self.column_types, self.columns_and_null_handling, columns_and_contamination=self.columns_and_contamination, 
                 columns_and_dbscan_params =self.columns_and_dbscan_params, total_contamination=self.total_contamination, total_epsilon=self.total_epsilon, min_sample=self.min_samples).run_anomaly_detection()
