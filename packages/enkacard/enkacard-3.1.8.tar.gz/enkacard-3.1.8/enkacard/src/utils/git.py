...
font = str(file_path.parent.parent / 'assets' / 'total' / 'font' / 'Genshin_Impact.ttf') .replace('\\', '/')
fontKH = str(file_path / 'assets' /'total'/ 'font' / 'GSEnochian.ttf').replace('\\', '/')

async def change_Font(x):
    global font
    if x == 0:
        font = str(file_path / 'assets' /'total' / 'font' / 'Genshin_Impact.ttf').replace('\\', '/')
    else:
        font = str(file_path / 'assets' /'total' / 'font' / 'GSEnochian.ttf').replace('\\', '/')
