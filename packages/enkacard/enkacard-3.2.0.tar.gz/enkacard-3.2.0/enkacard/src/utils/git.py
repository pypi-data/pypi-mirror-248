...
font = str(Path(__file__).resolve().parent.parent / 'assets' / 'total' / 'font' / 'Genshin_Impact.ttf')
fontKH = str(Path(__file__).resolve().parent.parent / 'assets' / 'total'/ 'font' / 'GSEnochian.ttf')
...
async def change_Font(x):
    ...
    if x == 0:
        ...
        font = str(Path(__file__).resolve().parent.parent / 'assets' /'total' / 'font' / 'GSEnochian.ttf')
mapping = {
