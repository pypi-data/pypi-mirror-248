...
font = str(file_path.parent.parent / 'assets' / 'total' / 'font' / 'Genshin_Impact.ttf') 
fontKH = str(file_path / 'assets' /'total'/ 'font' / 'GSEnochian.ttf')

async def change_Font(x):
    global font
    if x == 0:
        font = str(file_path / 'assets' /'total' / 'font' / 'Genshin_Impact.ttf')
    else:
        font = str(file_path / 'assets' /'total' / 'font' / 'GSEnochian.ttf')
