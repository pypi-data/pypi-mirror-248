    ...
    namespace phoenix6
    {
        namespace spns
        {
            ...
            public:
                ...
                static constexpr int PRO_PIDStateEnables_IsMotionMagicRunning = 2050;
                static constexpr int PRO_PIDStateEnables_DeviceEnable = 2052;
                static constexpr int PRO_PIDRefPIDErr_PIDRef_Position = 2054;
                static constexpr int PRO_PIDRefPIDErr_PIDRef_Velocity = 2055;
                static constexpr int PRO_PIDRefPIDErr_PIDErr_Position = 2056;
                static constexpr int PRO_PIDRefPIDErr_PIDErr_Velocity = 2057;
                static constexpr int PRO_PIDOutput_ProportionalOutput_DC = 2059;
                static constexpr int PRO_PIDOutput_ProportionalOutput_V = 2060;
                static constexpr int PRO_PIDOutput_ProportionalOutput_A = 2061;
                static constexpr int PRO_PIDOutput_DerivativeOutput_DC = 2062;
                static constexpr int PRO_PIDOutput_DerivativeOutput_V = 2063;
                static constexpr int PRO_PIDOutput_DerivativeOutput_A = 2064;
                static constexpr int PRO_PIDOutput_Output_DC = 2065;
                static constexpr int PRO_PIDOutput_Output_V = 2066;
                static constexpr int PRO_PIDOutput_Output_A = 2067;
                static constexpr int PRO_PIDOutput_Slot = 2068;
                static constexpr int PRO_PIDRefSlopeECUTime_ReferenceSlope_Position = 2069;
                static constexpr int PRO_PIDRefSlopeECUTime_ReferenceSlope_Velocity = 2070;
                static constexpr int PRO_MotorOutput_PIDState_Diff_DutyCycle = 2073;
                static constexpr int PRO_MotorOutput_PIDState_Diff_TorqueCurrent = 2074;
                static constexpr int TalonFX_DifferentialControlMode = 2077;
                static constexpr int PRO_MotorOutput_PIDState_Diff_IntegratedAccum_DC = 2078;
                static constexpr int PRO_MotorOutput_PIDState_Diff_IntegratedAccum_V = 2079;
                static constexpr int PRO_MotorOutput_PIDState_Diff_IntegratedAccum_A = 2080;
                static constexpr int PRO_MotorOutput_PIDState_Diff_FeedForward_DC = 2081;
                static constexpr int PRO_MotorOutput_PIDState_Diff_FeedForward_V = 2082;
                static constexpr int PRO_MotorOutput_PIDState_Diff_FeedForward_A = 2083;
                static constexpr int PRO_AvgPosAndVel_Velocity = 2085;
                static constexpr int PRO_AvgPosAndVel_Position = 2086;
                static constexpr int PRO_DiffPosAndVel_Velocity = 2089;
                static constexpr int PRO_DiffPosAndVel_Position = 2090;
                static constexpr int PRO_DiffPIDRefPIDErr_PIDRef_Position = 2092;
                static constexpr int PRO_DiffPIDRefPIDErr_PIDRef_Velocity = 2093;
                static constexpr int PRO_DiffPIDRefPIDErr_PIDErr_Position = 2094;
                static constexpr int PRO_DiffPIDRefPIDErr_PIDErr_Velocity = 2095;
                static constexpr int PRO_DiffPIDOutput_ProportionalOutput_DC = 2097;
                static constexpr int PRO_DiffPIDOutput_ProportionalOutput_V = 2098;
                static constexpr int PRO_DiffPIDOutput_ProportionalOutput_A = 2099;
                static constexpr int PRO_DiffPIDOutput_DerivativeOutput_DC = 2100;
                static constexpr int PRO_DiffPIDOutput_DerivativeOutput_V = 2101;
                static constexpr int PRO_DiffPIDOutput_DerivativeOutput_A = 2102;
                static constexpr int PRO_DiffPIDOutput_Output_DC = 2103;
                static constexpr int PRO_DiffPIDOutput_Output_V = 2104;
                static constexpr int PRO_DiffPIDOutput_Output_A = 2105;
                static constexpr int PRO_DiffPIDOutput_Slot = 2106;
                static constexpr int PRO_DiffPIDRefSlopeECUTime_ReferenceSlope_Position = 2107;
                static constexpr int PRO_DiffPIDRefSlopeECUTime_ReferenceSlope_Velocity = 2108;
                static constexpr int Slot0_kP = 2110;
                static constexpr int Slot0_kI = 2111;
                static constexpr int Slot0_kD = 2112;
                static constexpr int Slot0_kS = 2113;
                static constexpr int Slot0_kV = 2114;
                static constexpr int Slot0_kA = 2115;
                static constexpr int Slot0_kG = 2116;
                static constexpr int Slot0_kG_Type = 2117;
                static constexpr int Slot1_kP = 2118;
                static constexpr int Slot1_kI = 2119;
                static constexpr int Slot1_kD = 2120;
                static constexpr int Slot1_kS = 2121;
                static constexpr int Slot1_kV = 2122;
                static constexpr int Slot1_kA = 2123;
                static constexpr int Slot1_kG = 2124;
                static constexpr int Slot1_kG_Type = 2125;
                static constexpr int Slot2_kP = 2126;
                static constexpr int Slot2_kI = 2127;
                static constexpr int Slot2_kD = 2128;
                static constexpr int Slot2_kS = 2129;
                static constexpr int Slot2_kV = 2130;
                static constexpr int Slot2_kA = 2131;
                static constexpr int Slot2_kG = 2132;
                static constexpr int Slot2_kG_Type = 2133;
                static constexpr int Config_Inverted = 2134;
                static constexpr int Config_SupplyVLowpassTau = 2135;
                static constexpr int Config_BeepOnBoot = 2136;
                static constexpr int Config_NeutralMode = 2137;
                static constexpr int Config_DutyCycleNeutralDB = 2138;
                static constexpr int Config_StatorCurrentLimit = 2139;
                static constexpr int Config_StatorCurrLimitEn = 2140;
                static constexpr int Config_SupplyCurrentLimit = 2141;
                static constexpr int Config_SupplyCurrLimitEn = 2142;
                static constexpr int Config_PeakForwardDC = 2143;
                static constexpr int Config_PeakReverseDC = 2144;
                static constexpr int Config_PeakForwardV = 2145;
                static constexpr int Config_PeakReverseV = 2146;
                static constexpr int Config_PeakForTorqCurr = 2147;
                static constexpr int Config_PeakRevTorqCurr = 2148;
                static constexpr int Config_TorqueNeutralDB = 2149;
                static constexpr int Config_FeedbackRotorOffset = 2150;
                static constexpr int Config_SensorToMechanismRatio = 2151;
                static constexpr int Config_RotorToSensorRatio = 2152;
                static constexpr int Config_FeedbackSensorSource = 2153;
                static constexpr int Config_FeedbackRemoteSensorID = 2154;
                static constexpr int Config_DutyCycleOpenLoopRampPeriod = 2155;
                static constexpr int Config_VoltageOpenLoopRampPeriod = 2156;
                static constexpr int Config_TorqueOpenLoopRampPeriod = 2157;
                static constexpr int Config_DutyCycleClosedLoopRampPeriod = 2158;
                static constexpr int Config_VoltageClosedLoopRampPeriod = 2159;
                static constexpr int Config_TorqueClosedLoopRampPeriod = 2160;
                static constexpr int Config_ForwardLimitType = 2161;
                static constexpr int Config_ForwardLimitAutosetPosEnable = 2162;
                static constexpr int Config_ForwardLimitAutosetPosValue = 2163;
                static constexpr int Config_ForwardLimitEnable = 2164;
                static constexpr int Config_ForwardLimitSource = 2165;
                static constexpr int Config_ForwardLimitRemoteSensorID = 2166;
                static constexpr int Config_ReverseLimitType = 2167;
                static constexpr int Config_ReverseLimitAutosetPosEnable = 2168;
                static constexpr int Config_ReverseLimitAutosetPosValue = 2169;
                static constexpr int Config_ReverseLimitEnable = 2170;
                static constexpr int Config_ReverseLimitSource = 2171;
                static constexpr int Config_ReverseLimitRemoteSensorID = 2172;
                static constexpr int Config_ForwardSoftLimitEnable = 2173;
                static constexpr int Config_ReverseSoftLimitEnable = 2174;
                static constexpr int Config_ForwardSoftLimitThreshold = 2175;
                static constexpr int Config_ReverseSoftLimitThreshold = 2176;
                static constexpr int Config_MotionMagicCruiseVelocity = 2177;
                static constexpr int Config_MotionMagicAcceleration = 2178;
                static constexpr int Config_MotionMagicJerk = 2179;
                static constexpr int Config_MotionMagicExpo_kV = 2180;
                static constexpr int Config_MotionMagicExpo_kA = 2181;
                static constexpr int Config_PeakDiffDC = 2182;
                static constexpr int Config_PeakDiffV = 2183;
                static constexpr int Config_PeakDiffTorqCurr = 2184;
                static constexpr int CANcoder_Velocity = 2185;
                static constexpr int CANcoder_Position = 2186;
                static constexpr int CANcoder_AbsPosition = 2187;
                static constexpr int CANCoder_RawVel = 2189;
                static constexpr int CANCoder_RawPos = 2190;
                static constexpr int CANCoder_SupplyVoltage = 2191;
                static constexpr int CANcoder_MagHealth = 2192;
                static constexpr int SPN_ClearStickyFaults = 2195;
                static constexpr int PRO_MotorOutput_BridgeType_Public = 2196;
                static constexpr int Config_ContinuousWrap = 2218;
                static constexpr int Config_SupplyCurrThres = 2224;
                static constexpr int Config_SupplyTimeThres = 2225;
                static constexpr int Config_DifferentialSensorSource = 2239;
                static constexpr int Config_DifferentialTalonFXSensorID = 2240;
                static constexpr int Config_DifferentialRemoteSensorID = 2241;
                static constexpr int Config_BeepOnConfig = 2280;
                static constexpr int Config_AllowMusicDurDisable = 2281;
                static constexpr int Compliancy_Version = 2282;
                static constexpr int Version_IsProLicensed = 2283;
                static constexpr int PRO_SupplyAndTemp_DeviceTemp2 = 2322;
