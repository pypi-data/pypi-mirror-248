...
if __name__=="__main__":
    data = {'headers': {'authorization': 'Bearer eyJhbGciOiJIUzI1NiJ9..MXJBJQYnVO6hh0D1ov5c22m95hvCBf3Vkgtwt2SC_bY', 'lang': 'en', 'Content-Type': 'application/json'},
            'patternModel': 'INCLUDE_MATCH', 'env': 'https://front-admin-preview.shoplineapp.com', 'sales_id': 402233, 'platform': 'FACEBOOK'}
    response = get_post_comment(data)
    print(response)