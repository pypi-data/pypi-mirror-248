...
class DBClient:
    ...
    def _execute(self, query: LiteralString, params: dict[str, Any], fetchall: bool) -> Any:
    ...
    def get_list(self, query: LiteralString, params: dict[str, Any] | None = None) -> list[Any]:
        """
            Args:
    ...
    def get_dict(self, query: LiteralString, params: dict[str, Any] | None = None) -> dict[Any, Any] | None:
        """
            Args:
                query (str): The SQL query to execute.
                params (dict[str, Any] | None, optional): The parameters to substitute in the query.
    ...
    def select_all(self, query: LiteralString, params: dict[str, Any] | None = None) -> list[tuple]:
        """
            Args:
    ...
    def get_first_value(self, query: LiteralString, params: dict[str, Any] | None = None) -> Any:
        """
            Args:
                query (str): The SQL query to execute.
                params (dict[str, Any] | None, optional): The parameters to substitute in the query.
    ...
    def get_first_row(self, query: LiteralString, params: dict[str, Any] | None = None) -> Any:
        """
            Args:
                query (LiteralString): The SQL query to execute.
                params (dict[str, Any] | None, optional): The parameters to substitute in the query.
    ...
    def execute(self, query: LiteralString, params: dict[str, Any] | None = None) -> None:
        """
            Args:
                query (LiteralString): The SQL query to execute.
                params (dict[str, Any] | None, optional): The parameters to substitute in the query.
