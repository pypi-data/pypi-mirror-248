...
def get_breakout_price(asset: str, day: int = 20) -> tuple[float, float]:
...
class Breakout:
  """This class represents the process of finding the next breakout price.
