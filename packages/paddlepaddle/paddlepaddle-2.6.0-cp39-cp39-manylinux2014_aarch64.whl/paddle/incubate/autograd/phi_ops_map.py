op_map = {
    ...
    "fusion_seqexpand_concat_fc": {
        "phi_name": "fusion_seqexpand_concat_fc",
        "inputs": {
            "x": "X",
            "fc_weight": "FCWeight",
            "fc_bias": "FCBias"
