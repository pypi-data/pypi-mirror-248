...
class KnockPY(object):
    ...
    async def subdomain_center(self):
        """@return List"""
        try:
            ...
            print("[Knockpy subdomain_center ERROR]", e, flush=True)
            return []
    ...
    async def search(self, resolve=False, return_dict=True):
        ...
        print("project subdomain_center")
        subdomains += await self.subdomain_center()
...
class KnockPYSync(KnockPY):
    ...
    def search(self, resolve=False, return_dict=True):
        ...
        print("project subdomain_center")
        subdomains += self.subdomain_center()
