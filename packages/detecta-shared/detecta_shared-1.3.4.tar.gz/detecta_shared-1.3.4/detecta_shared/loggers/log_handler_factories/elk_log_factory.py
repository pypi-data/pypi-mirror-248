...
class ELKLogHandlerFactory(LogHandlerFactory):
    ...
    def __init__(self, elastic_address: str, login: str, password: str,
                 settings: LogHandlerSettings, application_name: str, index_prefix: str, instance_id: str):
    ...
    def create_handler(self):
        ...
        handler = ElasticsearchHandler(es, self.application_name, self._index_prefix, self._instance_id)
