...
class GWCertificate:
    def __init__(self, gw_id, owner_id, tests:list = [],
                 mqtt_mode:Literal['automatic', 'manual' ,'legacy'] = 'automatic', topic_suffix=''):
        # Runtime
        ...
        tests_to_init = TESTS if tests is [] else tests
        # Tests
...
if __name__ == "__main__":
    ...
    gwc = GWCertificate(gw_id='ac233ffb264b',owner_id=WH_OWNERID, mqtt_mode='manual', topic_suffix='-prod',
                        tests=[ConnectionTest, UplinkTest, DownlinkTest])
    gwc.run_tests()
    gwc.create_results_html()

#TODO - Add manual mode to specify gw capabilities
