...
class InferenceSession:
    ...
    def get_chat_template(self, tempelate_name: str = "OLM"):
        if tempelate_name == "Llama2":
            return self.chat_template
        elif tempelate_name == "OpenChat":
            return self.os_chat_template
        else:
            raise ValueError("UnKnown Chat Tempelate requested")
