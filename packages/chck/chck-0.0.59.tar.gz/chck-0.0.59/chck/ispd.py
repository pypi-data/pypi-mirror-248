...
# %% auto 0
__all__ = ['ispdna', 'notpdna', 'isdelegate', 'iscataccessor', 'isdf', 'isidx', 'isseries', 'iscategoricalindex', 'iscatidx',
           'iscidx', 'isboolindex', 'isboolidx', 'isbidx', 'isindexlike', 'isidxlike']
