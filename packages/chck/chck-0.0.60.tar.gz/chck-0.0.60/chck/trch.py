...
# %% auto 0
__all__ = ['isdevice', 'istensor', 'istrc', 'istens', 'istorchtype', 'isdtype', 'isttype', 'istrctype', 'iscpu', 'ismps',
           'iscuda', 'iscputensor', 'ismpstensor', 'isdataset', 'isds', 'isdataloader', 'isdl', 'isdatamodule', 'isdm',
           'isdfds', 'isdfdataset', 'isdataframedataset']
...
# %% ../nbs/63_trch.ipynb 5
from .atyp import (dtype, device, Tensor, pttype, ptdevice, pttensor)
from .atyp import (Dataset, DataLoader, ptdataset, ptdataloader)
from .atyp import (pldatamodule, DataModule)
