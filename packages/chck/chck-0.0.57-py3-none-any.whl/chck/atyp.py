...
__all__ = ['G', 'P', 'TypeLike', 'TypeDesc', 'GuardFunc', 'PathLike', 'sbytes', 'notsbytes', 'pdbindex', 'pdindexlike', 'npbool',
           'npnan', 'npNaN', 'npNAN', 'npmatrix', 'npndarray', 'pdna', 'pdindex', 'pdseries', 'pdcindex', 'dataframe',
           'pddelegate', 'sparr', 'spmtx', 'pttype', 'ptdevice', 'pttensor', 'ptdataset', 'ptdataloader',
           'pldatamodule', 'cvvideo', 'anndata']
...
except ImportError: PandasDelegate = object, list, list, list
...
try: from torch import dtype, device, Tensor
except ImportError: dtype, device, Tensor = type, str, list
