...
from searchbibleai.utils.prompt_shared_key_bindings import prompt_shared_key_bindings
...
from searchbibleai import config
...
class HealthCheck:
    ...
    def getFiles():
        apps = {
            ...
            "searchbibleai": ("SearchBibleAI", "SearchBibleAI"),
        }
