...
A simple sample as following:
    ...
    import make_color
    from make_color import Color

    make_color.set_color(Color.GOLD, Color.BLUE)
    print('Hello, make_color!')
    color = make_color.make_color(4, 3, 1) # get a bronze color
    make_color.set_fcolor(color)
    ...
    make_color.reset_color()
