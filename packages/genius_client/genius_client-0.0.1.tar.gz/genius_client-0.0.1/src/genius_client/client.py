...
_PaginatedMethodType = t.Literal["artist_songs", "referents"]
...
class GeniusClient(requests.Session):
    ...
    def __init__(self, access_token: str | None = None, per_page: int = 10):
        ...
        self.access_token = access_token or os.environ["GENIUS_ACCESS_TOKEN"]
    ...
    def genius_get(self, url, params: dict) -> dict:
        return self.genius_request("GET", url=url, params=params, allow_redirects=True)
    ...
    def referents(self, song_id: str = "", web_page_id: str = "", **kwargs) -> tuple[str | None, list[m.Referent]]:
        ...
        response = self.paginated_get("/referents", **kwargs)
    ...
    def paginator(self, method: _PaginatedMethodType, **kwargs) -> t.Iterable[dict]:
