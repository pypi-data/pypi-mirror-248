...
DATABASE_MYSQL_PYTHON_GENERIC_CRUD_COMPONENT_NAME = 'circles_local_database_python\\generic_mapping'
...
class GenericMapping(GenericCRUD):
    ...
    def __init__(self, default_schema_name: str = None, default_table_name: str = None, default_view_table_name: str = None,
                 default_id_column_name: str = None, default_entity_name1: str = None, default_entity_name2: str = None,):
