...
import os
import sys
from oreiller import __version__
...
setup(
    ...
    description="The package for easy and convenient image manipulation, heavy use of Pillow",  # Optional
    ...
    url="https://github.com/Abdur-RahmaanJ/oreiller",  # Optional
    ...
    keywords="image pillow",  # Optional
