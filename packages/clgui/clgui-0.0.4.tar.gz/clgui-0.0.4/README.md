...
# Methods
button1 = clgui.Button("Hello", lambda: print("Hello")) # Create a new button with an event handler when enter is pressed on it
button2 = clgui.Button("World", lambda: print("World")) # Create a new button with an event handler when enter is pressed on it
