...
class Query(Module):
    ...
    @deprecation.deprecated(deprecated_in="0.0.1", details="Use Query.base instead")
    ...
    @deprecation.deprecated(deprecated_in="0.0.1", current_version=importlib.metadata.version("tql"), details="Use Query.project instead")
