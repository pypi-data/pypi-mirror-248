...
def scream():
    mixer.init()
    tom_scream = mixer.Sound(r"D:\Apps\tom_scream.mp3")
    tom_scream.play()

    count = 0
    while mixer.get_busy() and count < 2800:
        time.delay(1)
        count += 1
...
if __name__ == "__main__":
    pam = AlphaApp(
        ...
        app="python module",
        execute=False,
        root=r"C:\Users\ideapad\AppData\Local\Programs\Python\Python312\Lib\site-packages\pam.py",
    )
