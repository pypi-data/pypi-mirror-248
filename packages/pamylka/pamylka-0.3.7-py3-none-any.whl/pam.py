...
class AlphaApp(App):
    def __init__(
        ...
        super().__init__(name, version, type, date, creator, app, extension)
        self.Application = {
...
class BaseApp(AlphaApp):
    ...
    def __init__(
        ...
        super().__init__(
            name, version, type, date, creator, extension=extension, app="Base App"
        )
        """
        Parameters
        -
...
class HeroApp(AlphaApp):
    ...
    def __init__(
        ...
        super().__init__(
            name, version, type, date, creator, extension=extension, app="Hero App"
        )
        """
        Parameters
        -
...
class InApp(App):
    ...
    def __init__(
        ...
        super().__init__(
            name, ver, type, date, creator, extension=extension, app="Inside App"
        )
        """
        Parameters
        -
...
if __name__ == "__main__":
    pam = AlphaApp(
        "pam", "00.03.05", "Programming", "13/3/1445 Higri", app="python module"
    )
    print(pam)
