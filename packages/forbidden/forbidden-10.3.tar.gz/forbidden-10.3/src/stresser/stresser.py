...
default_user_agent = "Stresser/10.3"
...
class MyArgParser(argparse.ArgumentParser):
	def print_help(self):
		print("Stresser v10.3 ( github.com/ivan-sincek/forbidden )")
		print("")
...
class Validate:
	...
	def __init__(self):
		...
		self.__parser.add_argument("-r"   , "--repeat"                          , required = False, type   = str         )
		...
		self.__parser.add_argument("-dir" , "--directory"                       , required = False, type   = str         )
