...
def prv_pool_report(date,style_date):
    ...
    for i in range(len(main_df)):
        ...
        for temp_date in date_pick['rqnp'].tolist():
            date_pick.loc[date_pick['rqnp']==temp_date,'ret']=customer_ret_data.loc[int(util._shift_date(temp_date))]['客户加权平均收益率']+1
    ...
    customer_ret_summary.columns=['近一月客户收益率','近三月客户收益率','近六月客户收益率']
    ...
    for col in ['近一月客户收益率','近三月客户收益率','近六月客户收益率']:
        customer_ret_summary[col]=customer_ret_summary[col].map("{:.2%}".format)
        customer_ret_summary.loc[customer_ret_summary[col] == 'nan%', col] = np.nan
...
if __name__ == '__main__':
    ...
    # mutual_fund_industry_exp().get_the_industry_exp('20231128','20200601','20230630')
    ...
    # prv_pool_report('20231117','20230930')
