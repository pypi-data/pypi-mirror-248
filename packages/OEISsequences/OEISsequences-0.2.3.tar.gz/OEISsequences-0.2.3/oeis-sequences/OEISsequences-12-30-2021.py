...
where a(offset) is the first term returned by the generator, this value of offset is the same as the offset keyword in the OEIS database.
...
from sympy import factorint, divisors, integer_nthroot, divisor_sigma, nextprime, Matrix, divisor_count, \
                  ...
                  sqrt, bernoulli, ff, sin, cos, tan, fibonacci, lucas, pi, hyperexpand
...
from gmpy2 import mpz, fac, popcount, is_prime, is_square, next_prime, c_divmod, lucas2, fib2, \
                  isqrt_rem, digits as gmpy2digits
