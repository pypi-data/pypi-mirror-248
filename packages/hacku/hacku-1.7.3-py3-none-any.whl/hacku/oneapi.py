...
class OneAPI:
    ...
    def get_tokens(self):
        ...
        for d in response['data']:
            print(f"名称：{d['name']}, key：{d['key']}, 过期时间：{d['expired_time']}, 余额：{d['remain_quota']}, 是否无限余额：{d['unlimited_quota']}")
    ...
    def get_channel(self):
        ...
        print(response)
        for d in response['data']:
            print(f"名称：{d['name']}, key：{d['key']}, URL：{d['base_url']}, 余额：{d['remain_quota']}, 是否无限余额：{d['unlimited_quota']}")
