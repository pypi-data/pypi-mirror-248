...
def run(command, expressions, dry_run, case_insensitive, include_hidden, import_, silent, sort_alg_name, stop_at_error):
    ...
    globs_expanded = [sort_alg(glob2.glob(g, include_hidden=include_hidden, case_sensitive=(not case_insensitive))) for g in globs]
