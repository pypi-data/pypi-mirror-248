...
# from edsseCore.runtime import platform
from seCore.util import FancyEqMixin
from seCore.win32 import (
    ERROR_DIRECTORY,
...
islink = getattr(os.path, "islink", False)
    ...
    def children(self):
        ...
        try:
            ...
            if getattr(ose, "winerror", None) in (
                ...
                raise UnlistableError(ose)  # pragma: NotTested
...
class FilePath(AbstractFilePath):
    ...
    def __getstate__(self):
        ...
        if "_statinfo" in d:
            del d["_statinfo"]  # pragma: NotTested
        return d
    ...
    def preauthChild(self, path):
        ...
        if not newpath.startswith(ourPath):
            raise InsecurePath(f"{newpath} is not a child of {ourPath}")  # pragma: NotTested
        return self.clonePath(newpath)
    ...
    def getModificationTime(self, isNone=False):
        """
        Retrieve the time of last access from this file.
    ...
    def getStatusChangeTime(self, isNone=False):
        """
        Retrieve the time of the last status change for this file.
    ...
    def getInodeNumber(self, isNone=False):
        """
    ...
    def isBlockDevice(self, isNone=False):
        """
    ...
    def isSocket(self, isNone=False):
        """
    ...
    def touch(self):
        ...
        try:
            self.open("a").close()
        except OSError:  # pragma: NotTested
            pass
    ...
    def __cmp__(self, other):
        if not isinstance(other, FilePath):
            return NotImplemented  # pragma: NotImplemented
    ...
    def create(self) -> IO[bytes]:
        ...
        # xToDo: 'name' attribute of returned files is not mutable or
    ...
    def copyTo(self, destination, followLinks=True):
        ...
        if self.islink() and not followLinks:
            ...
            return
        # xToDo: *thorough* audit and documentation of the exact desired
        ...
        if self.isdir():
            ...
            with destination.open("w") as writefile, self.open() as readfile:
                while 1:
                    # xToDo: optionally use os.open, os.read and
            ...
            raise NotImplementedError("Only copying of files and directories supported")  # pragma: NotImplemented
    ...
    def moveTo(self, destination, followLinks=True):
        ...
        try:
            ...
            if ose.errno == errno.EXDEV:  # pragma: no cover
