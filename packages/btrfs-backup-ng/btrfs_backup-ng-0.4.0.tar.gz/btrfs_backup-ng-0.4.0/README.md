...
been transferred to me(Robert Schindler). Many thanks to Chris for his work. The old code
...
Alternatively, clone this git repository
    ...
    $ cd btrfs-backup-ng
    $ git checkout tags/v0.4.0  # optionally checkout a specific version
...
were specified at the command line. You might do something like:
    ...
    $ btrfs-backup-ng --no-snapshot --locked-dests /home
