...
def debug_logger_execute(func):
    ...
    def wrapper(self, *args, **kwargs):
        ...
        DebugLogger.log_function_call(function_name=self.function_name, app_name=self.app_name, log_entry={"status": StradaResponseStatus.SUCCESS.name, "input": kwargs, "output": json_response})
