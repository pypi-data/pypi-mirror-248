...
class SendPromptRequestPayload(BaseModel):
    ...
    instructions: Optional[str] = Field(..., title="Instructions")
    use_json: Optional[bool] = Field(..., title="Use JSON")
...
class OpenAISendPromptAction:
    ...
    def execute(self, **kwargs):
        ...
        try:
            payload = SendPromptRequestPayload(**raw_payload)
        except ValidationError as e:
            raise StradaValidationException(str(e), schema=SendPromptRequestPayload.schema(), data=payload)
        ...
        if payload.use_json:
            ...
            messages.append({"role": "system", "content": "JSON response format selected."})
