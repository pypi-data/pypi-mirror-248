...
def list_session(req: ListSessionRequest):
    assistant_session = data_access.get_or_create_session(get_user(), ChatRole.assistant)
    notification_session = data_access.get_or_create_session(get_user(), ChatRole.notification_center)
