...
if os.name == 'nt':
    # Environment configuration under WINDWOS requires calling .dll file
...
class Sdpc:
    ...
    def crop_patches(self, tile_size, overlap_size, patch_level, save_dir, blank_TH=0.5, is_mark=True,
