...
class Module(ClientBase):
    ...
    def delete_schema(self, name: str) -> Dict:
        ...
        """
        return self.query(f"/modules/{name}/schema", method="delete")
    ...
    def get(self, name: str) -> Dict:
        ...
        """
        return self.query(f"/modules/{name}")
    ...
    def get_schema(self, name: str) -> Dict:
        ...
        :param name: Name of module to retrieve.
        """
        return self.query(f"/modules/{name}/schema")
    ...
    def refresh(self) -> Dict:
        ...
        """
        return self.query("/modules/refresh", method="post")
