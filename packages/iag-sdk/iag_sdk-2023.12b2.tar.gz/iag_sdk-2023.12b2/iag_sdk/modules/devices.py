...
class Device(ClientBase):
    ...
    def add(self, config_object: Dict) -> Dict:
        ...
        """
        return self.query(f"/devices", method="post", jsonbody=config_object)
    ...
    def delete(self, name: str) -> Dict:
        ...
        """
        return self.query(f"/devices/{name}", method="delete")
    ...
    def get(self, name: str) -> Dict:
        ...
        """
        return self.query(f"/devices/{name}")
    ...
    def get_state(self, name: str) -> Dict:
        ...
        :param name: Name of device.
        """
        return self.query(f"/devices/{name}/state")
    ...
    def get_variable(self, name: str, variable_name: str) -> Dict:
        ...
        """
        return self.query(f"/devices/{name}/variables/{variable_name}")
    ...
    def get_variables(self, name: str) -> Dict:
        ...
        :param name: Name of device.
        """
        return self.query(f"/devices/{name}/variables")

    def get_all(
        self, offset: int = 0, limit: int = 100, filter: str = None
    ) -> Dict:
        """
    ...
    def update(
        self, name: str, config_object: Dict, method: str = "put"
    ) -> Dict:
        """
        ...
        """
        return self.query(f"/devices/{name}", method=method, jsonbody=config_object)
