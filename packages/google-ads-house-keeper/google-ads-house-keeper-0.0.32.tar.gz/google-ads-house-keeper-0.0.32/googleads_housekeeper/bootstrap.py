...
class LocalBootstrapper(Bootstrapper):
    ...
    def __init__(self) -> None:
        ...
        self.publish_service = publisher.LogPublisher()
...
def bootstrap(
    ads_api_client: GoogleAdsApiClient = get_default_google_ads_api_client(),
    start_orm: bool = True,
