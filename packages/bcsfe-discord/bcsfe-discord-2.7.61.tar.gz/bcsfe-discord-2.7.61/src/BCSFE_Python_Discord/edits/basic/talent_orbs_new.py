...
"""
        ...
        orb_input_selection = (
            str(orbs).lower().replace("angle", "angel").split(",")
        )
...
def edit_talent_orbs(save_stats: dict[str, Any], orbs: str, count: str) -> dict[str, Any]:
