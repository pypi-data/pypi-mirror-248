...
def stage_handler(
    stage_data: dict[str, Any], star: str, ids: list[int], offset: int, unlock_next: bool = True
) -> dict[str, Any]:
...
def stories_of_legend(save_stats: dict[str, Any], stage_id: str, star: str) -> dict[str, Any]:
    ...
    offset = -1
    save_stats["event_stages"] = stage_handler(stage_data, star, ids, offset)
