...
def set_c_ids(save_stats: dict[str, Any], catids) -> dict[str, Any]:
...
def get_character_drops(save_stats: dict[str, Any], catids) -> dict[str, Any]:
    ...
    if flag_t_ids:
        ...
        save_stats = set_c_ids(save_stats, catids)
