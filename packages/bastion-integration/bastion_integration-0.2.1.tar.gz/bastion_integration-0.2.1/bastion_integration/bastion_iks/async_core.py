...
from garbige.dto.pass_dto import PassInDto
from garbige.dto.person_dto import BastionV2PersonDto
from garbige.dto.time_dto import TimeIntervalDto


# Возникали ошибки при работе с бастионом 2 версии на асинхронных запросах и с другими библиотеками.
# Для унификации обоих версий был создан асинхронный класс.
class CoreIKSAsync:

    def __init__(self, config: BastionConfigDto):
        self.config = config
        self.core = CoreV2(self.config)
    ...
    async def _check_connection(self, only_ping: bool = True, **kwargs):
        return self.core.check_connection(only_ping=only_ping, kwargs=kwargs)
    ...
    async def create_person(self, dto: PersonDto.Create):
        ...
        person_info = BastionV2PersonDto(name=dto.last_name,
