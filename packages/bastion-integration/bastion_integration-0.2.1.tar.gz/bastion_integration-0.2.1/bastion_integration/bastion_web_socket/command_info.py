...
from bastion_integration.bastion_web_socket.bastion_web_socket_dto import PassDto, HandShakeDto
...
class WebSocketCommand:
    ...
    def handshake(self, dto: HandShakeDto):
        handshake_info = {
        ...
        handshake_info.update(dto.model_dump())
        return {"request_name": RequestName.HANDSHAKE.name,
                "$type": REQUEST_COMMAND,
                "request": handshake_info}
