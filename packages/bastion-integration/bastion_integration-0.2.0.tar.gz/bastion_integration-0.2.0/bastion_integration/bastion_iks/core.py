...
from bastion_integration.bastion_iks.bastion_iks_dto import BastionV2Config
from garbige.dto.attendance_dto import Attendance, OutAttendance
from garbige.dto.card_dto import OutCardEvents, GetCardEvents
from garbige.dto.department_dto import DepartmentOutDto, DepartmentInDto
from garbige.dto.device_dto import DeviceDto, DeviceOutDto
from garbige.dto.dict_dto import DictValues
from garbige.dto.organization_dto import OrganizationInDto
from garbige.dto.pass_dto import PassOutDto, GetPassInDto, PassInDto, PassDto
from garbige.dto.points_dto import EntryPoint, AccessLevel, ControlArea, AccessPoint
from garbige.handlers import BastionIntegrationError, _handle_response
...
class CoreV2:
    ...
    def __init__(self, config: BastionV2Config):
    ...
    def check_connection(self):
        return self._send_request("GET", "CheckConnection")
    ...
    # =============================================================================================
    def get_departments(self, department_name: str = None) -> List[DepartmentOutDto]:
        params = None
        departments_info = []
    ...
    def create_person(self, dto: PassInDto, use_access_levels: bool):
        ...
        logger.debug(f'create_pass: {dto.model_dump(exclude_none=True, exclude_defaults=True)}')
        response = _handle_response(self._send_request("PUT", "PutPass",
                                                       params={
                                                           "useAccessLevelsInsteadOfEntryPoints": use_access_levels},
                                                       dto=dto.model_dump(exclude_none=True, exclude_defaults=True)))
        logger.info(f'create_pass: {response}')
        return response
