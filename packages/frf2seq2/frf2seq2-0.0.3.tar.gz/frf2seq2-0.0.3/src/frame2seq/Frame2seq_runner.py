...
class Frame2seqRunner():
    ...
    """
    def __init__(self, model_ckpts=["frame2seq/trained_models/model1.ckpt", "trained_models/model2.ckpt", "trained_models/model3.ckpt"], num_models=3):
        ...
        for ckpt_file in model_ckpts:
            ...
            self.models.append(
                frame2seq.load_from_checkpoint(ckpt_file).eval().to(self.device))
