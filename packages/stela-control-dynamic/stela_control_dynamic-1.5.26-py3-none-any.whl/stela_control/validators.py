...
from .models import (
    ...
    Booking, BookingServices, City, Team, JobApplication, Biography, PhotoGallery
...
from .forms import (
    ...
    PwdResetConfirmForm, ValuesForm, LoginForm, JobApplicationForm, BiographyForm, PhotoGalleryForm
)
form_mapping = {
    ...
    if request.method == 'POST':
        ...
        if action == "checkBio": 
            ...
            if pk:   
                ...
                get_formset = inlineformset_factory(
                    Biography, PhotoGallery, 
                    form=PhotoGalleryForm,
                    extra=0, can_delete=True,
                )
                formset=get_formset(instance=biography, prefix='formset')
                obj_data = render_to_string('stela_control/load-data/site_docs/forms/bio_form.html', { 
                    'form': form,
                    'formset':formset,   
                    'pk': pk
                })
