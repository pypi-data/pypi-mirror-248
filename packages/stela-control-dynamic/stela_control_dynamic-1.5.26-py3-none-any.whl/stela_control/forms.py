...
from .models import (
        ...
        JobApplication, Biography, PhotoGallery
)
import re
...
class BiographyForm(forms.ModelForm):
    class Meta:
        model = Biography
        fields = ['name', 'date_of_birth', 'place_of_birth', 'nationality', 'profession', 'biography']
        widgets = {
...
class PhotoGalleryForm(forms.ModelForm):
    ...
    def clean_image(self):
        ...
        # Aquí puedes añadir cualquier validación personalizada para la imagen.
        # Por ejemplo, validar el tamaño del archivo o el tipo de archivo.
        return image
