...
class PolygonOptions:
    ...
    async def filter_options_advanced(self, select_columns:str=None, ticker:str=None, strike:float=None, strike_min:float=None, strike_max:float=None, expiry:str=None, expiry_min:str=None, expiry_max:str=None, dte:int=None, dte_min:int=None, dte_max:int=None, 
                            time_value:float=None, time_value_min:float=None, time_value_max:float=None, moneyness:str=None, liquidity_score:float=None, liquidity_score_min:float=None, liquidity_score_max:float=None, cp:str=None, exercise_style:str=None, 
                            option_symbol:str=None, theta:float=None, theta_min:float=None, theta_max:float=None, theta_decay_rate:float=None, theta_decay_rate_min:float=None, theta_decay_rate_max:float=None, delta:float=None, delta_min:float=None, delta_max:float=None, 
                            delta_theta_ratio:float=None, delta_theta_ratio_min:float=None, delta_theta_ratio_max:float=None, gamma:float=None, gamma_min:float=None, gamma_max:float=None, gamma_risk:float=None, gamma_risk_min:float=None, gamma_risk_max:float=None, 
                            vega:float=None, vega_min:float=None, vega_max:float=None, vega_impact:float=None, vega_impact_min:float=None, vega_impact_max:float=None, timestamp:float=None, timestamp_min:float=None, timestamp_max:float=None, 
                            oi:float=None, oi_min:float=None, oi_max:float=None, open:float=None, open_min:float=None, open_max:float=None, high:float=None, high_min:float=None, high_max:float=None, low:float=None, low_min:float=None, low_max:float=None, 
                            close:float=None, close_min:float=None, close_max:float=None, intrinsic_value:float=None, intrinsic_value_min:float=None, intrinsic_value_max:float=None, extrinsic_value:float=None, extrinsic_value_min:float=None, extrinsic_value_max:float=None, 
                            leverage_ratio:float=None, leverage_ratio_min:float=None, leverage_ratio_max:float=None, vwap:float=None, vwap_min:float=None, vwap_max:float=None, conditions:float=None, conditions_min:float=None, conditions_max:float=None, 
                            price:float=None, price_min:float=None, price_max:float=None, trade_size:float=None, trade_size_min:float=None, trade_size_max:float=None, exchange:str=None, ask:float=None, ask_min:float=None, ask_max:float=None, 
                            bid:float=None, bid_min:float=None, bid_max:float=None, spread:float=None, spread_min:float=None, spread_max:float=None, spread_pct:float=None, spread_pct_min:float=None, spread_pct_max:float=None, iv:float=None, iv_min:float=None, iv_max:float=None, 
                            bid_size:float=None, bid_size_min:float=None, bid_size_max:float=None, ask_size:float=None, ask_size_min:float=None, ask_size_max:float=None, vol:float=None, vol_min:float=None, vol_max:float=None, mid:float=None, mid_min:float=None, mid_max:float=None, 
                            change_to_breakeven:float=None, change_to_breakeven_min:float=None, change_to_breakeven_max:float=None, underlying_price:float=None, underlying_price_min:float=None, underlying_price_max:float=None, return_on_risk:float=None, return_on_risk_min:float=None, 
                            return_on_risk_max:float=None, velocity:float=None, velocity_min:float=None, velocity_max:float=None, sensitivity:float=None, sensitivity_min:float=None, sensitivity_max:float=None, greeks_balance:float=None, greeks_balance_min:float=None, 
                            greeks_balance_max:float=None, opp:float=None, opp_min:float=None, opp_max:float=None):
        """
        Filters the options table based on provided arguments.
        Usage example:
            await filter_options(ticker='AAPL', strike_min=100, strike_max=200, cp='call', expiry='2023-01-01', delta_min=0.1, delta_max=0.5)
        """

        # Start with the base query
        query = f"SELECT {select_columns if select_columns else '*'} FROM poly_options WHERE "
        params = []
        param_index = 1

        # Construct query based on provided arguments

        # Example: Adding condition for 'ticker'
        if ticker:
            query += f"ticker = {ticker} AND "
            params.append(ticker)

        if strike is not None:
            query += f"strike = {strike} AND "
            params.append(strike)
        if strike_min is not None:
            query += f"strike >= {strike_min} AND "
            params.append(strike_min)
        if strike_max is not None:
            query += f"strike <= {strike_max} AND "
            params.append(strike_max)
        if expiry:
            query += f"expiry = {expiry} AND "
            params.append(expiry)
        if expiry_min:
            query += f"expiry >= {expiry_min} AND "
            params.append(expiry_min)
        if expiry_max:
            query += f"expiry <= {expiry_max} AND "
            params.append(expiry_max)
        if dte is not None:
            query += f"dte = {dte} AND "
            params.append(dte)
        if dte_min is not None:
            query += f"dte >= {dte_min} AND "
            params.append(dte_min)
        if dte_max is not None:
            query += f"dte <= {dte_max} AND "
            params.append(dte_max)
        if time_value is not None:
            query += f"time_value = {time_value} AND "
            params.append(time_value)
        if time_value_min is not None:
            query += f"time_value >= {time_value_min} AND "
            params.append(time_value_min)
        if time_value_max is not None:
            query += f"time_value <= {time_value_max} AND "
            params.append(time_value_max)
        if moneyness:
            query += f"moneyness = {moneyness} AND "
            params.append(moneyness)
        if liquidity_score is not None:
            query += f"liquidity_score = {liquidity_score} AND "
            params.append(liquidity_score)
        if liquidity_score_min is not None:
            query += f"liquidity_score >= {liquidity_score_min} AND "
            params.append(liquidity_score_min)
        if liquidity_score_max is not None:
            query += f"liquidity_score <= {liquidity_score_max} AND "
            params.append(liquidity_score_max)
        if cp:
            query += f"cp = {cp} AND "
            params.append(cp)
        if exercise_style:
            query += f"exercise_style = {exercise_style} AND "
            params.append(exercise_style)
        if option_symbol:
            query += f"option_symbol = {option_symbol} AND "
            params.append(option_symbol)
        if theta is not None:
            query += f"theta = {theta} AND "
            params.append(theta)
        if theta_min is not None:
            query += f"theta >= {theta_min} AND "
            params.append(theta_min)
        if theta_max is not None:
            query += f"theta <= {theta_max} AND "
            params.append(theta_max)
        # Continuing with the rest of the parameters
        if theta_decay_rate is not None:
            query += f"theta_decay_rate = {theta_decay_rate} AND "
            params.append(theta_decay_rate)
        if theta_decay_rate_min is not None:
            query += f"theta_decay_rate >= {theta_decay_rate_min} AND "
            params.append(theta_decay_rate_min)
        if theta_decay_rate_max is not None:
            query += f"theta_decay_rate <= {theta_decay_rate_max} AND "
            params.append(theta_decay_rate_max)
        if delta is not None:
            query += f"delta = {delta} AND "
            params.append(delta)
        if delta_min is not None:
            query += f"delta >= {delta_min} AND "
            params.append(delta_min)
        if delta_max is not None:
            query += f"delta <= {delta_max} AND "
            params.append(delta_max)

        if gamma is not None:
            query += f"gamma = {gamma} AND "
            params.append(gamma)

        if gamma_max is not None:
            query += f"gamma = {gamma_max} AND "
            params.append(gamma_max)

        if gamma_min is not None:
            query += f"gamma = {gamma_min} AND "
            params.append(gamma_min)

        if vega is not None:
            query += f"gamma = {vega} AND "
            params.append(vega)

        if vega_min is not None:
            query += f"gamma = {vega_min} AND "
            params.append(vega_min)


        if vega_max is not None:
            query += f"gamma = {vega_max} AND "
        ...
        # Assuming async database operation
    ...
    async def filter_options(self,select_columns:str=None, **kwargs):
        ...
        """
        # Start with the base query
        query = f"SELECT ticker, strike, cp, expiry FROM poly_options WHERE "
        params = []
        param_index = 1
        ...
        column_types = {
            ...
            'timestamp_min': ('timestamp', 'float'),
            'timestamp_max': ('timestamp', 'float'),
            ...
            'vwap_min': ('vwap', 'float'),
            'vwap_max': ('vwap', 'float'),
            'conditions_min': ('conditions', 'float'),
            'conditions_max': ('conditions', 'float'),
        ...
        query = f"SELECT ticker, strike, cp, expiry FROM poly_options WHERE oi > 0" if select_columns is None else f"SELECT ticker, strike, cp, expiry, {select_columns} FROM poly_options WHERE oi > 0"
