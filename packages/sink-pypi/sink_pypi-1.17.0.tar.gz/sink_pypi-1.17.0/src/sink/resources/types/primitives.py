...
class Primitives(SyncAPIResource):
    with_raw_response: PrimitivesWithRawResponse

    def __init__(self, client: Sink) -> None:
        super().__init__(client)
        self.with_raw_response = PrimitivesWithRawResponse(self)
...
class AsyncPrimitives(AsyncAPIResource):
    with_raw_response: AsyncPrimitivesWithRawResponse

    def __init__(self, client: AsyncSink) -> None:
        super().__init__(client)
        self.with_raw_response = AsyncPrimitivesWithRawResponse(self)
