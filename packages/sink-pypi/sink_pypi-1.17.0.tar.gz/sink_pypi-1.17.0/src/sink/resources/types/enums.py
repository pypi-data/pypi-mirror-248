...
__all__ = ["Enums", "AsyncEnums"]


class Enums(SyncAPIResource):
    with_raw_response: EnumsWithRawResponse

    def __init__(self, client: Sink) -> None:
        super().__init__(client)
        self.with_raw_response = EnumsWithRawResponse(self)
...
class AsyncEnums(AsyncAPIResource):
    with_raw_response: AsyncEnumsWithRawResponse

    def __init__(self, client: AsyncSink) -> None:
        super().__init__(client)
        self.with_raw_response = AsyncEnumsWithRawResponse(self)
...
class EnumsWithRawResponse:
    def __init__(self, enums: Enums) -> None:
...
class AsyncEnumsWithRawResponse:
    def __init__(self, enums: AsyncEnums) -> None:
