...
__all__ = ["TopLevelArrays", "AsyncTopLevelArrays"]


class TopLevelArrays(SyncAPIResource):
    with_raw_response: TopLevelArraysWithRawResponse

    def __init__(self, client: Sink) -> None:
        super().__init__(client)
        self.with_raw_response = TopLevelArraysWithRawResponse(self)
...
class AsyncTopLevelArrays(AsyncAPIResource):
    with_raw_response: AsyncTopLevelArraysWithRawResponse

    def __init__(self, client: AsyncSink) -> None:
        super().__init__(client)
        self.with_raw_response = AsyncTopLevelArraysWithRawResponse(self)
...
class TopLevelArraysWithRawResponse:
    def __init__(self, top_level_arrays: TopLevelArrays) -> None:
        self.basic_cursor = to_raw_response_wrapper(
            top_level_arrays.basic_cursor,
        )


class AsyncTopLevelArraysWithRawResponse:
    def __init__(self, top_level_arrays: AsyncTopLevelArrays) -> None:
