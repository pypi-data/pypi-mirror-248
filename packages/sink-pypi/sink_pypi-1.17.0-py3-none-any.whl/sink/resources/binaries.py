...
class Binaries(SyncAPIResource):
    with_raw_response: BinariesWithRawResponse

    def __init__(self, client: Sink) -> None:
        super().__init__(client)
        self.with_raw_response = BinariesWithRawResponse(self)
...
class AsyncBinaries(AsyncAPIResource):
    with_raw_response: AsyncBinariesWithRawResponse

    def __init__(self, client: AsyncSink) -> None:
        super().__init__(client)
        self.with_raw_response = AsyncBinariesWithRawResponse(self)
