...
class ResponseHeaders(SyncAPIResource):
    with_raw_response: ResponseHeadersWithRawResponse

    def __init__(self, client: Sink) -> None:
        super().__init__(client)
        self.with_raw_response = ResponseHeadersWithRawResponse(self)
...
class AsyncResponseHeaders(AsyncAPIResource):
    with_raw_response: AsyncResponseHeadersWithRawResponse

    def __init__(self, client: AsyncSink) -> None:
        super().__init__(client)
        self.with_raw_response = AsyncResponseHeadersWithRawResponse(self)
