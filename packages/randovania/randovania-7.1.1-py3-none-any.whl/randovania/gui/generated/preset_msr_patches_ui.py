...
class Ui_PresetMSRPatches(object):
    ...
    def retranslateUi(self, PresetMSRPatches):
        ...
        self.charge_door_buff_label.setText(QCoreApplication.translate("PresetMSRPatches", u"Makes Charge Doors invulnerable against Power Bombs", None))
        self.beam_door_buff_check.setText(QCoreApplication.translate("PresetMSRPatches", u"Buff Beam Doors", None))
        self.beam_door_buff_label.setText(QCoreApplication.translate("PresetMSRPatches", u"Makes Beam Doors invulnerable against Power Bombs", None))
