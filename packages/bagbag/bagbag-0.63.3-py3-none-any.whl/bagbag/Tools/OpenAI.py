...
class ChatGPT():
    def __init__(self, key:str=None, model:float=3.5, baseURL:str=None) -> None:
        self.key = str(key)
        ...
        self.client = openai.OpenAI(api_key=self.key, base_url=baseURL)
