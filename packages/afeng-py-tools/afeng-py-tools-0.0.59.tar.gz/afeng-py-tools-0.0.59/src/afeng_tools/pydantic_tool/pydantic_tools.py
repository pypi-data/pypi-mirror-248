...
def _get_model_properties(orm_model_class: Type[Model], add_flag: bool = False) \
...
def create_model_by_po(orm_model_class: Type[Model], add_flag: bool = False) -> type[BaseModel]:
