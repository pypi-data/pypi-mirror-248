...
conditions = {"cn_congruent":    (red,      red,     color_naming),
              "cn_incongruent":  (red,      green,   color_naming),
              "cn_neutral":      (green,  neutral,   color_naming),
              "wr_congruent":    (red,      red,     word_reading),
              "wr_incongruent":  (red,      green,   word_reading),
              "wr_neutral":      (neutral,   red,     word_reading)
              }