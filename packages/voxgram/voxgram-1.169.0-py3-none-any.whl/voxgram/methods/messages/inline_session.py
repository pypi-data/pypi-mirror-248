...
from voxgram.errors import AuthBytesInvalid
from voxgram.session import Session
from voxgram.session.auth import Auth


async def get_session(client: "voxgram.Client", dc_id: int):
