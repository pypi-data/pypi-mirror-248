...
import voxgram
from voxgram import enums
from voxgram import raw
from voxgram import utils
from voxgram.crypto import aes
from voxgram.errors import CDNFileHashMismatch
from voxgram.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from voxgram.handlers.handler import Handler
from voxgram.methods import Methods
from voxgram.session import Auth, Session
from voxgram.storage import FileStorage, MemoryStorage, Storage
from voxgram.storage import MongoStorage
from voxgram.types import User, TermsOfService
from voxgram.utils import ainput
...
class Client(Methods):
    ...
    def __init__(
        ...
        self.listeners = {listener_type: [] for listener_type in voxgram.enums.ListenerTypes}
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except voxgram.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
