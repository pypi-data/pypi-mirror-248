...
from voxgram.utils import PyromodConfig
from voxgram.types import CallbackQuery, Identifier, Listener
...
class CallbackQueryHandler(Handler):
    ...
    async def check_if_has_matching_listener(self, client: "voxgram.Client", query: CallbackQuery) -> Tuple[bool, Listener]:
        data = self.compose_data_identifier(query)
        listener = client.get_listener_matching_with_data(data, voxgram.enums.ListenerTypes.CALLBACK_QUERY)
    ...
    async def check(self, client: "voxgram.Client", query: CallbackQuery):
    ...
    async def resolve_future_or_callback(self, client: "voxgram.Client", query: CallbackQuery, *args):
        listener_does_match, listener = await self.check_if_has_matching_listener(client, query)
