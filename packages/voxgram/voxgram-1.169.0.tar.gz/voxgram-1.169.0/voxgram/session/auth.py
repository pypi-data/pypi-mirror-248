...
from voxgram.connection import Connection
from voxgram.crypto import aes, rsa, prime
from voxgram.errors import SecurityCheckMismatch
from voxgram.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "voxgram.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
