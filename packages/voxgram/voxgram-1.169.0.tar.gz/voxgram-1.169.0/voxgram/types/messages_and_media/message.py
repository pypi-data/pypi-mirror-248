...
import voxgram
from voxgram import raw, enums
from voxgram import types
from voxgram import utils
from voxgram.errors import MessageIdsEmpty, PeerIdInvalid
from voxgram.parser import utils as parser_utils, Parser
...
class Message(Object, Update):
    ...
    async def wait_for_click(
        ...
        return await self._client.listen(
            filters=filters,
            timeout=timeout,
            listener_type=voxgram.enums.ListenerTypes.CALLBACK_QUERY,
