...
class BotMessages(BaseModel):
    ...
    bot_help: str = (
        ...
        **Gelbooru**
        ...
        Usage: TAG_1.. TAG_N
        Note: 
        - TAG = replace "space" with underscore (_)
        ...
        **Furry e621**
        Show images from e621 or e6ai website
        Command: `@ttloli_bot .fur`
        Usage: [MODE].. TAG_1.. TAG_N
        Mode: `-ai` | null
        Note: 
        ...
        **Manga / Doujins** __[BETA]__
        ...
        Usage: [OPTIONS].. TITLE..
        Options: tag:TAG | LANGUAGE
        Language: `-en` | `-jp` | `-zh`
        Note: 
        - Default language = english
        - TAG = replace "space" with dash (-)
        - Title = no need to replace "space" with anything
        
        **Example** 
        `@ttloli_bot highres one_piece`
        `@ttloli_bot .px id:99370414 -safe -no_ai`
        `@ttloli_bot .fur -ai loona_(helluva_boss)`
        `@ttloli_bot .rp cosplay asia`
        `@ttloli_bot .md tag:big-breast genshin impact`
