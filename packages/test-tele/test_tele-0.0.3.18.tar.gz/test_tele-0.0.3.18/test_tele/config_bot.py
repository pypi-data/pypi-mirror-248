...
class BotMessages(BaseModel):
    ...
    bot_help: str = (
        ...
        **HELP**
        ...
        `/get`   : Forward any messages from public channel
        ...
        **Manga / Doujins**
        ...
        Usage: [OPTIONS].. [MODE]..
        Options: TAGS | author:AUTHOR_ID | uploader:UPLOADER_ID
        Mode: `rating:N` N: minimum rating (1-5)
        Note: TAGS = no need to replace "space" with underscore
