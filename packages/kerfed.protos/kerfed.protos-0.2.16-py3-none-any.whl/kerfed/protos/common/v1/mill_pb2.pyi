...
class MillMachine(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["extents", b"extents", "feed_max", b"feed_max", "max_z_travel", b"max_z_travel", "rpm_max", b"rpm_max", "spindle_length", b"spindle_length", "spindle_pad", b"spindle_pad", "spindle_radius", b"spindle_radius", "tool_pad", b"tool_pad"]) -> None: ...
...
class MillPreprocess(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["directions", b"directions", "drills", b"drills", "mesh", b"mesh", "stock", b"stock", "stock_geometry", b"stock_geometry"]) -> None: ...
...
class MillFabrication(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cuts", b"cuts", "fixtures", b"fixtures", "gcode", b"gcode", "machine", b"machine", "plan", b"plan", "pre", b"pre", "stock", b"stock", "volume", b"volume"]) -> None: ...
