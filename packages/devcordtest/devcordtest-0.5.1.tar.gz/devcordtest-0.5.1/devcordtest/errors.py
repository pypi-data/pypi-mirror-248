...
class devcordtestException(Exception):
    """Base exception class for all devcordtest exceptions."""


class ConvertTimeError(devcordtestException):
    """Raised when a time conversion fails."""


class Blacklisted(devcordtestException):
