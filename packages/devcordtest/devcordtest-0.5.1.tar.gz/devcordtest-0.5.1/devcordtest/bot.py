...
class Bot(_main_bot):  # type: ignore
    """The devcordtest bot class. This is a subclass of :class:`discord.Bot` if you use Pycord.
    ...
    **kwargs:
    ...
    def add_help_command(
        ...
        *,
        ...
        if not DPY:
            self.load_extension("devcordtest.cogs.pyc.help_setup", package="devcordtest")
    ...
    def add_status_changer(
        ...
        **kwargs:
        ...
        if not DPY:
            self.load_extension("devcordtest.cogs.pyc.status_changer_setup", package="devcordtest")
    ...
    def add_blacklist(
        ...
        *,
        ...
        if not DPY:
            self.load_extension("devcordtest.cogs.pyc.blacklist_setup", package="devcordtest")
            
    def add_guild_blacklist(
        self,
        admin_server_ids: list[int],
        *,
        db_path: str = "guildblacklist.db",
        db_name: str = "guildblacklist",
        raise_error: bool = False,
        owner_only: bool = True,
    ):
        """Add a blacklist that bans users from using the bot. This should be called
    ...
    async def setup_hook(self):
        ...
        for ext in self.enabled_extensions:
            await self.load_extension(f".cogs.dpy.{ext}_setup", package="devcordtest")
...
class PrefixBot(Bot, commands.Bot):
    ...
    This class can be used if you want to use devcordtest with prefix commands.
...
class BridgeBot(Bot, bridge.Bot):
    ...
    This class can be used if you want to use devcordtest with bridge commands.
    This is only needed for Pycord.
    """
