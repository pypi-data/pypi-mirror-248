...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget_26.setGeometry(QtCore.QRect(530, 100, 111, 82))
...
"(if available)"))
        ...
        self.asteroidDistArcsecLabel.setText(_translate("MainWindow", "arcsec"))
        ...
        self.demoGeometryButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Clicking this button will cause a plot to appear that shows the geometry of the event with the star center and diameter and path relative to the asteroid shape.</p><p>This is particularly useful when dealing with diffraction models where the asteroid can be modelled as an ellipse and the orientation of the ellipse is hard to visualize.</p></body></html>"))
        ...
        self.baselineADUbutton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Click this button once a point pair has been placed on the baseline area that exludes any event data. The points selected will be changed to a salmon color.</p><p>This operation may be reated multiple time.</p></body></html>"))
...
"Setting this value to zero will force Miss distance optimization to be skipped."))
        ...
        self.majorAxisLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>If a value is entered in this edit box (and all the others in this row), an elliptical shape for the asteroid will be used during diffraction modelling, automatically overriding the asteroid diameter entry.</p><p>The major axis is the vertical axis (y) in plots of the diffraction pattern on the ground</p></body></html>"))
        self.majorAxisLabel.setText(_translate("MainWindow", "Ellipse specs:     major axis(km)(y):"))
        self.minorAxisLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>If a value is entered in this edit box (and all the others in this row), an elliptical shape for the asteroid will be used during diffraction modelling, automatically overriding the asteroid diameter entry.</p><p>The minor axis is the horizontal axis (x) in plots of the diffraction pattern on the ground</p></body></html>"))
        self.minorAxisLabel.setText(_translate("MainWindow", "   minor axis(km)(x):"))
        self.ellipseAngleLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>If a value is entered in this edit box (and all the others in this row), an elliptical shape for the asteroid will be used during diffraction modelling, automatically overriding the asteroid diameter entry.</p><p>The ellipse angle is relative to the observation path with positive values treated as counter-clockwise rotation. The angle units are degrees, not radians</p></body></html>"))
