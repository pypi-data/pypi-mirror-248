#
# adasmf SMF record structures V1.6 for Adabas V8.4 with zIIP
#
...
class Asbase(Datamap):
    ...
    Uint4('tsesso',pos=0x00a0),  # Offset to detail section from startx
...
ASSMFVC = b'\x01\x06' # current version
...
class Aspid(Datamap):
    ...
    #q Assmfv15  equ     x'0105'            version 1.5 - Adabas AZP835
    #q Assmfv16  equ     x'0106'            version 1.6 - Adabas V8.4 with zIIP
...
class Asparm(Datamap):
  def __init__(self, **kw):
    ...
    String('ziip',1,caption='zIIP'),        #v84 + zIIP

    byteOrder=NETWORKBO,ebcdic=1,**kw)
ASPARML=0x4a8 # Length of parameter area
