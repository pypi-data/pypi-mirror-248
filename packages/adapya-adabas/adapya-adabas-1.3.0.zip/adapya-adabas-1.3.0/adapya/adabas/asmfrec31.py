#
# adasmf SMF record structures V3.1 used with Adabas V8.6 with zIIP
#
...
ASSMFVC = b'\x03\x01' # current version
...
class Aspid(Datamap):
    ...
    #q AsSMFV16  equ     x'0106'            version 1.6 - zIIP V8.5
...
class Asparm(Datamap):
  def __init__(self, **kw):
    ...
    byteOrder=NETWORKBO,ebcdic=1,**kw)
ASPARML=0x4ac # Length of parameter area (asmfrec v3.1)
...
class Asstg(Datamap):
    ...
    Uint4('stghwt',opt=T_STCK,caption='HWM time'),   # in stck format
