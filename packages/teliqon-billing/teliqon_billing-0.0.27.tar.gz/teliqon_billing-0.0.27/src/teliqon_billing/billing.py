...
class BillingAPI:
    ...
    def get_transaction_query(self, filter: dict = None, exclude: dict = None, order_by: list = None, limit: int = None, offset: int = None) -> list: # Untyped
        if offset is None: 
            offset = 0
        if limit is None:
            limit = 50
    ...
    def set_subscription_amount(self, unique_id: str, plan_unique_id: str, amount: float):
        return self._patch_user_subscription(unique_id, plan_unique_id, amount=amount)
