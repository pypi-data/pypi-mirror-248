...
@click.help_option(help_option_names=['-h', '--help'], help='Menampilkan pesan bantuan dan keluar.')
@click.version_option(version='0.1.7', message="0.1.7", help="Menampilkan versi saat ini")
def hitung_mundur(f):
    bersihkan_layar()
