/*
    tests/test_local_bindings.src -- tests the py::module_local class feature which makes a class
...
TEST_SUBMODULE(local_bindings, m) {
    ...
    // one, in pybind11_cross_module_tests.src, is designed to fail):
    ...
    // test_class.src and should raise a runtime error from the duplicate definition attempt.  If
