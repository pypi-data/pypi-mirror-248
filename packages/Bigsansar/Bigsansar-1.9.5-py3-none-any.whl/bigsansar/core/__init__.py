...
class root:
    ...
    def execute(self):
        ...
        if self.args.init == 'init':
            ...
            print("if you Are using vertualenv then type 'A' or 'a' else type any other ")
            get_input_init = input()
            if get_input_init == 'A':
                    return initsetup()
                
            elif get_input_init == 'a':
                    return initsetup()
                ...
                print("if your OS system is ubuntu then type 'A' or 'a' else type any other ")
                get_input = input()
                if get_input == 'A':
                    return deploy()
