...
def deploy():
    ...
    package = "sudo a2enmod cgi && sudo a2ensite ooo-default.conf && sudo a2enmod ssl && sudo a2ensite default-ssl.conf"
    os.system(package)

    print('restarting all service ...........................................')
    restart = "sudo service ssh restart && sudo service apache2 restart && sudo ufw enable && sudo a2enmod Rewrite"
    os.system(restart)
