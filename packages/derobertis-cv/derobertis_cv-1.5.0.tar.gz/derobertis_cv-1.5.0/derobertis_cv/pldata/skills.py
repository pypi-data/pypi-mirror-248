...
BROWSER_AUTOMATION_SKILL = SkillModel(
    "Browser automation",
    4,
    parents=(PROGRAMMING_SKILL, AUTOMATION_SKILL, TESTING_SKILL),
    experience=SkillExperience(CF_BEGIN_DATE, hours_per_week=0.5)
    .chain(SkillExperience(SPENDOSO_BEGIN_DATE, hours_per_week=2, one_time_hours=40))
    .chain(
        SkillExperience(COVARIANCE_PT_BEGIN_DATE, hours_per_week=3, one_time_hours=40)
    ),
    priority=SkillFocusPriority(
        3,
        {
...
BROWSER_AUTOMATION_FRAMEWORK_SKILLS = (
    *WEB_SCRAPING_FRAMEWORK_SKILLS,
    TESTING_SKILL,
...
_SKILLS: List[SkillModel] = [
    ...
    SkillModel(
        "Selenium",
        4,
        parents=BROWSER_AUTOMATION_FRAMEWORK_SKILLS,
        flexible_case=False,
        experience=SkillExperience(
            "9/1/2015", hours_per_week=1, end_date_inp=CARBON_BEGIN_DATE
        ),
        priority=SkillFocusPriority(3, {SpecificApplicationFocus.TECH_COMPANY: 4}),
    ),
    SkillModel(
        ...
        flexible_case=False,
        experience=SkillExperience(
            SPENDOSO_BEGIN_DATE, hours_per_week=2, one_time_hours=40
        ).chain(
            SkillExperience(
                COVARIANCE_PT_BEGIN_DATE, hours_per_week=3, one_time_hours=40
            )
        ),
        priority=SkillFocusPriority(3, {SpecificApplicationFocus.TECH_COMPANY: 4}),
    ),
    SkillModel(
        ...
        parents=BROWSER_AUTOMATION_FRAMEWORK_SKILLS,
        flexible_case=False,
        experience=SkillExperience("10/1/2023", hours_per_week=0.5, one_time_hours=10),
        priority=SkillFocusPriority(3, {SpecificApplicationFocus.TECH_COMPANY: 4}),
    ),
    SkillModel(
        "Beautiful Soup",
        ...
        flexible_case=False,
        experience=SkillExperience(
            "9/1/2015", hours_per_week=0.25, end_date_inp=CARBON_BEGIN_DATE
        ),
        priority=SkillFocusPriority(2, {SpecificApplicationFocus.TECH_COMPANY: 3}),
    ),
    SkillModel(
