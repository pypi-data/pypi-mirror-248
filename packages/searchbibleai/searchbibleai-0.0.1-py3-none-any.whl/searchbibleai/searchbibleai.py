...
from searchbibleai.convertor.bible import ConvertBible
...
def main():
    version = input("Enter a bible version (e.g. NET): ")
    searchVerses(version=version if version := version.strip() else "NET")
