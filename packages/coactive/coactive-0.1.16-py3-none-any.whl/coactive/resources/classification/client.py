...
class ClassificationClient:
    ...
    def classify_image_at_url(
        ...
        *,
        ...
        """
        Classify an image downloadable via a public url for provided concepts ids or all concepts within the provided dataset
        ...
        Parameters:
            ...
            - concept_ids: typing.Optional[typing.List[str]]. Concept ids to use to classify an image

            - dataset_id: typing.Optional[str]. The dataset id to get all concepts to use for classification
        ---
    ...
    def classify_image_file(self) -> ClassificationResponse:
        """
        Classify an image file for provided concepts ids or all concepts within the provided dataset
        ...
        client.classification.classify_image_file()
        """
        _response = self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/v1/classify/image/file"),
            headers=self._client_wrapper.get_headers(),
            timeout=60,
        )
        if 200 <= _response.status_code < 300:
...
class AsyncClassificationClient:
    ...
    async def classify_image_file(self) -> ClassificationResponse:
        """
        Classify an image file for provided concepts ids or all concepts within the provided dataset
        ...
        await client.classification.classify_image_file()
        """
        _response = await self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/v1/classify/image/file"),
