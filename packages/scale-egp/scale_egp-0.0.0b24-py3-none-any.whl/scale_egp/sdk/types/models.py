...
from scale_egp.sdk.enums import ModelVendor, AgentAction
...
class Model(Entity):
    ...
    Attributes:
        ...
        model_creation_parameters: The parameters used to create the model
        status: Status of the model's deployment.
        request_schema: JSON schema for the requests to the model
        response_schema: JSON schema for the response to the model
    """
