...
# 四组不同的损伤对
damage_pairs = [(0.0, 0.0), (0.01, 0.02) , (0.5, 0.5), (0.9, 0.9)]
...
for index, (v1_brca1_damage, v1_tp53_damage) in enumerate(damage_pairs):
    ...
    for cycle in range(1,cycles):
        ...
        H3_after_genamonic_tf[0] = H3_after_genamonic_tf[0] + (effect_on_H3_0 *0.1* H3_after_genamonic_tf[0] )
        H3_after_genamonic_tf[2] = H3_after_genamonic_tf[2] + (effect_on_H3_2 *0.1* H3_after_genamonic_tf[0] )
