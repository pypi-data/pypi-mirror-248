...
v2_BRCA1 = np.array([0, 1, 1, 0] + [0]*12 + [0.3])  # BRCA1示例参数
...
# 四组不同的损伤对
damage_pairs = [(0.05, 0.15), (0.1, 0.2), (0.15, 0.25), (0.2, 0.3)]
...
for index, (v1_tp53_damage, v1_brca1_damage) in enumerate(damage_pairs):
    ...
    # 绘制子图
    axs[index].plot(total_MLN_output)
    axs[index].set_title(f'TP53 Damage: {v1_tp53_damage}, BRCA1 Damage: {v1_brca1_damage}')
