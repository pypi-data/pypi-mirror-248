...
# [Aspose.BarCode for Python via Java](https://releases.aspose.com/barcode/python-java/) (23.12.0)
...
```python
pip install aspose-barcode-for-python-via-java==23.12
```

# [Aspose.Cells for Python via Java](https://releases.aspose.com/cells/python-java/) (23.12.0)
...
```python
pip install aspose-cells==23.12.0
```

# [Aspose.Diagram for Python via Java](https://releases.aspose.com/diagram/python-java/) (23.12.0)
...
```python
pip install aspose-diagram==23.12.0
```
