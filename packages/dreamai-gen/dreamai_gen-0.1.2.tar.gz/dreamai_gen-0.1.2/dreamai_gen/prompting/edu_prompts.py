...
def course_template(course_name: str, prefix: str = "", **extra) -> str:
    if prefix:
        prefix = cleandoc(prefix)
    else:
        prefix = "You are a friendly and helpful instructional coach helping teachers create engaging and effective lessons for their students."
    if course_name:
