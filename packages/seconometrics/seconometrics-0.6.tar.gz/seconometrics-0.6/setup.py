...
setup(
    name='seconometrics',  # Name of your package
    version='0.6',  # Initial version of your package
    ...
    url='https://github.com/stefanstavrianos/seconometrics/',  # Link to the project's GitHub repo
    install_requires=[
        'numpy',
        'pandas',
        'scipy'
