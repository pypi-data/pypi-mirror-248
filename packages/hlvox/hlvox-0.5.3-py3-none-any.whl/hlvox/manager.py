...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Generate a sentence using voices")
    parser.add_argument(
        "-s",
        "--voices-dir",
        type=str,
        required=True,
        help="Path to folders with voice audio file folders",
    )
    parser.add_argument(
        "-f",
        "--format",
        ...
        required=False,
        default="wav",
        help="Audio format to export voice files as",
    )
