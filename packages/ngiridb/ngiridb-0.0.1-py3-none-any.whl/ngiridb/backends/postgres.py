...
from ngiridb.core import LOG_EXTRA, DatabaseURL
from ngiridb.interfaces import (
    ConnectionBackend,
    DatabaseBackend,
...
class PostgresConnection(ConnectionBackend):
    ...
    async def fetch_val(
        ...
        # see also:
        # https://github.com/encode/ngiridb/pull/131
        # https://github.com/encode/ngiridb/pull/132
        # https://github.com/encode/ngiridb/pull/246
