...
from typing import Dict, Iterator, List, Mapping, Any, Optional
...
class MongoDbClient(DatabaseClient):
    ...
    def __init__(self, **kwargs):
        ...
        self.connect_fcn = MongoClient

    def connect(self) -> None:
        super(MongoDbClient, self).connect()
        self.db = self.connection[self.db]

    def test_connection(self, session: Optional[ClientSession] = None) -> Dict:
        return self.connection.server_info(session=session)
